...
⚠️ **Insieme questi due file pesano 337 KB** (byte LF, il 2026-08-18), e con
[`docs/audit-2026-08-11.md`](docs/audit-2026-08-11.md) — **chiuso il 2026-08-18, otto decisioni
su otto**, quindi oggi una **consultazione** — **368**. ⛔ **E il prezzo in
...
`docs/adr/` «per farsi un'idea». Insieme pesano **oltre mezzo megabyte** — **722 KB** in
