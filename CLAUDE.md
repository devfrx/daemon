...
⚠️ **Insieme questi due file pesano 373 KB** (byte LF, il 2026-08-19), e con
[`docs/audit-2026-08-11.md`](docs/audit-2026-08-11.md) — **chiuso il 2026-08-18, otto decisioni
su otto**, quindi oggi una **consultazione** — **404**. ⛔ **E il prezzo in
...
già 91, e fino alla chiusura del Traguardo 3 **«165»** quando erano 192. Restano comunque la lettura più economica che esista qui: l'alternativa è **732 KB**.

⛔ **Non aprire** `docs/HANDOFF.md`, la spec del sotto-progetto 1, o la cartella
`docs/adr/` «per farsi un'idea». Insieme pesano **oltre mezzo megabyte** — **732 KB** in
