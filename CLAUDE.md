...
già 91, e fino alla chiusura del Traguardo 3 **«165»** quando erano 192. Restano comunque la lettura più economica che esista qui: l'alternativa è **759 KB**.

⛔ **Non aprire** `docs/HANDOFF.md`, la spec del sotto-progetto 1, o la cartella
`docs/adr/` «per farsi un'idea». Insieme pesano **oltre mezzo megabyte** — **759 KB** in
