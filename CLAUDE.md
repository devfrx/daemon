...
⚠️ **Insieme questi due file pesano 143 KB** (`wc -c`, il 2026-08-10). ⛔ **E il prezzo in
...
già 91. Restano comunque la lettura più economica che esista qui: l'alternativa è **629 KB**.

⛔ **Non aprire** `docs/HANDOFF.md`, la spec del sotto-progetto 1, o la cartella
`docs/adr/` «per farsi un'idea». Insieme pesano **oltre mezzo megabyte** — **629 KB** con
`wc -c` il 2026-08-10, e possono solo crescere; la spec da sola ne fa **274** — e l'idea è
