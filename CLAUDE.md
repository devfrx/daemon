...
⚠️ **Insieme questi due file pesano 210 KB** (`wc -c`, il 2026-08-11). ⛔ **E il prezzo in
...
compendio ne ha **oltre milleseicento**. ⚠️ **Un limite inferiore e non un totale, come la
...
già 91, e fino alla chiusura del Traguardo 3 **«165»** quando erano 192. Restano comunque la lettura più economica che esista qui: l'alternativa è **675 KB**.

⛔ **Non aprire** `docs/HANDOFF.md`, la spec del sotto-progetto 1, o la cartella
`docs/adr/` «per farsi un'idea». Insieme pesano **oltre mezzo megabyte** — **675 KB** con
...
legge**. Il verbale è la **sedicesima misura** della §12; l'ultima rimisura è la **ventesima**, alla chiusura del brainstorming del Traguardo 4, e le due cifre di questo capoverso vengono da lì. Quando ti servirà il **perché** di
