...
LEGGI QUESTI TRE FILE, PER INTERO, POI FERMATI          — 537 KB in tutto
  1. CLAUDE.md
...
| lettura che ordinava | l'intero corpus, oltre mezzo megabyte | **505 KB** — `CLAUDE.md` più il compendio, e **537** con l'audit |
| decisioni note all'agente | tutte, dopo aver letto tutto | **tutte**, dopo 505 KB |
...
resta quello che conta: **537 KB contro 767**. ⛔ **E il 2026-08-18 una passata ha trovato che il
