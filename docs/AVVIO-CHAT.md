...
LEGGI QUESTI TRE FILE, PER INTERO, POI FERMATI          — 553 KB in tutto
  1. CLAUDE.md
...
⛔ NON aprire docs/HANDOFF.md, la spec del sotto-progetto 1, né la cartella
   docs/adr/ «per farsi un'idea»: insieme pesano oltre mezzo megabyte — 771 KB
   il 2026-08-25, la spec da sola 277, i quattro piani più grandi 356, 168,
...
| lettura che ordinava | l'intero corpus, oltre mezzo megabyte | **521 KB** — `CLAUDE.md` più il compendio, e **553** con l'audit |
| decisioni note all'agente | tutte, dopo aver letto tutto | **tutte**, dopo 521 KB |
...
resta quello che conta: **553 KB contro 771**. ⛔ **E il 2026-08-18 una passata ha trovato che il
