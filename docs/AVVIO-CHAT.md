...
LEGGI QUESTI TRE FILE, PER INTERO, POI FERMATI          — 538 KB in tutto
  1. CLAUDE.md
...
| lettura che ordinava | l'intero corpus, oltre mezzo megabyte | **506 KB** — `CLAUDE.md` più il compendio, e **538** con l'audit |
| decisioni note all'agente | tutte, dopo aver letto tutto | **tutte**, dopo 506 KB |
...
resta quello che conta: **538 KB contro 767**. ⛔ **E il 2026-08-18 una passata ha trovato che il
