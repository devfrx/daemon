...
LEGGI QUESTI TRE FILE, PER INTERO, POI FERMATI          — 479 KB in tutto
  1. CLAUDE.md
...
| lettura che ordinava | l'intero corpus, oltre mezzo megabyte | **448 KB** — `CLAUDE.md` più il compendio, e **479** con l'audit |
| decisioni note all'agente | tutte, dopo aver letto tutto | **tutte**, dopo 448 KB |
...
resta quello che conta: **479 KB contro 750**. ⛔ **E il 2026-08-18 una passata ha trovato che il
