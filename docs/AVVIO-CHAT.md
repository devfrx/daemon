...
LEGGI QUESTI TRE FILE, PER INTERO, POI FERMATI          — 517 KB in tutto
  1. CLAUDE.md
...
⛔ NON aprire docs/HANDOFF.md, la spec del sotto-progetto 1, né la cartella
   docs/adr/ «per farsi un'idea»: insieme pesano oltre mezzo megabyte — 762 KB
   il 2026-08-21, la spec da sola 277, i quattro piani più grandi 345, 168,
...
| lettura che ordinava | l'intero corpus, oltre mezzo megabyte | **485 KB** — `CLAUDE.md` più il compendio, e **517** con l'audit |
| decisioni note all'agente | tutte, dopo aver letto tutto | **tutte**, dopo 485 KB |
...
resta quello che conta: **517 KB contro 762**. ⛔ **E il 2026-08-18 una passata ha trovato che il
