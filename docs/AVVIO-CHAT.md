...
LEGGI SOLO QUESTI DUE FILE, PER INTERO, POI FERMATI     — 123 KB in tutto
  1. CLAUDE.md
...
| lettura che ordinava | l'intero corpus, oltre mezzo megabyte | **123 KB** — `CLAUDE.md` più il compendio |
| decisioni note all'agente | tutte, dopo aver letto tutto | **tutte**, dopo 123 KB |
...
resta quello che conta: **123 KB contro mezzo megabyte**.
