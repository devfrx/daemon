...
LEGGI QUESTI TRE FILE, PER INTERO, POI FERMATI          — 490 KB in tutto
  1. CLAUDE.md
...
⛔ NON aprire docs/HANDOFF.md, la spec del sotto-progetto 1, né la cartella
   docs/adr/ «per farsi un'idea»: insieme pesano oltre mezzo megabyte — 753 KB
   il 2026-08-21, la spec da sola 277, i quattro piani più grandi 338, 168,
...
| lettura che ordinava | l'intero corpus, oltre mezzo megabyte | **458 KB** — `CLAUDE.md` più il compendio, e **490** con l'audit |
| decisioni note all'agente | tutte, dopo aver letto tutto | **tutte**, dopo 458 KB |
...
resta quello che conta: **490 KB contro 753**. ⛔ **E il 2026-08-18 una passata ha trovato che il
