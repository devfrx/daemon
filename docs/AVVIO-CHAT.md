...
LEGGI QUESTI TRE FILE, PER INTERO, POI FERMATI          — 531 KB in tutto
  1. CLAUDE.md
...
| lettura che ordinava | l'intero corpus, oltre mezzo megabyte | **499 KB** — `CLAUDE.md` più il compendio, e **531** con l'audit |
| decisioni note all'agente | tutte, dopo aver letto tutto | **tutte**, dopo 499 KB |
...
resta quello che conta: **531 KB contro 767**. ⛔ **E il 2026-08-18 una passata ha trovato che il
