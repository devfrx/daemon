...
| lettura che ordinava | l'intero corpus, oltre mezzo megabyte | **540 KB** — `CLAUDE.md` più il compendio, e **572** con l'audit |
| decisioni note all'agente | tutte, dopo aver letto tutto | **tutte**, dopo 540 KB |
