...
> (649 KB con `wc -c` il 2026-08-10, e possono solo crescere — la spec da sola ne fa 277), e
> l'idea è già qui.
...
dal 2026-08-10: nove compiti su dodici, `GATE GREEN` a tutti** — il **record durevole**
...
kernel scrive davvero** — la nota di `Untrusted::promote` — e col **Task 8** la **seconda
implementazione della porta `journal`**: `redb` col **backend scritto da noi**
(`crates/platform/src/journal.rs`), e col **Task 9** la conformità che gira contro **entrambe a
ogni commit** (`crates/platform/tests/journal_contract_real.rs`).
...
⏭️ **Il prossimo passo è il Task 10, i byte congelati** — e non si rigenerano mai: dal loro
commit in poi nessun campo nuovo può essere obbligatorio, nessun indice esistente può cambiare
significato, e una variante nuova di `RecordKind` smette di essere gratis (**E33** dell'errata).
...
| il testo integrale dei **gotcha** e delle **misure**, con i numeri | [`HANDOFF.md`](HANDOFF.md) — ⚠️ **a sezioni** | 159 KB |
...
| l'ordine dei dodici sotto-progetti e le dipendenze | [`roadmap.md`](roadmap.md) | 19 KB |
...
| **dove vive ogni controllo** della porta, riga per riga sul catalogo §7.4, e cosa **non** è coperto | [`porta-di-qualita.md`](porta-di-qualita.md) | 73 KB |
...
| la **provenienza** di ciò che non abbiamo dedotto noi, con le date | [`riferimenti.md`](riferimenti.md) | 89 KB |
...
| ⛔ **il compito da cui si riprende** — è il piano **in corso**, dodici compiti: i primi **otto sono eseguiti**, si riprende dal **Task 9**. ⚠️ **L'errata in testa si legge prima del compito**, ed è a **quarantacinque voci** | [`plans/2026-08-10-sottoprogetto-1-traguardo-3-giornale-e-formato-durevole.md`](superpowers/plans/2026-08-10-sottoprogetto-1-traguardo-3-giornale-e-formato-durevole.md) — ⚠️ **a compiti, mai intero** | 136 KB |
| l'indice di ADR e diagrammi | [`README.md`](README.md) | 12 KB |
