...
> (789 KB in byte LF il 2026-08-27, e possono solo crescere — la spec da sola ne fa 284), e
> l'idea è già qui.
...
le prime ~340 righe. ⛔ **Il «Dettaglio» che segue NON si legge intero:** sono 73 schede, 205 KB, e
...
tabella sola»*, **con la colonna di chi le chiude** — che per **sei** di esse non è il
proprietario.
...
⛔ **Il Task 9 del Traguardo 5 ha prodotto TRE forme nuove e una CONFERMA, e l'elenco restò a
settantasei — ⚠️ *restò*, perché l'audit del 2026-08-21 ha portato il **#77**: sono entrate
DENTRO le righe che le spiegano — il #31, il #76 e il #73 — e va
scritto perché.** Nessuna delle tre insegna una trappola che le righe esistenti non insegnino
già: la prima è il **#31** spostato dal *documento che invecchia* all'**oracolo che non può
essere verde**, la seconda è una **misura in più** sotto la stessa tesi del **#76**, la terza è
il **confine** fra il #73 e il **#14** — quando si pinza e quando si dichiara. ⛔ **Un gotcha che
non insegna niente diluisce quelli che insegnano**, e la §9 è l'elenco che si rilegge per primo:
è la stessa decisione presa chiudendo il Task 8, quando due candidati furono lasciati fuori
perché coperti dal #65 e dal #48. **Due volte su due la scelta è stata la stessa, e non è
un'omissione.**

⛔ **E il Task 10 ha rotto la serie: porta il #78, più DUE forme dentro righe che c'erano.** Il
**#78** entra perché insegna un gesto che nessuna riga esistente prescrive — *lo stato di un
compito si rivede a `HEAD`, non commit per commit* — e perché è costato un giro pieno di
revisione. Le due forme no: una è il **#69** spostato da uno **script** a un **subagente** che
muore a metà, l'altra è la **terza e quarta misura** sotto la stessa tesi del **#76**, con i
numeri che la rendono una serie invece di un aneddoto — `+120` righe con l'istruzione generica,
`−6` e `+1` con quella di togliere.

⛔ **E la chiusura di P-2 porta il #79, che è di specie diversa da tutti e settantotto: non è
una trappola dell'ESECUZIONE, è una del RINVIO.** Entra perché la sua cura è un gesto che
nessuna riga esistente prescrive — *si prova la ragione per cui un lavoro NON si fa* — e perché
il difetto che descrive è costato **tre traguardi** di scaglionamento inutile, con la smentita
committata a due file di distanza per tutto il tempo. ⚠️ **Nessuna forma nuova dentro righe
esistenti in questa passata**, tranne una del **#70**, che è registrata nel racconto di §6 e non
qui: un rinomino censito sul **nome intero** manca le case che lo scrivono **abbreviato**.

⛔ **E la nona ondata del Task 11 porta il #80, più UNA forma dentro una riga che c'era — e
stavolta a produrli non è stato il compito, ma la REVISIONE del compito.** Il **#80** entra
perché nessuna riga esistente dice dove finisce l'**insieme d'ingresso** di un controllo, e
perché il difetto ha fatto uscire `GATE RED` su un albero corretto: il cancello leggeva `.md`
che git **ignora**. ⚠️ **Non è il #41** — là un filtro esclude troppo, qui manca del tutto — e
la metà che insegna davvero è che **entrambe** le riparazioni ovvie erano sbagliate, ciascuna
per una ragione diversa. La forma nuova è del **#70**, ed è la **terza**: il `grep` **non trova**
una casa che c'è perché la frase è spezzata da un a-capo, e ciò che se ne conclude è una
**negazione**. ⚠️ **Registrata dentro il #70 e non promossa**, perché la cura è quella che il
#70 già prescrive — *si cerca il frammento più corto che resti unico* — e un gotcha che non
insegna niente diluisce quelli che insegnano. **Tre volte su tre la scelta è stata la stessa**,
e non è un'omissione.

⛔ **E il ciclo di revisione del Task 11 — chiuso il 2026-08-25 — non porta NESSUNA riga nuova, e
va scritto perché è una decisione e non una dimenticanza.** Le cinque revisioni hanno prodotto
**tre** candidati, valutati uno per uno contro le righe che ci sono:

| il candidato | dove è registrato, e perché lì |
|---|---|
| il **perimetro di una REVISIONE** deciso dalla cartella di lavoro invece che da ciò che si consegna — è la ragione per cui il ciclo si è fermato | dentro il **#80**, come sua **seconda forma**. Il #80 è nato su un **cancello**, ma la sua forma generale è già scritta al livello giusto — *l'insieme d'ingresso è ciò che si CONSEGNA* — e la cura non cambia cambiando il soggetto: promuoverlo sarebbe scrivere due volte la stessa lezione con un attore diverso, che è ciò che il **#69** e il **#31** hanno già evitato |
| una **clausola universale** cercata col `grep` sul **connettivo** che la porta (*«non può»*, *«mai»*) | dentro il **#70**, ed è la sua **quarta** forma. Il connettivo è **vero** nella riga accanto, quindi il `grep` restituisce candidate che non sono la clausola **e** manca la gemella che dice la stessa cosa con altre parole. La cura è quella che il #70 già prescrive, spostata dal frammento alla **proposizione**: *si cerca ciò che si afferma, non la parola che lo afferma* |
| il rimedio a un **conteggio che invecchia** non è una regola più severa, ma **togliere il numero** | dentro il **#76**, come misura in più sotto la stessa tesi — e stavolta la misura è **contata**. Prima del ciclo il compendio aveva **una** casa che al posto del numero porta un **rimando a `git log`**; la prima ondata ne ha aggiunte **due**, e le aggiunge **perché** una revisione vi aveva trovato un numero sbagliato. Da allora nessuna delle tre ha prodotto un rilievo, mentre la regola *«il comando e la popolazione»* — scritta in forma esortativa **due volte** — ha ceduto lo stesso nell'unico punto in cui a un conteggio è stata aggiunta una **promessa** |

⛔ **Nessuno dei tre entra nell'elenco**, e la ragione è quella scritta in cima a questa sezione:
un gotcha che non insegna niente diluisce quelli che insegnano. ⚠️ **E il conto cumulativo di
quante volte la scelta sia stata questa NON è scritto qui** — la riga qui sopra ne porta uno, ed
è del giorno in cui fu scritta: un cumulativo invecchia a ogni chiusura, mentre la **ragione**
resta vera mentre il conto cresce. È il gotcha **#31** applicato alla frase che chiude una
decisione invece che a una cifra.

⛔ **E IL TASK 12 PORTA IL #81, E LA DECISIONE VA SCRITTA PERCHÉ I CANDIDATI ERANO DUE E NE
ENTRA UNO.** Il **#81** entra perché insegna un gesto che nessuna riga esistente prescrive —
*prima di credere a una spazzata si misura quanti esiti distinti produce lo scenario, e si varia
una cosa alla volta per scoprire quale porta la diversità* — e perché il difetto che descrive
rendeva **impossibile far passare** il compito che lo conteneva.
⛔ **Il secondo candidato NON entra, ed è quello che la consegna dava per il più forte: la TERZA
forma della trappola dei fine-riga**, `git stash` / `git stash pop`, che rimaterializzano il file
dall'indice attraverso `smudge` e con `core.autocrlf=true` lo restituiscono **CRLF**. Le ragioni
sono tre. **Primo:** la casa di quella **regola** è la tabella *«come si lavora qui»* di
`CLAUDE.md`, che si legge **prima** del compendio, e in questa sezione la regola non c'è —
cercato eseguendo, non ricordato: `fine-riga|CRLF|autocrlf|CR` sulle **81** righe numerate della
tabella qui sotto ne restituisce **due**, il **#31**, dove i `CR` di un file integralmente CRLF sono
l'**oracolo che non può essere verde**, e il **#48**, dove a sbagliare è il **banco di misura**;
lette intere, nessuna delle due prescrive di **conservare** i fine-riga di un file. Aprirne una
qui darebbe alla stessa regola una **seconda casa in un secondo documento**, che è il gotcha
**#68** commesso dentro il catalogo che lo elenca. **Secondo:** la
cura non cambia — si contano i `CR` prima e dopo, e si ripristina da una copia byte-esatta — e
il registro lo scrive di sé stesso: *«la regola non cambia, cambia chi la fa scattare»*.
**Terzo:** la metà che sembra nuova — *il `diff` non lo mostra* — è una proprietà di
`core.autocrlf=true` già **misurata il 2026-08-18**, alla 39ª misura della §12, con un attore
diverso.
⚠️ **Ciò che invece è nuovo resta REGISTRATO E NON PRESO, perché è del proprietario:** la riga di
`CLAUDE.md` quantifica su *«chi scrive uno strumento che tocca file»*, e `git stash` non scrive
niente di suo — **come è formulata, la regola non nomina il caso che è appena costato un
censimento**. Allargarla tocca il **documento d'ingresso** e rende falsa una frase viva che ne
descrive il contenuto, che è la forma del **#78**; il testo della terza forma vive intanto in
[`porta-di-qualita.md`](porta-di-qualita.md), accanto alle altre due.

⛔ **E IL TASK 13 — la chiusura del Traguardo 5 — NON PORTA NESSUNA RIGA NUOVA, e va scritto
perché è una decisione e non una dimenticanza.** Il compito ha prodotto **tre** candidati,
valutati uno per uno contro le righe che ci sono:

| il candidato | dove è registrato, e perché lì |
|---|---|
| l'elenco **`Files:`** di un compito è un'affermazione come le altre, e si legge contro il codice: due lavori veri stavano fuori da quell'elenco | dentro il **#65** — *un rapporto è un piano, e si prezza leggendo il codice*. Cambia l'attore (l'intestazione invece del corpo), non la cura, ed è la stessa ragione per cui il #69 e il #31 non sono stati sdoppiati. Il caso vive nella voce `E154` dell'errata |
| un **censimento scritto in un documento diventa una casa di sé stesso**: il `grep` su *«VOCE APERTA»* dava undici occorrenze prima della raccolta e tredici dopo | dentro il **#31**, e la §12 lo porta già **tre volte** sul censimento del `⏭️`. La cura che funziona è quella del #31 e della regola di `CLAUDE.md` — **si toglie il totale**, perché un totale che il proprio commit sposta non può essere verde in nessun mondo — ed è stata applicata così, con la nota scritta **dentro il blocco dei comandi**, dove la legge chi lo rilancia. ⛔ **RICHIAMO DEL 2026-08-25: questa cella diceva *«dentro il #70»* e attribuiva al #70 la cura *«si legge ogni riga intera e si guarda chi l'ha scritta»*, che nel #70 NON C'È.** Misurato: `grep -c "si guarda chi"` sulla riga del #70 dà **zero**. Nessuna delle quattro forme del #70 descrive un censimento che, scrivendosi, muove la propria popolazione. ⚠️ **E non è un errore di solo indirizzo:** *leggere ogni riga intera* non impedisce al totale di spostarsi, quindi la cura citata non avrebbe funzionato nemmeno se fosse stata lì. 📌 *La ragione per cui un lavoro NON si fa non viene mai falsificata, perché non produce l'artefatto che potrebbe contraddirla* — provata contro il testo che nominava, non reggeva |
| la **stessa cifra invecchia diversamente secondo dove sta**: dentro un **verbale datato** regge, dentro una **voce aperta** si legge come *«questo è lo stato»* e mente | dentro il **#31**, come criterio per scegliere **da quale delle due case** togliere quando una cifra ne ha più d'una. Non è una trappola nuova: è la regola di `CLAUDE.md` — *una cifra che vive in più documenti si toglie* — con la domanda che dice **quale** togliere. Il caso è la voce `E155` |

⛔ **Nessuno dei tre entra nell'elenco**, per la ragione scritta in cima a questa sezione: un
gotcha che non insegna niente diluisce quelli che insegnano. ⚠️ **E il conto di quante volte la
scelta sia stata questa NON è scritto qui**, per la ragione che il riquadro del ciclo del Task 11
ha già dato: un cumulativo invecchia a ogni chiusura, la **ragione** no.
...
| 59 | ⛔ **Un ADR può essere falsificato da un ADR FRATELLO scritto lo stesso giorno, e nessuno dei due se ne accorge perché entrambi sono coerenti con sé stessi.** Misurato il 2026-08-11: [ADR-0026](adr/0026-linguaggio-del-core.md) elenca fra le proprie `Positive` *«esiste un runtime deterministico di ecosistema — `madsim` 0.2.34 … quindi il simulatore non va scritto da zero»*, e [ADR-0031](adr/0031-dipendenze-del-kernel-parte-del-confine.md) — **`Date: 2026-08-06`, la stessa** — misura che una crate `no_std` che dipende da `madsim` **compila** con **55 crate** nel grafo e conclude *«55 crate di superficie non verificabile contro un esecutore che nel prototipo è ~30 righe»*. Il codice di oggi dà ragione a 0031: `simulator` ha **una** dipendenza (`kernel`), è scritto **a mano**, e `madsim` non compare né in `Cargo.lock` né in `crates/`. ⚠️ **Quante righe non è scritto qui — richiamo del 2026-08-25:** questa cella diceva **512**, misurate il 2026-08-11 dal commit che la scrisse, e il 2026-08-25 erano **519**, mosse da `b4f1f03`; **tolta** da qui e dagli altri documenti **vivi** che la portavano, e **lasciata nei verbali datati** — il rimando del 2026-08-18 in ADR-0026, il finding `A-1` di `audit-2026-08-11.md` e due righe di [`riferimenti.md`](riferimenti.md) — perché il conto lo dà `find crates/simulator/src -name '*.rs' \| xargs wc -l` e l'argomento regge identico a qualunque valore. L'argomento — la contraddizione fra i due ADR — non dipende dalla cifra. 📌 È il **#31** su una cifra che nessuno rimisurava perché **sosteneva una tesi giusta**. ⛔ **Non è il #57**: là la decisione è **anteriore** a ciò che nomina e la smentita arriva dopo, dal codice; qui la smentita è **contemporanea** e sta in un altro file della stessa cartella. ⚠️ **Nessuno dei due ADR nomina l'altro**, quindi la contraddizione non è visibile da nessuno dei due lati. 📌 **La domanda che lo coglie, e nessuna delle quattro del pre-controllo la fa:** *questo ADR è stato letto contro i suoi **fratelli**, non solo contro il codice?* Le quattro domande guardano tutte il compito contro il codice |
...
| 64 | ⛔ **Due criteri possono coprire ciascuno la propria metà e lasciare scoperto il BUCO FRA loro, e nessuna rilettura dell'uno o dell'altro lo mostra.** Misurato il 2026-08-11: `bincode` 2.0.1 è coperto da **RUSTSEC-2025-0141 — «Bincode is unmaintained»**, categoria `INFO` e non una vulnerabilità, emessa il **2026-01-07**. L'avviso era pubblico **sette mesi prima** che §6.1.1 fosse riconfermata il 2026-08-08, e nessuno l'ha visto benché il criterio esistesse: **ADR-0037** chiede *«il pari ha un lettore conforme e **mantenuto**?»* — ma lo punta **verso il pari** (TypeScript, M-11); **M-1** puntava verso di noi e chiedeva un'altra cosa, *«il grafo transitivo è accettabile per I3?»*. ⛔ **Nessuno dei due chiede se sia mantenuta la libreria del NOSTRO capo del filo**, e `gate-deps.sh` verifica **quali** crate ci sono, non **come stanno**. ✅ **Il costo di agire è quasi zero oggi e cresce da solo:** `bincode` ha **zero usi di produzione** — un commento in `ports/ipc.rs` e la sonda `dependencies_usable.rs` — perché lo schema del canale `ipc` è il **Traguardo 6**. È una finestra che si chiude da sola, come la quarta proprietà di §3. 📌 **La domanda:** *questo criterio è puntato verso entrambi i capi del filo?* ⛔ **FORMA NUOVA, misurata il 2026-08-27 chiudendo il finding AUD-006: non due CRITERI ma due DEFINIZIONI della stessa parola, in due strati diversi — e ciò che nessuno chiede è in quale VERSO divergono.** *«In dubbio»* per la porta `journal` significa *«è stata chiamata `outcome`?»*; per `crate::reconcile` significa *«cosa dicono i record?»*, decodificandoli. La differenza era **dichiarata accanto al codice** — *«the two must not be confused»* — ma come **giustificazione**, cioè come spiegazione del perché sono diverse, e una spiegazione fa smettere di chiedere se la differenza faccia danno. **Ne fa:** un record d'esito indecifrabile è in dubbio per il kernel e **potabile** per la porta, cioè il verso in cui la divergenza autorizza la **sola operazione irreversibile** del giornale. Misurato su **entrambe** le implementazioni. 📌 **La domanda che lo coglie:** *questi due strati usano la stessa parola con due definizioni — in quale verso divergono, e uno dei due versi autorizza un'azione irreversibile?* ⚠️ **Non è una riga nuova, ed è una decisione:** la cura del #64 non cambia — si guarda il buco fra le due metà invece di rileggere ciascuna — e un gotcha che non insegna niente diluisce quelli che insegnano |
...
| 70 | ⛔ **Il `grep` con cui si ricontano le case di una cifra restituisce CANDIDATE, non case — e correggerle tutte rompe contenuto giusto.** Misurato il 2026-08-18 riallineando i pesi della §12. La cifra dei tre file da leggere è **353**, e `grep -rn "353"` ne riporta **sei**: quattro sono pesi, **due no** — `audit-2026-08-11.md` e `riferimenti.md` scrivono `COMPENDIO.md:353`, che è un **numero di riga** dentro una citazione esatta del finding **A-2**. Riscriverle avrebbe rotto due riferimenti corretti mentre si credeva di riallineare un peso. ⚠️ **E il difetto vive dentro il RIMEDIO, che è ciò che lo rende utile:** *«ricontare le case col `grep` invece che dal verbale precedente»* è la cura che la **ventesima** e la **ventiseiesima** misura prescrivono contro il **#31**, cioè contro il gotcha più frequente del progetto — e nessuno ne aveva scritto il modo di fallire. ⛔ **La causa è strutturale, non distrazione:** più una cifra è un **numero nudo** — 322, 353, 719 — più è probabile che una ricerca testuale peschi qualcosa che è un numero nudo per un'altra ragione: una riga, un byte, una percentuale, un identificatore. ⚠️ **Non è il #41**, dove un filtro **esclude** ciò che il controllo dovrebbe vedere: qui **include** roba di un'altra specie, e il danno va nella direzione opposta — non un falso negativo silenzioso, ma una **correzione sbagliata scritta con sicurezza**. ⚠️ **E non è il #48**, che descrive un banco di **misura**: qui lo strumento ha risposto correttamente alla domanda che gli è stata posta. 📌 **Il contro-verso, e costa una lettura:** il `grep` trova dove **guardare**, mai cosa **cambiare**. Ogni occorrenza si legge in faccia prima di toccarla, e il conteggio delle case si scrive **dopo** averle guardate. ⛔ **E la seconda forma, misurata mezz'ora dopo la prima: il `grep` TROVA la casa e chi legge non la guarda, perché l'uscita è TRONCATA.** Il censimento di `⏭️` riportava `roadmap.md:128`, scartata dopo centoventi caratteri per via del filtro messo lì a rendere leggibile l'elenco; dentro c'erano **due** affermazioni false insieme. Nella prima forma il difetto è nell'uscita del `grep`, nella seconda nel **filtro** che gli si mette dopo — il **#41** applicato all'occhio invece che allo script. 📌 **Una riga trovata da un censimento si legge INTERA, o il censimento non è stato fatto**. ⛔ **E la TERZA forma, misurata il 2026-08-24 e col verso opposto alle prime due: il `grep` NON TROVA una casa che c'è, perché la frase cercata è spezzata da un A-CAPO — e la conclusione che se ne trae è una NEGAZIONE.** Una revisione cercò `grep -rn "nothing formats a grant" crates/`, ottenne **zero righe** e concluse che la frase *«non è più in nessun file di `crates/`»*; il coordinatore la ricopiò nel brief dell'ondata senza rimisurarla. **È in `crates/kernel/src/arbiter/mod.rs`**, spezzata fra la riga 63 e la 64 — il `grep` lavora **riga per riga**, e a mancare era l'a-capo, non la frase. ⚠️ Nelle prime due forme il censimento **include troppo** o si legge male; qui **esclude una casa vera**, e il danno è di specie diversa: un falso positivo si vede quando lo si guarda in faccia, un falso negativo produce un'**affermazione negativa scritta con sicurezza** — che è il **#75**, *una negazione è l'affermazione che più facilmente si prova su un campione parziale*. 📌 **Il contro-verso è quello che questa riga già prescrive, e vale anche qui:** si cerca il **frammento più corto che resti unico** — una parola, non una frase — oppure si cerca **attraverso gli a-capo**. 📌 **La domanda:** *questa frase che il `grep` non trova, potrebbe stare su due righe?* ⛔ **QUARTA FORMA, misurata il 2026-08-25 chiudendo il ciclo di revisione del Task 11 — e qui il `grep` sbaglia UNITÀ, non frammento.** Censire le **clausole universali** cercando i connettivi che le portano — *«non può»*, *«mai»*, *«sempre»* — restituisce anche le righe in cui quel connettivo è **vero**, che sono candidate e non clausole, e **manca la gemella** che afferma la stessa cosa con parole diverse: in questo ciclo una clausola è stata tolta in una casa e lasciata viva **tre righe sotto**, e il giro dopo si è ripetuto sullo stesso pattern. 📌 **Il contro-verso:** *si cerca ciò che si AFFERMA, non la parola che lo afferma* — e la **lettura si separa dal censimento**, perché su una popolazione di prosa un pattern trova dove guardare e non prova un'assenza. |
...
| 76 | ⛔ **Un'ondata di correzioni che RISCRIVE crea la superficie del proprio giro successivo; una che TOGLIE la chiude — misurato, non argomentato.** Misurato il 2026-08-20, chiudendo il Task 8 del Traguardo 5. Fra Task 7 e Task 8, **nove** volte un'ondata mandata a chiudere dei rilievi ne ha aperti di nuovi **nella prosa scritta per chiuderli** — e **due** volte un **rapporto** ha dichiarato fatta una correzione **assente dal diff**. ✅ **All'ultima ondata è stata data un'istruzione diversa — *toglierlo* invece di *riscriverlo meglio* — e il ciclo si è chiuso in UNA passata invece di spiralare:** **quattordici** righe messe contro **diciassette** tolte, **una** sola voce d'errata per l'intera ondata, e la revisione successiva **pulita**. 📌 *Meno parole, meno superficie per una falsità nuova.* ⚠️ **Non è il #45**, che dice che il rimedio **nasce non provato** e prescrive di rivedere l'ondata **come** il compito: quello agisce sul **numero di giri**, questo sulla **forma** del rimedio, cioè sull'istruzione che si dà a chi lo scrive — e la porta con una misura, che il #45 non ha. ⛔ **Il limite, dichiarato perché la regola non si applichi dove non vale:** togliere funziona quando ciò che è falso è una **qualificazione** o un **conteggio** accanto a un fatto che regge — l'aggettivo invecchiato, il numero accanto a una tabella che si può contare, la rivendicazione d'unicità smentita da una casa in più. Quando a essere sbagliato è **il fatto**, non c'è niente da togliere: si riscrive, col richiamo datato. 📌 **La domanda, e costa una rilettura della propria correzione prima di committarla:** *quanto di questa frase è un fatto che ho misurato, e quanto una qualificazione che gli ho messo intorno?* ✅ **HA RETTO UNA SECONDA VOLTA il 2026-08-20, chiudendo il Task 9 — stessa istruzione, stesso esito: 12 righe messe contro 15 tolte, 145 parole contro 203, e il ciclo chiuso in UNA passata.** ⛔ **Ma la prova nuova è di specie diversa, e questa è la parte che il Task 8 non aveva:** quell'ondata si è trovata **da sola** una **quinta** esclusività stantia che **nessuna delle due revisioni aveva nominato** — *«proves what no other probe here proves»*, falsa dalla stessa uscita che smentiva le altre quattro. 📌 **Al Task 8 il #76 comprava la CONVERGENZA; qui compra anche il RITROVAMENTO:** un'istruzione a **togliere** manda a **cercare** le altre occorrenze della stessa forma, mentre una a **riscrivere** fa guardare **solo il sito indicato**. ⚠️ La differenza non è di zelo ma di **perimetro**: *riscrivi questa frase* nomina un sito, *togli le frasi di questa specie* nomina una **classe**. ⛔ **E il ciclo di revisione del Task 11 porta la misura sul NUMERO, il 2026-08-25.** Prima del ciclo il compendio aveva **una** casa che al posto di un conteggio porta un **rimando a `git log`**; la prima ondata ne ha aggiunte **due**, e le ha aggiunte perché una revisione vi aveva trovato il numero sbagliato. Da lì in poi nessuna delle tre ha prodotto un rilievo, mentre la regola messa in forma **esortativa** — *si riporta il comando e la popolazione* — è stata scritta **due volte** e ha ceduto lo stesso, nell'unico punto in cui a un conteggio è stata aggiunta una **promessa** sulla popolazione. 📌 **Togliere elimina la classe; disciplinare la governa** — e una classe governata continua a costare un giro. |
...
| 80 | ⛔ **Un cancello che legge file che NON si consegnano ha un verdetto che dipende dalla cartella di lavoro: è rosso per il lavoro di chi lo esegue, e il suo verdetto non dipende solo da ciò che si consegna.** Misurato il 2026-08-24, nona ondata del Task 11: `check-docs.sh` scandiva `find . -name '*.md'` con due sole esclusioni, quindi leggeva anche i `.md` dentro `.superpowers/` — cartella **interamente ignorata** da git (`git ls-files .superpowers/` è vuoto). Tre link rotti dentro un pacchetto di revisione, mai committato e mai committabile, davano `GATE RED`, e il rosso si leggeva come un difetto del compito. ⛔ **E il danno vero è l'altra direzione:** un cancello il cui insieme d'ingresso lo decide il disco può anche essere **verde per assenza** — nessuno se ne accorge, perché un verde non si indaga. ⚠️ **Non è il #41**, dove un filtro **esclude** ciò che il controllo dovrebbe vedere: qui il filtro **manca**, e il controllo vede ciò che non lo riguarda. ⚠️ **E non è il #38**, dove l'atto di misurare **modifica** lo stato: qui non si modifica niente, e lo strumento risponde correttamente alla domanda sbagliata. 📌 **La forma generale:** *l'insieme d'ingresso di un cancello è ciò che si CONSEGNA, non ciò che si trova sul disco.* ⛔ **E le due riparazioni ovvie sono ENTRAMBE sbagliate, il che è la metà utile di questa riga.** Escludere la cartella **per nome** lascia aperti `/scratch/` e `/tmp/`, che sono ignorati anch'essi e dove `CLAUDE.md` manda **ogni** misura: la regola giusta è quella **generale** — non si legge ciò che git ignora. E scandire i soli file **tracciati** (`git ls-files`) perde copertura **proprio nella corsa che conta**, perché il cancello gira **prima** del commit e un documento nuovo non ancora `git add`-ato sfuggirebbe: *non tracciato* e *ignorato* sono due cose diverse, e solo la seconda si scarta. ⚠️ **E il filtro va fatto FALLIRE APERTO:** se l'interrogazione a git non risponde, l'insieme degli ignorati resta vuoto e si scandisce tutto — un filtro che fallisse **chiuso** non scandirebbe nulla e uscirebbe **verde**, che è il gotcha **#26**. 📌 **La domanda, e costa una riga:** *questo controllo legge solo ciò che si consegna — e se la sua interrogazione fallisse, esce verde o rosso?* ⛔ **SECONDA FORMA, misurata il 2026-08-25 chiudendo il ciclo di revisione del Task 11 — e il soggetto non è un cancello ma una REVISIONE.** L'unico Important dell'ultimo giro viveva in un **rapporto di lavoro** che git ignora, cioè in un artefatto che nessuno riceve; nei file tracciati non c'era. Continuare a rivedere avrebbe dato un verdetto che dipende dalla **cartella di lavoro**, esattamente come il cancello di questa riga — e la revisione, a differenza del cancello, **non ha un `--name-only`** che le dica dove finisce il proprio ingresso: se lo deve dichiarare. ⚠️ **La direzione utile resta quella già scritta qui:** il danno grosso non è il rilievo di troppo, è che un perimetro non dichiarato lascia **verde per assenza** ciò che si consegna davvero. 📌 **La domanda, per una revisione:** *questo rilievo vive in un file che il commit porta con sé?* |
| 81 | ⛔ **Uno spazio di stati non si allarga aggiungendo SEMI: si allarga rompendo la SIMMETRIA fra i soggetti — e una campagna che ne spazza ventimila può esplorare UN mondo solo.** Misurato il 2026-08-25, eseguendo il Task 12 del Traguardo 5. Lo scenario che il piano dettava per la campagna DST dell'arbitro produceva **un** esito distinto — `granted 4, queued 8, refused 0, peak 6144` — su **ventimila** semi, cioè faceva fallire `the_campaign_sweeps_more_than_one_world`, che è l'oracolo di non-vacuità che il compito **stesso** detta. ⛔ **Le due cause, lette nel codice e poi separate una variabile alla volta:** le attività erano **identiche in tutto ciò che i libri vedono** — stessa riserva, distinte solo per **corsia**, e sotto `RemotePolicy` la corsia sceglie in quale **coda** finisce un biglietto, non **quanti** entrano — quindi permutarle cambia **chi** viene servito e non **quanti**; e `now` veniva dall'**indice del ciclo**, quindi l'istante in cui una parte chiede era calcolabile dal proprio indice e l'interlacciamento non arrivava all'arbitro. ✅ **Rotta la simmetria — quattro parti con taglie, corsie, finestre e ritmi diversi — e letto `now` dall'orologio virtuale, gli esiti distinti sono SETTE**, e il cancello li stampa a ogni corsa: `DST arbiter worlds: 7 distinct outcomes over 2000 seeds`. ⛔ **E la controprova è stata eseguita, che è la seconda direzione del #24:** dentro lo scenario di oggi, rese le quattro parti di nuovo **identiche**, gli esiti tornano **uno**. 📌 **La forma generale:** *lo spazio è limitato dalla FORMA dello scenario — i soggetti, le loro taglie e i loro ritmi — non dalla sua LUNGHEZZA né dal numero di semi*, e la misura scritta accanto a `REQUESTS` in `crates/simulator/tests/arbiter_campaign.rs` lo dice in cifre: allungando lo scenario da quattro richieste a sei e a otto gli esiti passano da **7** a **8** a **9**, mentre una spazzata passa da **369** a **578** a **750 ms**. ⚠️ **Non è il #28:** là a mancare è un **parametro non consegnato**, cioè una costante nascosta, e la cura è **consegnarlo**; qui ogni parametro è consegnato e a mancare è la **differenza fra i soggetti**. ⚠️ **E non è il #17**, dove il guasto è iniettato dove il codice non arriva: qui l'iniezione arriva, e non ha niente su cui mordere. ⚠️ **E non è il #18**, ma ne è il gemello con la manopola girata dall'altra parte: là *un solo giro non è una misura*, qui **ventimila semi non lo sono lo stesso**. 📌 **La domanda, e costa una corsa:** *quanti esiti distinti produce davvero questo scenario — e se rendo i suoi soggetti identici, quanti ne restano?* |
| 82 | ⛔ **UNO STRUMENTO CHE RISCRIVE UN FILE LO TRONCA PRIMA DI SAPERE SE HA QUALCOSA DA SCRIVERE, e il fallimento arriva DOPO: quel che resta non è il file vecchio, è ZERO BYTE.** Misurato il **2026-08-27**, chiudendo la radice R4: uno script di rimedio apriva `docs/superpowers/specs/2026-08-06-sottoprogetto-1-kernel.md` in scrittura e poi falliva nella codifica del testo nuovo — `UnicodeEncodeError` su una coppia surrogata. L'apertura in scrittura **tronca**, quindi il file era già vuoto quando l'errore è stato sollevato: **294595 byte → 0**, `git diff --stat` a **4036 deletions**. ✅ **Recuperato da `git checkout --` perché il file era PULITO a HEAD**, e questa è l'unica ragione per cui è finita bene: su un file con modifiche non committate lo stesso incidente le avrebbe portate via. ⛔ **La cura è una riga e vale per qualunque strumento:** si **costruisce e si codifica tutto il contenuto nuovo PRIMA**, si scrive in un file **temporaneo**, e solo allora si rinomina sopra l'originale — una rinomina non può fallire a metà. ⚠️ **Non è il gotcha dei fine-riga di `CLAUDE.md`**, che parla di uno strumento che riscrive *bene* ma **normalizza** i byte che non gli sono stati chiesti: là il file resta, qui **sparisce**. ⚠️ **Ed è imparentato col #48 in un punto solo:** *si revoca ripristinando da una copia presa PRIMA*, e la copia qui è stata `git`. 📌 **La domanda, e costa una riga di codice:** *se la costruzione del contenuto nuovo fallisse a metà, che cosa resta sul disco?* |
...
| il testo integrale dei **gotcha** e delle **misure**, con i numeri | [`HANDOFF.md`](HANDOFF.md) — ⚠️ **a sezioni** | 281 KB |
...
| l'ordine dei dodici sotto-progetti e le dipendenze | [`roadmap.md`](roadmap.md) | 34 KB |
...
| **dove vive ogni controllo** della porta, riga per riga sul catalogo §7.4, e cosa **non** è coperto | [`porta-di-qualita.md`](porta-di-qualita.md) | 422 KB |
...
| ⛔ **il messaggio da incollare all'inizio di una chat**, e il perché di ogni sua riga | [`AVVIO-CHAT.md`](AVVIO-CHAT.md) — ⚠️ il **messaggio** ne è **18,4** (18835 byte LF, rimisurati il 2026-08-25) | 31 KB |
