...
dal 2026-08-10: tre compiti su dodici, `GATE GREEN` a tutti** — il **record durevole**
(`crates/kernel/src/record.rs`), la **riga di catalogo dell'etichetta di fiducia** col proprio
caso negativo, e il **doppio in memoria del giornale** (`crates/simulator/src/journal.rs`).
⏭️ **Il prossimo passo è il Task 4**, la suite di conformità e i tre bugiardi. Il
