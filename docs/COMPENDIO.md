...
**Aggiornato il 2026-09-07**, col puntatore della §6 riscritto tre volte lo stesso giorno: per il **brainstorming a metà del sotto-progetto 2**, per la **stella polare della GUI** in cui quel brainstorming si è allargato, e per la **chiusura della sezione 1** della stella polare, il catalogo dei moduli, alla seconda ripresa; l'ultimo contenuto di **merito** è quel puntatore. Manutenzione: §13.
