...
citata. Fatti: la stella polare, la testa dell'audit, il riquadro delle voci aperte di questa §6, questo puntatore. Resta
`CLAUDE.md`; poi `AVVIO-CHAT.md`, se il proprietario lo incolla ancora.
