...
dal 2026-08-10: sei compiti su dodici, `GATE GREEN` a tutti** — il **record durevole**
...
(`crates/kernel/tests/journal_contract.rs`), l'operazione **`replay()`** sulla porta e la
**riconciliazione** (`crates/kernel/src/reconcile.rs`).
...
| ⛔ **il compito da cui si riprende** — è il piano **in corso**, dodici compiti: i primi **sei sono eseguiti**, si riprende dal **Task 7**. ⚠️ **L'errata in testa si legge prima del compito** | [`plans/2026-08-10-sottoprogetto-1-traguardo-3-giornale-e-formato-durevole.md`](superpowers/plans/2026-08-10-sottoprogetto-1-traguardo-3-giornale-e-formato-durevole.md) — ⚠️ **a compiti, mai intero** | 95 KB |
