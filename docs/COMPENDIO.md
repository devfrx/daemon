...
dal 2026-08-10: due compiti su dodici, `GATE GREEN` a entrambi** — il **record durevole**
(`crates/kernel/src/record.rs`) e la **riga di catalogo dell'etichetta di fiducia** col proprio
caso negativo. ⏭️ **Il prossimo passo è il Task 3**, il doppio in memoria del giornale. Il
...
7. 🔄 **Il codice del Traguardo 3 — in esecuzione dal 2026-08-10**, subagent-driven, un compito per volta con revisione fra uno e l'altro. **Due compiti su dodici**, `GATE GREEN` a entrambi: il **record durevole** — enum di versione `Record::V1`, quattro campi con indice esplicito, `Debug` scritto a mano che non stampa il payload — e la **riga di catalogo dell'etichetta di fiducia** (`Q9 · I6 · V20 · §4.9`) col caso `record_without_trust_label.rs`. ⛔ **Un'errata in testa al piano, sette voci dal solo Task 1**, e i costi misurati stanno in [`riferimenti.md`](riferimenti.md): la collisione `record`/`boundary` che ha riscritto **due oracoli pre-esistenti** è permanente. ⏭️ **Il prossimo è il Task 3**, il doppio in memoria del giornale.
...
| ⛔ **il compito da cui si riprende** — è il piano **in corso**, dodici compiti: i primi **due sono eseguiti**, si riprende dal **Task 3**. ⚠️ **L'errata in testa si legge prima del compito** | [`plans/2026-08-10-sottoprogetto-1-traguardo-3-giornale-e-formato-durevole.md`](superpowers/plans/2026-08-10-sottoprogetto-1-traguardo-3-giornale-e-formato-durevole.md) — ⚠️ **a compiti, mai intero** | 95 KB |
