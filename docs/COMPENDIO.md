...
**Aggiornato il 2026-09-07**, col puntatore della §6 riscritto due volte lo stesso giorno: per il **brainstorming a metà del sotto-progetto 2**, e poi per la **stella polare della GUI** in cui quel brainstorming si è allargato, fermata anch'essa dal proprietario e da riprendere in una sessione nuova; l'ultimo contenuto di **merito** è quel puntatore. Manutenzione: §13.
...
[piano](superpowers/plans/2026-09-04-knowledge-base-documenti.md). ✅ **E IL PIANO È ESEGUITO IL 2026-09-05**, `GATE GREEN` a ogni compito: i quattro rimandi in testa a ADR-0008, 0009, 0010 e 0038 e la riga di ADR-0039; la riga 13 «Registro delle guide, trigger e proiezione» in roadmap con le celle 3 e 6; le sei righe di tracciabilità; la decisione 7 dei gesti chiusa in tutte le sue case. ⏭️ **IL PROSSIMO PASSO: IL SOTTO-PROGETTO 2 — IL SUO BRAINSTORMING È PROSEGUITO IL 2026-09-07 E SI È ALLARGATO ALLA STELLA POLARE DI TUTTA LA GUI**, per scelta del proprietario, e si è fermato di nuovo dopo il quarto wireframe: le cinque domande e la modularità decise — pannelli agganciabili di `dockview`, a condizione di uno spike che il proprietario giudica provandolo — la Home approvata, Lavoro e Compatta col grafo presentati e **da confermare**, il 2 ritagliato come cornice più la sua fetta, e Passi che nasce col 2; restano le sei sezioni scritte della stella polare e le §7–§10 del 2, poi i due disegni e il piano. Si riprende **in una sessione nuova** da [`specs/2026-09-07-direzione-gui-design.md`](superpowers/specs/2026-09-07-direzione-gui-design.md), da leggere **per intero**, poi dalla consegna del 2 [`specs/2026-09-06-sottoprogetto-2-gui-minima-design.md`](superpowers/specs/2026-09-06-sottoprogetto-2-gui-minima-design.md), coi richiami datati del 2026-09-07; il testo della consegna dell'avvio sta in [`archivio/consegna-avvio-brainstorming-sottoprogetto-2.md`](archivio/consegna-avvio-brainstorming-sottoprogetto-2.md), parola per parola. ADR-0029 si chiude con M1–M5 all'inizio del 2 (voce 0029 della §5) — **e in parallelo AUD-004**, l'ADR del proprietario che sbarra il 13 (voce 3 della rilettura del disegno della knowledge base); poi il 13, poi il 3 — decisione 16. ⛔ **AUD-004 sbarra il 13**, non il 2.
