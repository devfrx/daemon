...
**suite di conformità** con **sette promesse e sette bugiardi**
(`crates/kernel/tests/journal_contract.rs`) e l'operazione **`replay()`** sulla porta.
