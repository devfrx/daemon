...
| [`superpowers/plans/`](superpowers/plans/) | i **quattro** piani scritti finora — lo **stack**, il **Traguardo 1**, il **Traguardo 2** (tutti e tre **eseguiti**) e il **Traguardo 3**, scritto il 2026-08-10 **ed eseguito lo stesso giorno**, dodici compiti su dodici — quindi **tutti e quattro** eseguiti. ⚠️ **Questa cella diceva *«da eseguire»*** a traguardo chiuso. Ciascuno porta un'**errata in testa** che documenta dove il piano sbagliava: quella del Traguardo 2 conta **sei passate e quarantanove voci**, quella del Traguardo 3 **nove passate e settantasette voci**, di cui **nove decisioni**. ⛔ Un piano non si riscrive: è il registro di ciò che fu osservato eseguendolo |
