...
Aggiornato il **2026-08-20**, durante l'**esecuzione del Traguardo 5** del sotto-progetto 1 —
...
| 5 | arbitro GPU — ammissione, corsie, concessione, le due policy | 🔵 **aperto il 2026-08-18** — brainstorming chiuso, disegno e [piano](superpowers/plans/2026-08-18-sottoprogetto-1-traguardo-5-arbitro-gpu.md) scritti, **tredici compiti in cinque parti**; **esecuzione in corso dal 2026-08-19**, `GATE GREEN` a ogni compito. ⛔ **A che punto sia NON è scritto qui:** il numeratore vive nella **§6 del [`COMPENDIO.md`](COMPENDIO.md)**, in un posto solo — questa cella diceva `⬜` con sei compiti eseguiti, che è la stessa specie di difetto del finding **D-1** |
