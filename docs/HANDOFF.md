...
⏭️ **Proseguire l'esecuzione del piano del Traguardo 4, dal Task 5** — subagent-driven, un
compito per volta con revisione fra uno e l'altro. ✅ **La PARTE 1 è completa: quattro compiti su
dieci eseguiti il 2026-08-11**, `GATE GREEN` a ciascuno — il giornale che cade, lo scenario
giornalato con `C7a`, **`C7b`**, e la campagna breve col numero di semi **misurato**. Il Task 5
apre la **Parte 2**, dove il soggetto non è più la riconciliazione del kernel ma la **coerenza di
`redb` dopo il crash**. ⛔ **E le trentasei voci d'errata si leggono prima**, in testa al piano:
**sette sono decisioni**, e la più istruttiva resta **E17** — *«l'iniezione è avvenuta»* e *«c'era
qualcosa da verificare»* sono **due** affermazioni, e una campagna che tiene solo la prima è verde
avendo confrontato insiemi vuoti. ⛔ **Una voce sola vincola la Parte 2: E36**, e la sua prima
riga è la stessa lezione applicata al livello 2 — **il Task 6 ha un solo oracolo di non-vacuità**,
e il punto di iniezione si estrae fra **tutte e sei** le operazioni di `StorageBackend`, `read` e
`len` comprese: se cadessero tutti su letture, l'archivio riaperto sarebbe identico a quello
scritto e il verde non proverebbe nulla. ✅ **Brainstorming, disegno e piano sono tutti chiusi il 2026-08-11:** il
