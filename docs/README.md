...
| [Design system — la consegna dell'avvio](superpowers/specs/2026-09-22-design-system-design.md) | il design system della GUI | ⛔ **Non è ancora un disegno:** è la consegna dell'avvio del brainstorming, nata il 2026-09-22; il disegno la riscriverà sul posto, e la consegna andrà in archivio parola per parola |
