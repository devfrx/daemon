...
| [`audit-2026-08-27.md`](audit-2026-08-27.md) | ⛔ **il secondo audit completo** — 18 revisori in parallelo, ognuno smentito da un secondo, 98 finding proposti e **25 scartati**. Le **sette radici**, i **73** finding con causa radice e comando di riproduzione, e lo **stato di ciascuno**. ⚠️ **Si legge a finding, mai intero** | *cosa è ancora aperto*, e con quale prova |
