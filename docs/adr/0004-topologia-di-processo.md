...
| **I4** | Il protocollo IPC è privato, singolo e non versionato: un trasporto, uno schema, nessun broker, nessun service discovery. | Nessun consumatore esterno, per [ADR-0003](0003-estensibilita-solo-mcp-e-skill-dichiarative.md) — ⚠️ **verifica completata da [ADR-0035](0035-porta-verso-i-worker-e-lettura-di-i4.md)**: questa riga dice *esternalità*, non quanti dei nostri processi parlino il protocollo. «Singolo» si legge **per canale privato**: anche il canale verso i worker è privato, non versionato, senza broker né discovery |
