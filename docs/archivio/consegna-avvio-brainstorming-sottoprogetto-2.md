# Archivio — la consegna dell'avvio del sotto-progetto 2, 2026-09-06

⛔ **Non è una lettura obbligatoria.** È il **verbale** della consegna con cui la sessione del
**2026-09-06** — quella che ha chiuso E10 e raccolto il contesto del sotto-progetto 2 senza fare il
brainstorming — ha passato il testimone, tenuto **parola per parola** coi soli link riscritti per
questa cartella. Spostato qui il **2026-09-07**, quando la sessione del brainstorming, fermata a metà
dal proprietario, ha riscritto **sul posto** il file come propria consegna, con la regola di
`CLAUDE.md`: *un documento vivo porta ciò che è vero adesso, e un verbale va in archivio*. Il
precedente è [quella della knowledge base](consegna-brainstorming-knowledge-base.md).

⚠️ **Ciò che è scritto qui era vero il giorno in cui fu scritto.** La consegna viva è
...
2. **E10 decisa dal proprietario: A** — la riga «Registro delle guide (13) dopo la GUI minima…» di
   ...
   [piano dei documenti](../superpowers/plans/2026-09-04-knowledge-base-documenti.md) — `af594c7`. Nessun altro
...
| Da | Che cosa | Dove |
|---|---|---|
| il disegno dei gesti | pannelli e menu che si muovono con **qualunque puntatore**; la mano è un puntatore in più e la aggiunge il 12. La variante di `IpcMessage` con la mano **si definisce quando la GUI esiste**, non prima. Il registro delle funzioni nasce col click | [disegno](../superpowers/specs/2026-09-03-riconoscimento-gesti-design.md), §4 |
| il disegno della knowledge base | il pannello della mappa nasce **col 6, non col 2**: il 2 disegnerebbe un indice che nessuno produce ancora. «Aggiungi al contesto» avrà due invocatori, il click e il modello, sullo stesso registro | [disegno](../superpowers/specs/2026-09-04-knowledge-base-design.md), domanda 12 e §2.3 |
