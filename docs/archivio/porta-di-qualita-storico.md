# Archivio — `porta-di-qualita.md` com'era il 2026-09-24, prima della compressione

⛔ **Non è una lettura obbligatoria.** È il registro della porta di qualità **intero, parola per parola**, com'era a
`c4ec042`, l'ultimo commit che lo ha toccato prima della compressione senza perdite del 2026-09-24 — decisione 10 del
[verbale degli sfoltimenti](../superpowers/specs/2026-09-23-ridimensionamento-lettura-design.md). Il file vivo,
[`porta-di-qualita.md`](../porta-di-qualita.md), porta ciò che è vero adesso e, in fondo, l'indice *«sezione di prima →
dove sta ora»*.

⚠️ **Ciò che è scritto qui era vero il giorno in cui fu scritto**, e dentro c'è la cronaca: le tabelle di mutazione, i
richiami datati, i conteggi, le passate di revisione. Le contraddizioni col codice di oggi **non sono corrette qui**:
restano come verbale del loro giorno, e quelle delle unità ancora vive sono elencate in fondo al file vivo. I commenti
nel codice che nominano una sezione di questo registro — *«task 8 section»*, *«section "P-2"»*, *«row 15 of the mutation
campaign»*, *«OPEN ENTRY 3»* — si risolvono **qui**, coi titoli com'erano.

📌 **L'unica modifica al testo sono i link relativi, riscritti per questa cartella.** La prova rifà il confronto e deve
mostrare **solo** righe con un link:
...
[`archivio/stato-storico.md`](stato-storico.md), parola per parola; nella §6 restano gli indici, la
...
di nomi invecchierebbe alla prima che si chiude:
