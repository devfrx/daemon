...
✅ **RICHIAMO DEL 2026-09-09:** quei blocchi sono ora **qui**, nella sezione *«Il racconto delle voci aperte
dei Traguardi 3–5»* in fondo al file, per il **taglio 3** del mandato del proprietario (decisione 26 della
[stella polare della GUI](../superpowers/specs/2026-09-07-direzione-gui-design.md)); nella §6 restano gli
indici, la tabella del 2026-08-10 e due voci che vivevano solo nel racconto.
...
## La cronaca delle riprese della stella polare della GUI — archiviata il 2026-09-09

⛔ **Estratta dal compendio il 2026-09-09**, undicesima ripresa della stella polare della GUI, prima di scrivere la sua §4: il
margine del tetto di `check-docs.sh` era sotto i duemila byte (gotcha #100), e la cronaca ripresa per ripresa vive già in
[`../superpowers/specs/2026-09-07-direzione-gui-design.md`](../superpowers/specs/2026-09-07-direzione-gui-design.md), in «Da sapere
subito» e in «Fatto in questa sessione». Qui sotto, **parola per parola** com'erano al commit `4100b78`, l'intestazione del compendio
e la parte del puntatore della §6 che portava la cronaca, dalla freccia in poi; i soli link sono riscritti per questa cartella. Lo
stato di oggi sta nella §6 del compendio, in un posto solo.

### L'intestazione

**Aggiornato il 2026-09-08**, col puntatore della §6 riscritto per la **chiusura delle sezioni 2 e 3** della stella polare della GUI — la **settima porta** del kernel, decisa su delega — per il **mandato del proprietario** sulla passata dei diagrammi, che precede le sezioni 4–6, e — alla quarta ripresa dello stesso giorno — per l'**apertura della passata**: la decisione 17 delegata e presa, la sezione 1 presentata e in attesa — e alla **quinta** ripresa per la sezione 1 **scritta** e per la **decisione 18**, il metodo di ogni studio futuro, e per design/07 con ADR-0019 — e alla **sesta** per design/03, alla **settima** per design/08 e la sua chiusura, all'**ottava** per la lettera E della §8.2 della spec e per design/10, e alla **nona** per «la GUI dentro», le tre sequenze del protocollo core ↔ GUI, decisi su delega, e alla **decima** per la sezione 4 della stella polare — lo spike di accettazione di `dockview` — approvata e non scritta; l'ultimo contenuto di **merito** è quel puntatore. Manutenzione: §13.

### Il puntatore della §6, dalla freccia in poi

⏭️ **IL PROSSIMO PASSO: IL SOTTO-PROGETTO 2 — IL SUO BRAINSTORMING È PROSEGUITO IL 2026-09-07 E SI È ALLARGATO ALLA STELLA POLARE DI TUTTA LA GUI**, per scelta del proprietario, e si è fermato dopo il quarto wireframe, poi ripreso due volte lo stesso giorno: le cinque domande e la modularità decise — pannelli agganciabili di `dockview`, a condizione di uno spike che il proprietario giudica provandolo — la Home approvata, Lavoro e Compatta col grafo **approvati come mappa** (decisione 10), il 2 ritagliato come cornice più la sua fetta, e Passi che nasce col 2; ✅ **le sezioni 1–3 della stella polare sono CHIUSE** — il catalogo dei moduli il 2026-09-07 (decisioni 10–13); **viste e disposizione** e **la fetta del 2** il 2026-09-08, alla terza ripresa, con due decisioni delegate al coordinatore («decidi secondo la skill»): «salva disposizione» **fuori dal registro** (14) e una **SETTIMA PORTA** del kernel che custodisce la disposizione come pacchetto opaco (15) — letto nel codice che il messaggio arriva **dentro** il kernel (§5 del 2) e che nessuna delle sei porte esaustive della §3.1 tiene un pacchetto; la §2.3 e la §3.1 della spec, `ports/mod.rs` e la tabella delle finte ricevono il richiamo, compito del piano. 📌 **Il mandato del proprietario per la sessione nuova, PRIMA delle sezioni 4–6 (decisione 16):** una **passata sui diagrammi** — aggiornare quelli esistenti (design/09: «configurazione» guadagna la disposizione, le guide sono file della knowledge base dal disegno del 2026-09-04, la policy VRAM al riavvio; le sette famiglie dove le sei sono scritte), **crearli dove mancano** (ER compresi: nessuno esiste, e la GUI dentro non ha un diagramma), e **correggere la progettazione** dove un diagramma mostra un errore — la correzione torna al proprietario in forma A/B, con richiamo datato. ✅ **La passata è APERTA dal 2026-09-08, quarta ripresa:** i nove file di `docs/design/` letti diagramma per diagramma; la policy VRAM al riavvio **decisa su delega (17)** — la corrente è la **proiezione del giornale**, il profilo dà il default, rimando ad ADR-0006 da scrivere; la **sezione 1** della passata (design/09 e le sue conseguenze in ADR-0022, ADR-0006, design/02, design/05) **presentata e in attesa dell'A/B**. ✅ **E SCRITTA alla quinta ripresa, lo stesso giorno** — design/09 (il diagramma degli archivi, la colonna «Chi lo raggiunge», la telecamera in «riservato», due regole), i rimandi in testa ad ADR-0022 e ADR-0006, una riga in design/02 e una in design/05 — approvata **A con due correzioni** nate dalla domanda del proprietario *«stai tenendo conto di scalabilità, di quanto verrà e di quanto già esiste?»*: «guide approvate (col 13)» nel giornale, e le due vie della configurazione (i profili consegnati dal daemon, ADR-0034; la disposizione dalla settima porta). Da lì la **decisione 18**, scritta in `CLAUDE.md`: ogni studio, brainstorming o diagramma controlla ciò che esiste, ciò che arriva e se regge crescendo, e lo schema corregge logiche, ADR e codice se è più corretto. ✅ **E la sezione 2 è cominciata lo stesso giorno:** design/07 riscritto — sette fonti del degrado (il fallback dichiarato di ADR-0012 esiste già nel codice, la telecamera arriva col 12), la GUI viva a GPU satura, le proiezioni a classi, «Dove» e «Chi» in «sempre visibile» — col rimando in testa ad ADR-0019, approvato A. ✅ **E design/03 è scritto alla sesta ripresa** (A), col richiamo alla tabella Passi della stella polare — i tipi di record sono **sei**, letti nel codice — e con la registrata sui due passi per invocazione, chiusore il 3. ✅ **E design/08 alla settima** (A): la GUI entra nello strato deterministico (col 2), le suite di conformità sono nominate con la regola che le fa crescere, lo stato delle Q resta nella §8.4 della spec; corrette due frasi — il «ciclo lungo» della DST profonda che non esiste (vincolo 8 della §11), la valutazione del linguaggio già fatta da ADR-0026 — e registrate per il proprietario la lettera E della §8.2 (7, contro il 12 di ADR-0039) e l'innesco B (3) di Q6/Q11. **La sezione 2 della passata è chiusa.** ✅ **La lettera E della §8.2 della spec è decisa su delega all'ottava ripresa (19): il primo worker vero è del 12**, scritto nelle tre righe della spec che portavano il 7, col richiamo datato in «Sulla E». ✅ **E il primo disegno della sezione 3 è SCRITTO, su delega (20):** [design/10](../design/10-modello-dei-dati-durevoli.md), il modello dei dati durevoli in due `erDiagram` — il giornale com'è nel codice, e ciò che è deciso con «(col N)». ✅ **E il secondo, «la GUI dentro», è SCRITTO su delega alla nona ripresa (21–23):** le tre sequenze del protocollo core ↔ GUI come `sequenceDiagram` nella stella polare, sotto «Il modello della GUI»; disegnare ha corretto due righe approvate del 2 col richiamo datato — `Approve` porta l'invocazione, perché il permesso è una nota su un passo già aperto, e «il core chiude» non è un'operazione della porta `ipc`. **La passata sui diagrammi è CHIUSA.** Si riparte dalle **sezioni 4–6** della stella polare, poi le §7–§10 del 2, i due disegni e il piano. ✅ **E la sezione 4 è APPROVATA (A) alla decima ripresa, lo stesso giorno, e NON scritta:** lo spike di accettazione di `dockview` dentro lo spike del guscio — sette mosse giudicate dal proprietario, il protocollo prima, M4 con `dockview` acceso — sta parola per parola nella stella polare, nel prossimo passo; **aperta** la domanda sulla **mossa 8**, la mano di SP-7 come puntatore (letto alla fonte: `dndStrategy: 'pointer'`). Si riparte da quella risposta, poi si scrive la §4, poi le sezioni 5 e 6. Si riprende **in una sessione nuova** da [`specs/2026-09-07-direzione-gui-design.md`](../superpowers/specs/2026-09-07-direzione-gui-design.md), da leggere **per intero**, poi dalla consegna del 2 [`specs/2026-09-06-sottoprogetto-2-gui-minima-design.md`](../superpowers/specs/2026-09-06-sottoprogetto-2-gui-minima-design.md), coi richiami datati del 2026-09-07; il testo della consegna dell'avvio sta in [`archivio/consegna-avvio-brainstorming-sottoprogetto-2.md`](../archivio/consegna-avvio-brainstorming-sottoprogetto-2.md), parola per parola. ADR-0029 si chiude con M1–M5 all'inizio del 2 (voce 0029 della §5) — **e in parallelo AUD-004**, l'ADR del proprietario che sbarra il 13 (voce 3 della rilettura del disegno della knowledge base); poi il 13, poi il 3 — decisione 16. ⛔ **AUD-004 sbarra il 13**, non il 2.

## Il paragrafo dell'audit nella §6 del compendio — archiviato il 2026-09-09

⛔ **Il taglio 2 del mandato del proprietario (decisione 26 della
[stella polare della GUI](../superpowers/specs/2026-09-07-direzione-gui-design.md)), approvato A il 2026-09-09:** la
lettura d'apertura dell'audit del 2026-08-27 si restringe alla tabella delle voci senza numero AUD e alla disciplina in
cinque passi, e il paragrafo della §6 che ordinava di leggere fino alla tabella dei 73 è riscritto più corto. Il testo
com'era, parola per parola, coi soli link riscritti per questa cartella:
...
## Il racconto delle voci aperte dei Traguardi 3–5 — archiviato il 2026-09-09

⛔ **Il taglio 3 del mandato del proprietario (decisione 26 della
[stella polare della GUI](../superpowers/specs/2026-09-07-direzione-gui-design.md)), approvato A il 2026-09-09:**
il riquadro *«Le voci ancora aperte, e il racconto che le circonda»* della §6 del compendio — il debito dichiarato
dello sfoltimento del 2026-08-28 — è ridotto agli indici, dopo che ogni voce è stata censita una per una contro le
tabelle uniche del registro ([`../porta-di-qualita.md`](../porta-di-qualita.md), Traguardi 5 e 6) e dell'audit; due
voci che vivevano solo qui hanno ora una riga nella tabella del 2026-08-10, che resta nel compendio col comando del
ritratto pieno. Qui il racconto **parola per parola**, coi soli link riscritti per questa cartella: i due paragrafi
di cronaca in testa alla §6, poi il riquadro intero, salvo ciò che resta nel compendio, segnato fra parentesi quadre.

### I due paragrafi di cronaca in testa alla §6, com'erano
...
[`archivio/stato-storico.md`](stato-storico.md) — che ne porta anche le **misure**, con
...
[`archivio/misure-dimensioni.md`](misure-dimensioni.md).
...
riassunti:** stanno in [`archivio/stato-storico.md`](stato-storico.md), parola per
...
*[Qui la §6 porta la tabella «Raccolte qui il 2026-08-10», che resta nel compendio con due righe in più.]*
