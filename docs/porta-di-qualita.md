...
la §7.4 è spec (il «vincolo globale 7» dei piani del sotto-progetto 1, idioma di questo file: una riga di catalogo nuova è decisione del proprietario — E235: nel piano della parte 2 il 7 è un altro), quindi le sonde si **registrano** e non si prendono — stesso trattamento di PL-1, di K-1/B-1
