...
| i **test di contratto** — porta `journal`, **una implementazione su due** | `crates/kernel/tests/journal_contract.rs`. ⚠️ **La seconda implementazione ESISTE dal 2026-08-10** — `platform::journal::FileJournal`, Task 8 — e la suite le gira contro **verde, otto promesse su otto**, misurato con un file usa-e-getta. ⛔ **Ma la suite non la esegue ancora dentro il repository**: quel file è il **Task 9**, e fino ad allora questa riga resta *«una su due»* invece di anticipare il verde | **J2** · **J3** · **J4** · **J5** · **J6** · **J7** · **J8** · **J10** | J1 · **J9** · **J11** |
