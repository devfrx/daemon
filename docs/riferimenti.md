...
| il giorno del compito 13, il 2026-09-21 | lo script Python sul registro npm che il compito detta — `grep -n 'registry.npmjs' docs/superpowers/plans/2026-09-11-sottoprogetto-2-parte-2-gui-minima.md` (⚠️ richiamo del 2026-09-22, E234: qui stava *«lo stesso `npm view`»*) | `dockview-core`, `dockview`, `pinia` e `reka-ui` ancora le appuntate; `vue-i18n` 11.4.12, `jsdom` 30.1.0, `@vue/test-utils` 2.5.1 e `@types/node@24` 24.13.6 più nuove delle appuntate, che si installano: restano quelle del piano | il messaggio di `8679f27` |
