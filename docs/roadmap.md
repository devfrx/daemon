...
Ultimo aggiornamento: **2026-09-24**, con la riga del piano del design system nella tabella dei piani, «scritto» — P-27 e D19 di quel piano.
...
| [Sotto-progetto 2 · parte 2 — la GUI minima](superpowers/plans/2026-09-11-sottoprogetto-2-parte-2-gui-minima.md) | I pezzi 2–9 della §3 della [stella polare](superpowers/specs/2026-09-07-direzione-gui-design.md): il filo in `platform`, lo schema che cresce, il registro delle funzioni, la **settima porta** `custody`, il daemon che ascolta, la SPA con `dockview`, il core finto, il passo del cancello; più **X-1** e **X-3** dell'audit (decisioni 44 e 45). **Tocca il codice di prodotto** | ✅ **scritto il 2026-09-15, eseguito il 2026-09-22** — `GATE GREEN` a ogni compito; la Definizione di «fatto» coi comandi sta nel piano. ⛔ **RICHIAMO DEL 2026-09-15: qui stava *«sedici compiti, i primi due scritti»*, falso in ENTRAMBE le metà** — i compiti si sono spostati scrivendo (D21, D25, D47) e la cifra non è riallineata ma **tolta**: la casa unica è la tabella della posizione del piano, e a contarli è il comando, non una riga di questo file |
| [Design system della GUI](superpowers/plans/2026-09-23-design-system.md) | le sezioni (a)–(f) del [disegno](superpowers/specs/2026-09-22-design-system-design.md): i token e i due temi, il kit con la pagina kit, il dock vestito, la cornice con la Panoramica e le viste col nome, le voci registrate, le sonde che diventano prove nel browser vero; e la chiusura. **Tocca il codice di prodotto**, in `gui/` e in `scripts/gate-gui.sh`, non il kernel né il filo | ⏳ **scritto il 2026-09-24**, da pre-controllare ed eseguire — a che punto è lo dice la tabella della posizione del piano |
