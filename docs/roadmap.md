...
Ultimo aggiornamento: **2026-09-15**, col conteggio dei compiti **tolto** dalla riga del [piano della parte 2 del sotto-progetto 2](superpowers/plans/2026-09-11-sottoprogetto-2-parte-2-gui-minima.md) nella tabella dei piani: a dirlo è la tabella della posizione di quel piano, in una casa sola.
...
| [Sotto-progetto 2 · parte 2 — la GUI minima](superpowers/plans/2026-09-11-sottoprogetto-2-parte-2-gui-minima.md) | I pezzi 2–9 della §3 della [stella polare](superpowers/specs/2026-09-07-direzione-gui-design.md): il filo in `platform`, lo schema che cresce, il registro delle funzioni, la **settima porta** `custody`, il daemon che ascolta, la SPA con `dockview`, il core finto, il passo del cancello; più **X-1** e **X-3** dell'audit (decisioni 44 e 45). **Tocca il codice di prodotto** | ⏳ **scritto il 2026-09-15, in revisione** — nessuno eseguito. ⛔ **RICHIAMO DEL 2026-09-15: qui stava *«sedici compiti, i primi due scritti»*, falso in ENTRAMBE le metà** — i compiti si sono spostati scrivendo (D21, D25, D47) e la cifra non è riallineata ma **tolta**: la casa unica è la tabella della posizione del piano, e a contarli è il comando, non una riga di questo file |
