...
> ⏭️ **Il prossimo passo è scrivere il piano del Traguardo 4**, il simulatore DST.
...
| 1 | Implementazione del kernel + simulatore DST | L0 + L1 | 🔵 **in corso** — spec completa (§0–§8, riapertura chiusa, §8 chiusa, audit passato). **Traguardi 1 e 2 ✅ eseguiti**: scheletro e porta di qualità, poi il substrato iniettabile e le sei famiglie di porte, `GATE GREEN`. ✅ **Traguardo 3 eseguito il 2026-08-10**, **dodici** compiti su dodici: il giornale e il formato durevole, coi **byte congelati**. ⏭️ **Traguardo 4** — il simulatore DST — è il prossimo, e il suo piano si scrive adesso. ⚠️ **Questa cella diceva «sette compiti su dodici»** a dodici eseguiti | 0, 0b, 0c |
...
| **4** | il simulatore DST | ⏭️ **il prossimo, e il piano si scrive adesso**: tempo virtuale, iniezione dei guasti, la campagna, i semi. Il `StorageBackend` su cui iniettare **esiste già**, ed è provato sostituibile da fuori la crate |
