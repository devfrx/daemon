...
> ciascuna il proprio indirizzo fra i Traguardi 5 e 6. ⏭️ **Il prossimo è il Traguardo 5**,
> l'arbitro GPU, e si comincia dal **brainstorming**. ⚠️ **Questa riga diceva *«il prossimo passo
...
| 5 | arbitro GPU | ⏭️ **il prossimo, e si comincia dal BRAINSTORMING** — non dal piano: ammissione, corsie, ciclo della concessione, le due policy. Eredita **cinque** delle nove righe di guasto che il Traguardo 4 ha lasciato scoperte con un indirizzo |
