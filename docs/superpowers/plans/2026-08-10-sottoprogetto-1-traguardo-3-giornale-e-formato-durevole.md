...
> questa sezione, poi il compito. **Trentatré voci in quattro passate:** le prime sette dal
> **Task 1**; le **quattordici** da **E8** in giù dai **Task 4 e 5**, eseguiti come un compito
> solo; **E22** da un passo preliminare al **Task 6**, **E23–E26** dal Task 6 stesso, ed
> **E27–E33** dal **Task 7**. ⛔ **E19, E22, E27 ed E28 non sono divergenze ma DECISIONI**, prese
