...
> questa sezione, poi il compito. Le prime sette vengono dal **Task 1**; da **E8** in giù dai
> **Task 4 e 5**.
...
| **E15** | Task 5, Step 3 | attende `test result: ok. 4 passed` | **criterio di chiusura stantio**, la stessa specie di **E4**: con sei bugiardi e la finta onesta i test sono **7**. Un conteggio atteso invecchia come ogni altra cifra — gotcha #31 |
