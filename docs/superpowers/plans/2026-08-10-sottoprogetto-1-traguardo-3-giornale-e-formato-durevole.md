...
> questa sezione, poi il compito. Le prime sette vengono dal **Task 1**; le **quattordici** da
> **E8** in giù dai **Task 4 e 5**, eseguiti come un compito solo; **E22** da un passo
> preliminare al **Task 6**, e le altre dal Task 6 stesso. ⛔ **E19 ed E22 non sono divergenze
> ma DECISIONI**, prese dal coordinatore eseguendo: si leggono per prime fra quelle, perché
> cambiano una **firma pubblica** o il contratto di una porta condivisa, e il proprietario deve
> poterle **ribaltare vedendole** invece di scoprirle.
