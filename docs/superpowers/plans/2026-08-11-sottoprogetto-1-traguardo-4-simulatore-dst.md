...
**Si legge prima del compito, non dopo.** ⛔ **Il piano non si riscrive:** resta il registro di ciò che fu deciso, e le divergenze si appendono qui con la loro misura. **Ventisei voci in tre passate** — otto dal **Task 1**, otto dal **Task 2**, **dieci** dal **Task 3**; ⛔ **quattro sono DECISIONI** (**E2**, **E6**, **E11**, **E17**), e il proprietario può ribaltarle vedendole. ⚠️ Questa cifra si riconta **sulle righe** e non a memoria: alla passata del Task 3 è stata scritta *«venticinque, nove dal Task 3»* e poi ne sono state appese **dieci** — il gotcha **#31** commesso dentro il capoverso che lo dichiara, e colto **prima** del commit solo perché il riconteggio è stato fatto sulla tabella.
