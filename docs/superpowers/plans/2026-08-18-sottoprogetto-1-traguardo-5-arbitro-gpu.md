...
| **E153** | Task 13, decisione del proprietario ereditata | ⛔ **`docs/riferimenti.md` STA FRA I `Modify:` DEL COMPITO E NON VA TOCCATO — seconda occorrenza, e la risoluzione è quella di `E146`.** La voce nacque per il Task 12 e vale **identica** qui: scegliere fra *«spostare le misure lì»* e *«cambiare la regola di `CLAUDE.md`»* è una decisione del proprietario, **registrata e non presa**, e cominciarla a chiusura di traguardo produrrebbe **due** convenzioni invece di una. ✅ **Rimisurata e non citata**, il 2026-08-25: `git rev-list --count dc6ac4c~1..HEAD -- docs/riferimenti.md` dà **zero** sui commit dell'esecuzione del Traguardo 5. ⛔ Le misure di questo compito vivono in [`porta-di-qualita.md`](../../porta-di-qualita.md) e nella §12 del [compendio](../../COMPENDIO.md), come per tutti i dodici compiti precedenti |
| **E154** | Task 13, pre-controllo del coordinatore | ⛔ **DUE LAVORI VERI NON STANNO FRA I `Modify:` DEL COMPITO, E VANNO FATTI LO STESSO.** ① Il Passo 4 prescrive di rileggere la riga del **disegno del Traguardo 5** che diceva *«piano da scrivere»*, ma `docs/superpowers/specs/2026-08-18-…-arbitro-gpu-design.md` **non è fra i file elencati**. ✅ Misurata: la riga era falsa **dal 2026-08-18**, cioè dal giorno stesso dell'approvazione del disegno, perché il piano fu scritto poche ore dopo — è il gotcha **#31** sull'**intestazione**, che nessuno rilegge perché è la cornice. Corretta con richiamo datato. ② La §12 del compendio dichiarava già che decidere se [`semi-dst.md`](../../semi-dst.md) guadagni una riga per la campagna dell'arbitro *«è lavoro del Task 13»*, e nemmeno quel file sta fra i `Modify:`. ✅ **Deciso: NON la guadagna**, perché la regola di quella pagina è che una voce nasce quando una campagna **fallisce**, e la campagna dell'arbitro non ha fatto fallire nessun caso — `GATE GREEN` e cinque sonde su cinque, rimisurate il 2026-08-25. Ciò che quel file guadagna è il **fatto** che le campagne sono tre, con le costanti che rendono interpretabile una voce della terza. 📌 **La classe, e vale oltre il caso:** l'elenco `Files:` di un compito è un'**affermazione come le altre** e si legge contro il codice — gotcha **#65** applicato all'intestazione invece che al corpo |
| **E155** | Task 13, in esecuzione | ⚠️ **IL CENSIMENTO `git ls-files --eol` VIVEVA IN DUE DOCUMENTI, ED È STATO TOLTO DA UNO.** La §6 del compendio lo portava dentro una **voce aperta** — *«140 · 75 · 4 · 3»*, misurato il 2026-08-20 — e [`porta-di-qualita.md`](../../porta-di-qualita.md) dentro un **verbale datato** del 2026-08-21, dove le stesse cifre sono giuste e restano. ✅ **Rieseguito il 2026-08-25:** `140 i/lf w/crlf · 85 i/lf w/lf · 4 i/crlf w/crlf · 3 i/-text w/-text` — la seconda cifra si è mossa di **dieci**, che sono i file LF/LF che il traguardo ha aggiunto; le altre tre reggono. ⛔ **Tolto dalla voce aperta e non riallineato**, per la regola di `CLAUDE.md`: una cifra che vive in più documenti si toglie. 📌 **La distinzione che questo caso insegna:** un **verbale** dice cosa fu misurato quel giorno e invecchia bene; una **voce aperta** si legge come *«questo è lo stato»* e invecchia male — la stessa cifra, due collocazioni, due destini |
