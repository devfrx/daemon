...
| **E174** | ⛔ **IL VINCOLO OPERATIVO DEL COMPITO 10 È IL TETTO DEL COMPENDIO, E VA MISURATO PRIMA DI SCRIVERE, non dopo.** ✅ **Misurato alla chiusura del compito 9:** `wc -c docs/COMPENDIO.md` → **204 584** byte contro il tetto di **208 896** di `scripts/check-docs.sh`, cioè **4 312** byte di margine. ⚠️ **E il gotcha #100 dice che il verde NON è un segnale di margine:** il 2026-09-01 il compendio era verde a **ventun** byte dal rosso. 📌 Il compito tocca la §6 in **due** punti soltanto — la tabella dei sei traguardi e il prossimo passo — e la §6 dichiara di sé che *«a che punto sia NON è scritto qui»*: il verbale va nella **§8 del disegno**, che è la decisione **B** della §7.1 e la ragione per cui quella §8 esiste |
