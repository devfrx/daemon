...
| **D** — i meccanismi | 5, 6, 7, 8 | ▶️ **IN CORSO** — ⛔ **QUALI compiti siano eseguiti lo dice il comando, non questa cella:** `git log --format='%h %s' | grep -E 'compito <n>'`, col numero della colonna «Compiti». ⚠️ **RICHIAMO DEL 2026-09-01 ②: qui stava *«i compiti 5 e 6 sono ESEGUITI … 7 e 8 sono scritti e non dispacciati»*, ed era falsa dal commit del compito 7, `8d45eea`.** È la **seconda** volta in due giorni che questa cella mente, e la prima ha già il proprio richiamo qui sotto: un'enumerazione che cresce a ogni compito **è** un numeratore, quindi è **tolta e non riallineata a «5, 6 e 7»** — precedenti **AUD-007** e **AUD-046**, *un elenco invecchia, una regola no*. Riallinearla per la seconda volta sarebbe la radice **R1** commessa dentro la cella che la registra. ⚠️ **RICHIAMO DEL 2026-09-01: questa cella diceva *«il compito 5 è ESEGUITO; 6, 7 e 8 sono scritti e non dispacciati»*, ed era stantia dal commit del compito 6** — che ha toccato questo stesso file senza muovere la propria posizione. È la cella dichiarata **casa unica** della posizione, quindi qui il difetto è peggiore che altrove: chi la legge non ha una seconda casa che lo smentisca. Scritta il 2026-08-30 — pre-controllo P-12…P-15, voce chiusa dalla **D22**. Il pre-controllo del compito 5 rese **cinque** voci, `E44`–`E48`, due bloccanti; eseguendo ne uscirono altre **tre**, `E49`–`E51`. ✅ **E il pre-controllo del compito 6 è FATTO, prima di dispacciarlo:** `E57`–`E62`, **due bloccanti**. ⛔ **QUANTI GIRI DI REVISIONE ABBIA AVUTO IL COMPITO 5, E CHE COSA RESTI APERTO, NON STA QUI: la casa unica è la voce `E53` dell'errata**, che porta il metodo, il perimetro e il perché. ⚠️ **RICHIAMO DEL 2026-09-01: questa cella PORTAVA quel racconto, appeso giro dopo giro, ed era STANTIA — si fermava al terzo mentre i giri fatti sono cinque, e diceva «due giri» in una frase e «tre» in quella dopo.** È il gotcha **#68** dentro la tabella che dichiara di tenere la **posizione**: un racconto che cresce a ogni passata non è una posizione, ed è **tolto e non riallineato** — sul precedente di **AUD-007** e **AUD-046**, *un elenco invecchia, un rimando no*. ⛔ **I VERBALI NON SONO TOCCATI:** `E46` ed `E53` portano una data che quella sessione credeva vera, ed è onesto che ce la portino; ogni riga porta il proprio commit, e `git show -s --format=%ad <hash>` è la sua data. ✅ **E IL COMPITO 6 È STATO RIVISTO IL 2026-09-01, dopo essere stato consegnato SENZA revisione:** il settimo giro del ciclo di `E53` e la revisione del compito 6 hanno lo **stesso** perimetro — `git diff c63c8c8..HEAD -- crates/` — e sono stati fatti come una passata sola. **Cinque rilievi, `E97`–`E101`, tutti riverificati dal coordinatore e tutti veri**, di cui **due di prodotto**. |
| **E** — la prova e la chiusura | 9, 10 | ✅ **ESEGUITA** — ⛔ **QUALI compiti siano eseguiti lo dice il comando, non questa cella:** `git log --format='%h %s' | grep -E 'compito 10'`, col numero della colonna «Compiti». Scritta il 2026-08-30, e il pre-controllo aveva trovato **P-16**, un meccanismo che la mappa dei file non ospitava |
...
| **E53** | ⛔ **IL COMPITO 5 È STATO ESEGUITO IN SESSIONE E NON SUBAGENT-DRIVEN. ✅ IL CICLO DI REVISIONE È STATO FATTO IL 2026-08-31, DA UNA SESSIONE FRESCA E NON DA UN SOTTO-AGENTE, E HA TROVATO TRE RILIEVI DI CUI DUE MUTANTI VIVI.** ⚠️ **La voce NON è cancellata e il residuo NON è azzerato: è RIDOTTO, e la differenza va detta.** L'intestazione di questo piano prescrive *«un subagente fresco per compito con revisione fra uno e l'altro»*; i sotto-agenti erano disabilitati il giorno dell'esecuzione e **lo erano ancora** il giorno della revisione — a una seconda domanda diretta è stato risposto *«decidi secondo i criteri»*, che è **letteralmente ciò che questa voce aveva già registrato non essere il permesso**. ✅ **CHE COSA COMPRA UNA SESSIONE FRESCA, e non è poco:** chi ha rivisto **non aveva scritto quel codice**, che è la proprietà che questa voce dichiarava comprare i rilievi — *«un revisore fresco legge il prodotto senza sapere che cosa l'autore intendeva»*. E li ha comprati: `E54`, `E55` ed `E56`, due dei quali sono **mutanti vivi sull'intero workspace** che le cinque mutazioni dettate non potevano vedere, perché **nessuna delle cinque li toccava**. ⛔ **CHE COSA NON COMPRA, misurato e non temuto:** chi ha rivisto aveva letto la §6 del compendio e l'intestazione del piano **prima** di aprire il codice, quindi conosceva già `E51`, `E52` e il gotcha **#95**. La contaminazione è sui rilievi **già trovati** e non su quelli da trovare — ma è reale, ed è meno indipendenza di quella che un subagente ha per costruzione. E **un solo giro**, non *«si rivede finché una passata non torna pulita»*. 📌 **IL RESIDUO CHE RESTA, per chi riprende:** il compito 5 ha avuto **una** revisione dove gli altri compiti di questo traguardo ne hanno avute da tre a cinque, e quella revisione ha trovato **tre** difetti reali al primo giro — che è la ragione per cui la regola dice *«finché una passata non torna pulita»*. ⛔ **Non si chiude eseguendo il compito 6**, e non si chiude nemmeno con questa riga: si chiude con **un secondo giro**, sul perimetro che ora è più largo perché la revisione stessa ha scritto codice. ⛔ **RICHIAMO DEL 2026-08-31 — QUESTA VOCE È LA CASA UNICA DEL RESIDUO, E LA RIGA QUI SOPRA È DIVENTATA STANTIA LO STESSO GIORNO: i giri fatti sono TRE, e la voce è ancora APERTA.** ✅ **E LA CONDIZIONE CHE QUESTA VOCE REGISTRAVA COME MANCANTE È CADUTA: il proprietario ha AUTORIZZATO i sotto-agenti il 2026-08-31**, quindi il terzo giro è stato fatto da un sotto-agente fresco e non da una sessione, e il piano può tornare alla modalità che la sua intestazione prescrive. ⚠️ **Ma il residuo NON si chiude con l'autorizzazione:** si chiude con **una passata che torni pulita**, e nessuna delle tre lo è stata — `E54`–`E56`, poi `E65`–`E66`, poi `E67`–`E72`. ⛔ **E il numero dei rilievi per passata è 3 · 2 · 6, cioè NON sta convergendo, e la causa è misurabile invece che supposta:** ogni rimedio aggiunge **prosa**, e la prosa è la classe in cui i difetti di questo repository si concentrano — l'audit del 2026-08-27 misurò il **44%** dei propri finding come *«una cifra o un'affermazione al presente che nessun controllo difende»*, la sua radice **R1**. Le tre passate hanno trovato, in ordine, mutanti e conteggi · mutanti e date · **le affermazioni scritte dai rimedi precedenti**. ⏭️ **CHI RIPRENDE DEVE DISPACCIARE UN QUARTO GIRO**, con perimetro `git diff 4e4b725^..HEAD -- crates/` e l'istruzione di battere **per prime** le affermazioni introdotte dai commit `eba6344` e `16365f2` — è lì che la terza passata ha trovato la propria messe. ⚠️ **Un quarto giro era stato dispacciato il 2026-08-31 e la sessione si è chiusa prima del suo esito: il suo lavoro è PERSO e va rifatto**, il che non è un danno perché una revisione non lascia stato nel repository — costa solo il tempo. ⛔ **RICHIAMO DEL 2026-09-01 — IL QUARTO GIRO È FATTO, DA UN SOTTO-AGENTE FRESCO, E NON È TORNATO PULITO: SEI RILIEVI, `E73`–`E78`, TUTTI VERIFICATI DAL COORDINATORE PRIMA DI RIMEDIARE E TUTTI VERI.** ⚠️ **La serie è `3 · 2 · 6 · 6`, quindi il conteggio NON converge — ma la FORMA sì, ed è il dato che conta:** dei sei, **uno solo** è un mutante vivo (`E73`) e **quattro** sono censimenti incompleti dei rimedi precedenti — `E70` nei corpi invece che nella testa, `E72` in due case su quattro, il letterale `85`/`86` **moltiplicato dal rimedio stesso**. ⛔ **La causa misurata regge e si è affinata:** non è che i rimedi sbaglino, è che **ogni rimedio scrive prosa nuova e chiude l'occorrenza invece della classe** — la radice **R1** dell'audit del 2026-08-27, che vale il 44% dei suoi finding. 📌 **E la contromisura che ha funzionato, misurata su questa ondata:** **cinque rimedi su sei TOLGONO righe**, e il solo che aggiunge è una riga dentro una sonda che esiste già — il conteggio dei test resta **298**. È il gotcha **#76**, applicato prima invece che all'ultima ondata. ⛔ **CHI RIPRENDE DISPACCIA UN QUINTO GIRO**, con perimetro `git diff 4e4b725^..HEAD -- crates/` e l'istruzione di battere **per prime** le affermazioni introdotte da questa ondata; e ⛔ **la domanda da porgli non è più «trova difetti» ma «questa ondata ha chiuso la CLASSE o l'occorrenza?»** — è la sola che i quattro rilievi di censimento avrebbero colto in anticipo. ⚖️ **E se il quinto giro trovasse ancora soltanto censimenti, la domanda diventa del PROPRIETARIO e non dell'agente:** *«si rivede finché una passata non torna pulita»* è una regola scritta contro difetti di **prodotto**, e il prodotto è verde e immutato da quattro giri — misurato, `git diff --name-only` di questa ondata nomina **zero** cambiamenti di comportamento, solo commenti e **una** asserzione. **Registrata e non presa.** ⛔ **RICHIAMO DEL 2026-09-01 ② — IL QUINTO GIRO È FATTO, E LA DOMANDA NUOVA HA PAGATO: QUATTRO RILIEVI, `E79`–`E82`, E TUTTI E QUATTRO SONO RIMEDI DELL'ONDATA PRECEDENTE CHE AVEVANO CHIUSO L'OCCORRENZA E NON LA CLASSE.** Al sotto-agente è stato chiesto, **prima** di cercare difetti, di prendere i sei rimedi di `bd37d59` uno per uno e rispondere col `grep` alla domanda *«ha chiuso la classe, o il punto dove l'ho trovato?»*. ✅ **Due su sei erano classe chiusa** (`E74`, `E75`), uno era chiuso e senza fratelli (`E77`); **tre no**. ⛔ **E il più caro è `E79`: `E73` aveva chiuso UN sito su tre, e gli altri due erano MUTANTI VIVI** — `41 · 298 · 0 · 2` su entrambi, identico alla baseline. ⚠️ **L'errata di `E73` li nominava e li prezzava come *«aggiunte meccaniche, non tre rilievi»*: la prima metà era vera, la seconda no.** 📌 **Quindi la domanda di classe ha colto, in un giro, ciò che quattro giri di *«trova difetti»* non avevano colto — e la si tiene.** ⚠️ **La serie è `3 · 2 · 6 · 6 · 4`.** ⛔ **CHI RIPRENDE DISPACCIA UN SESTO GIRO** con la **stessa** domanda, sui quattro rimedi di questa ondata. ⚖️ **E LA VOCE PER IL PROPRIETARIO SI È FATTA PIÙ NETTA, ed è la ragione per cui va portata adesso invece che al decimo giro:** i rilievi del quarto giro erano in maggioranza generati dai rimedi del terzo, e quelli del quinto lo sono **tutti e quattro** dai rimedi del quarto. ⛔ **Il ciclo non sta convergendo verso zero: si sta autoalimentando**, e la regola *«si rivede finché una passata non torna pulita»* fu scritta contro difetti di **prodotto** — che qui è verde e, tolte le due asserzioni di `E79`, **immutato da cinque giri**. 📌 **Le vie sono tre, e la scelta è sua:** ① continuare finché una passata torna pulita, accettando che ogni ondata ne generi un'altra; ② dichiarare il ciclo **chiuso sul prodotto** e trattare i censimenti residui come una passata **documentale** a sé, fuori dal ciclo di revisione del compito; ③ chiudere alla **radice**, che è il finding **AUD-050** — la coppia `kind`/`Detail` tenuta al **livello 1** da campi privati e un costruttore per specie — anch'esso già suo e registrato. **Registrata, non presa.** ⛔ **RICHIAMO DEL 2026-09-01 ③ — IL PROPRIETARIO HA SCELTO LA TERZA VIA: CHIUDERE ALLA RADICE.** Delle tre che il richiamo ② mette davanti — continuare · dichiarare il ciclo chiuso sul prodotto · chiudere alla radice — è stata scelta la **③**, e **AUD-050 è chiuso a livello 1** il 2026-09-01: campi privati, sei accessori, un costruttore per specie con `reason: &'static str`. Il verbale è la voce **E83**. ⛔ **E CIÒ CHE CAMBIA PER QUESTO CICLO È LA COSA DA CAPIRE:** la classe che ha prodotto `E73` e `E79` — *«la coppia `kind`/`Detail` è tenuta dalla DISCIPLINA, e la disciplina si dimentica in due siti su tre»* — non è più tenuta dalla disciplina: `kind` non è parametro di niente, quindi la coppia sbagliata è **impronunciabile**. ✅ **Quel filone di rilievi non può ripresentarsi**, e non perché qualcuno stia più attento. ⚠️ **Ma il residuo NON è chiuso, e dirlo altrimenti sarebbe la scorciatoia che questa voce esiste per impedire:** il cambiamento ha toccato **45 siti di costruzione in 13 file su 3 crate** e non è stato rivisto da nessuno. ⛔ **RICHIAMO DEL 2026-09-01 ④ — IL SESTO GIRO È FATTO, DA UN SOTTO-AGENTE FRESCO, E NON È TORNATO PULITO: QUATTRO RILIEVI, `E84`–`E87`, TUTTI RIVERIFICATI DAL COORDINATORE PRIMA DI RIMEDIARE E TUTTI VERI.** ⚠️ **E la cifra di questa frase è UNO DEI QUATTRO:** *«su 3 crate»* è falsa e *«37 siti di lettura»* non è riproducibile — la casa unica con la misura e il comando è [`porta-di-qualita.md`](../../porta-di-qualita.md), e il verbale è la voce **E85**. ⛔ **CHI RIPRENDE DISPACCIA UN SESTO GIRO, e il perimetro è CAMBIATO:** non più `git diff 4e4b725^..HEAD -- crates/` ma **`git show c63c8c8`** — il commit di `E83`, che è lo strato nuovo e il più grande del traguardo. ⛔ **E la domanda del quinto giro RESTA, perché è quella che ha pagato:** *«ciascun rimedio ha chiuso la CLASSE o l'occorrenza?»* — applicata stavolta ai **cinque doc di sorgente** che dichiaravano la falla aperta e al censimento dei siti, che è dove un cambiamento di questa taglia lascia le proprie bucce. ⚖️ **E la voce del proprietario si è ristretta invece di sparire:** ciò che resta da decidere non è più *«che cosa fare del ciclo»* — l'ha deciso — ma se, chiuso il sesto giro pulito o no, il compito **6** si apra comunque. **Registrata, non presa.** ⛔ **RICHIAMO DEL 2026-09-01 ④ — IL SESTO GIRO È FATTO, DA UN SOTTO-AGENTE FRESCO SUL PERIMETRO `git show c63c8c8`, E NON È TORNATO PULITO: QUATTRO RILIEVI, `E84`–`E87`, TUTTI RIVERIFICATI DAL COORDINATORE PRIMA DI RIMEDIARE E TUTTI VERI.** ✅ **E LA VOCE DEL PROPRIETARIO È CHIUSA, il 2026-09-01: il compito 6 si apre comunque.** ⛔ **MA IL SESTO GIRO HA SMENTITO L'ARGOMENTO CON CUI IL CICLO STAVA PER CHIUDERSI, e va detto invece che taciuto.** Il richiamo ② argomentava che *«il prodotto è verde e immutato da cinque giri»*, quindi che i residui fossero di sola **prosa**: `E84` è un difetto di **PRODOTTO** — `record_without_version.rs` era **degradato dalla forma forte alla debole** del gotcha #42 da `E83` stesso, e **nessun rosso** lo diceva, perché il controllo di privacy gira dopo il type-check e l'`E0599` aborta prima. ⚠️ **La serie è `3 · 2 · 6 · 6 · 4 · 4`**, e il dato nuovo non è il conteggio ma la **specie**: il primo rilievo di prodotto in quattro giri è arrivato subito **dopo** il primo cambiamento grosso di codice. 📌 **La regola che ne esce, ed è generale:** *«si rivede finché una passata non torna pulita»* è debole contro i giri che seguono una passata **documentale**, e forte contro quelli che seguono un cambiamento di **codice** — il perimetro conta più del numero del giro. ⛔ **CHI VOLESSE UN SETTIMO GIRO lo dispacci su `git diff c63c8c8..HEAD -- crates/`**, con la stessa domanda di classe; **non sbarra il compito 6**, per la decisione del proprietario qui sopra. ⛔ **RICHIAMO DEL 2026-09-01 ⑤ — IL SETTIMO GIRO È FATTO, DA UN SOTTO-AGENTE FRESCO SUL PERIMETRO `git diff c63c8c8..HEAD -- crates/`, E NON È TORNATO PULITO: CINQUE RILIEVI, `E97`–`E101`, TUTTI RIVERIFICATI DAL COORDINATORE PRIMA DI RIMEDIARE E TUTTI VERI.** ⚠️ **E non era soltanto il settimo giro di questo ciclo: era anche la REVISIONE DEL COMPITO 6**, che non ne aveva avuta nessuna — `git log` non porta nessun commit di revisione fra il suo e questo. ⛔ **La regola che il sesto giro aveva enunciato ha retto alla lettera:** *«si rivede finché una passata non torna pulita» è debole dopo una passata documentale e forte dopo un cambiamento di CODICE*. Questo perimetro è codice nuovo, e ne sono usciti **DUE difetti di prodotto** — `E97` ed `E98`, entrambi **mutanti vivi sull'intero workspace**, uno dei quali sull'etichetta `I6` di un record **durevole**. ⚠️ **La serie è `3 · 2 · 6 · 6 · 4 · 4 · 5`**, e la specie conferma il sesto giro: dopo il codice arrivano difetti di prodotto, dopo la prosa arrivano censimenti. 📌 **E la domanda di classe ha pagato una seconda volta:** `E99` ed `E101` sono **rimedi del sesto giro che avevano chiuso l'occorrenza**, e uno dei due — `E99` — si era falsificato da sé **al commit successivo dello stesso giorno**. ⛔ **RICHIAMO DEL 2026-09-01 ⑥ — L'OTTAVO GIRO È FATTO, DA UN SOTTO-AGENTE FRESCO SU `git show 9441e6d`, E NON È TORNATO PULITO: DIECI RILIEVI, `E116`–`E121` più tre voci di documento, TUTTI RIVERIFICATI DAL COORDINATORE PRIMA DI RIMEDIARE E TUTTI VERI.** Il verbale per esteso è la voce **`E122`**. ⛔ **E la domanda di classe ha pagato una TERZA volta, ed è la misura che conta: SETTE rimedi su otto avevano chiuso l'OCCORRENZA e non la CLASSE.** ⛔ **TRE erano mutanti vivi di PRODOTTO** — il `payload` del record di routing, la **seconda** scrittura di `run_the_ring`, e l'errore di `replay` inghiottito da `reconcile::steps_in_doubt`, che è quello con la conseguenza peggiore: *«nessun passo è in dubbio»* su un archivio illeggibile, sull'unica strada dove quella risposta viene agita, la **ripresa dopo un crash**. ✅ **E nessuno dei tre ha chiesto una riga di prodotto** — `git diff --stat crates/kernel/src/` è vuoto dopo il rimedio: il codice era giusto, a mancare era la **prova**, che è la forma del gotcha **#74**. ⚠️ **La serie è `3 · 2 · 6 · 6 · 4 · 4 · 5 · 10`**, e il conteggio non converge — ma la regola del sesto giro **regge ancora**: questo perimetro era un'**ondata di correzioni**, cioè codice nuovo, e ne sono usciti difetti di **prodotto**. ⛔ **E il dato nuovo è la SPECIE del difetto ricorrente: sette rimedi su otto chiudevano il punto in cui il difetto era stato trovato.** Non è disattenzione, è che *«ha chiuso la classe?»* non veniva chiesto dall'ondata a sé stessa — la domanda paga perché sta **prima**, non perché sia più severa. ⏭️ **CHI RIPRENDE DISPACCIA UN NONO GIRO**, perimetro `git diff 9441e6d..HEAD -- crates/`, con la **stessa** domanda di classe posta per prima. ⚖️ **E LA VOCE PER IL PROPRIETARIO TORNA, più stretta di come il richiamo ② la pose:** allora la domanda era *«che cosa fare del ciclo»* e la scelta fu **chiudere alla radice**; oggi non c'è una radice sola da chiudere — la specie ricorrente non è un tipo ma un **modo di rimediare**. Se valga la pena rendere la domanda di classe una **condizione scritta** di ogni ondata, invece di un'istruzione che il coordinatore ricorda, è del proprietario. **Registrata, non presa.** ⛔ **RICHIAMO DEL 2026-09-01 ⑦ — IL NONO GIRO È FATTO, DA UN SOTTO-AGENTE FRESCO SU `git diff 9441e6d..HEAD -- crates/` (brief `E123`), E NON È TORNATO PULITO: SEI RILIEVI, `E124`–`E129`, TUTTI RIVERIFICATI DAL COORDINATORE PRIMA DI RIMEDIARE E TUTTI VERI — il verbale è `E130`.** ⛔ **La domanda di classe ha pagato una QUARTA volta, e stavolta sul CENSIMENTO che aveva chiuso una classe:** `E114` la dichiarava a due membri e ne restavano quattro, due `pub` dentro il suo stesso perimetro — un conteggio non è una chiusura, e la chiude il compilatore facendo crescere OGNI candidato. Uno solo di prodotto (`E124`), e non ha chiesto una riga di comportamento; quattro dei cinque di prosa erano scritti dai rimedi dell'ottavo giro. ⚠️ **La serie è `3 · 2 · 6 · 6 · 4 · 4 · 5 · 10 · 6`.** ⏭️ **CHI RIPRENDE DISPACCIA UN DECIMO GIRO**, perimetro `git diff 02d2162..HEAD -- crates/` — l'ondata di questo giro, che è **codice** (`fe52039`) e non solo prosa, quindi la regola del sesto giro è **forte** — con la stessa domanda di classe posta per prima; il brief è `E131`. ⚖️ **La voce del proprietario resta quella del richiamo ⑥, con una prova in più:** la domanda di classe ha colto un difetto di prodotto anche al nono giro, e resta un'istruzione che il coordinatore ricorda. ⛔ **RICHIAMO DEL 2026-09-01 ⑧ — IL DECIMO GIRO È FATTO, DA UN SOTTO-AGENTE FRESCO SU `git diff 02d2162..HEAD -- crates/` (brief `E131`), E PER LA PRIMA VOLTA UN'ONDATA DI CODICE È TORNATA SENZA UN DIFETTO DI PRODOTTO:** tre rilievi, `E132`–`E134`, tutti di prosa o di registro, tutti riverificati dal coordinatore e tutti veri, e uno dei tre **fuori dai file del perimetro**, colto dalla domanda di classe sulla specie di `E129`. Il verbale è `E135`. ✅ **E il rifattorizzamento di `fe52039` è misurato tenuto:** i quattro predicati provati braccio per braccio nelle due direzioni, trentasette enum di `crates/*/src` censiti facendoli crescere — la casa è la sezione *«La DECIMA passata»* del registro. ⚠️ **La serie è `3 · 2 · 6 · 6 · 4 · 4 · 5 · 10 · 6 · 3`.** ⚖️ **E LA DECISIONE CHE RESTA È DEL PROPRIETARIO, con una raccomandazione:** i rimedi del decimo giro sono **soltanto prosa**, quindi un undicesimo giro cadrebbe dopo una passata **documentale**, dove la regola *«si rivede finché una passata non torna pulita»* è **debole** per la misura del sesto giro; e la forma forte — un'ondata di **codice** riletta senza un difetto di prodotto — è soddisfatta per la prima volta. Le vie: ① un undicesimo giro documentale su `git diff 3b23f3c..HEAD -- crates/`; ② dichiarare il ciclo **chiuso sul prodotto** e passare al pre-controllo del **compito 8**, trattando la specie di `E129` — i numerali di distanza — come una passata documentale a sé, col censimento `grep -rnE "lines (up\|below\|above\|down)" crates/`. **Raccomandata la ②**, per le stesse ragioni del richiamo ②; **registrata, non presa**. La voce sulla domanda di classe come condizione scritta di ogni ondata resta aperta, con una prova in più. ⛔ **RICHIAMO DEL 2026-09-02 ⑨ — IL PROPRIETARIO HA SCELTO LA ②: IL CICLO È CHIUSO SUL PRODOTTO.** La passata documentale a sé sulla specie di `E129` è `E136`, fatta lo stesso giorno sull'intero `crates/` con censimento allargato; il pre-controllo del compito 8 è `E137`–`E140`, **due bloccanti misurati prima di dispacciare**, e il brief è `E141`. ⚠️ **La serie `3 · 2 · 6 · 6 · 4 · 4 · 5 · 10 · 6 · 3` è chiusa a dieci giri.** ⚖️ **Resta aperta e sua** la voce del richiamo ⑥: se la domanda di classe diventi una condizione scritta di ogni ondata. |
...
| **E73** | ✅ **CORRETTO — QUARTA PASSATA DI REVISIONE: `detail: None` DEL RECORD DI FEEDBACK ERA UN MUTANTE VIVO, ED È IL CAMPO CHE QUESTO COMPITO HA INTRODOTTO.** Dopo `E65` il banco teneva **cinque campi su sei** del secondo record che `run_the_ring` scrive — `kind`, `effect`, `trust`, `payload`, `reason` — e il sesto no. ⛔ **Misurato:** `detail: Some(Detail::Verdict(..))` in `crates/kernel/src/sensor.rs` lascia l'intero workspace verde, **`41 · 298 · 0 · 2`**, identico alla baseline cifra per cifra. ⛔ **E non è cosmetico:** il doc di `Detail` dichiara che *«nothing at level 1 holds the pair»* fra `kind` e `Detail`, e che a tenerla è **una funzione per specie** — `run_the_ring` **è** quella funzione, quindi la disciplina che il doc invoca non era misurata da niente, e un `Intent` con un `Detail::Verdict` entrerebbe nel **formato durevole**. ✅ **Chiuso con UNA riga dentro una sonda che esiste già**, `a_failing_verdict_opens_a_new_step_and_carries_the_detail` in `crates/kernel/tests/sensor_ring.rs`, sulla forma che `E65` usò per i propri quattro campi: nessun banco nuovo, conteggio invariato a **298**. ✅ **Provato nelle DUE direzioni:** col rimedio, la stessa mutazione dà **`41 · 297 · 1 · 2`** e a morire è **quella sonda e nessun'altra**. ⚠️ **Gli altri due siti del campo — `crates/kernel/src/boundary.rs` e `crates/kernel/src/arbiter/mod.rs` — portano lo stesso mutante vivo, misurato, e NON sono tre rilievi:** sono aggiunte meccaniche imposte dall'arrivo del campo, non decisioni, e il sito che **possiede** la coppia è uno solo (gotcha **#65**). |
| **E74** | ✅ **CORRETTO — IL CENSIMENTO DI `E72` SI ERA FERMATO A DUE CASE SU QUATTRO, E UNA DELLE DUE MANCANTI STAVA CENTO RIGHE SOTTO LA CORREZIONE, NELLO STESSO FILE.** `E72` ha misurato che `#[cbor(default)]` è **inerte** e ha riscritto la regola in `crates/kernel/tests/frozen_bytes.rs` (testa) e in `crates/kernel/src/record.rs` (doc di `detail`); restavano `frozen_bytes.rs` dentro la costante **`FORMAT_CHANGED`** e `record.rs` nel doc di `RecordV1`, che la enunciavano ancora come **obbligo** — *«must be OPTIONAL, WITH `#[cbor(default)]`»*. ⛔ **`FORMAT_CHANGED` è la casa peggiore:** è la prosa che l'oracolo stampa **quando il formato durevole si muove**, cioè quella che qualcuno legge nel momento di massimo rischio, e diceva che una modifica **corretta** — `Option` senza annotazione — è sbagliata. ✅ **Chiuso TOGLIENDO**, non riscrivendo: due cancellazioni, zero prosa nuova, e la regola corretta resta nella casa che `E72` le ha dato. ⚠️ **Terza occorrenza della stessa classe** — `E56` → `E70` → questa: *le case che il censimento non ha raggiunto*. ✅ **La continuazione di riga del letterale è stata verificata dopo la scrittura** con `cat -A`, perché è esattamente il gotcha **#97**: le `\` di fine riga e gli spazi che le precedono sono **intatti**. |
| **E75** | ✅ **CORRETTO — `a_verdict()` DICHIARAVA INERTE UN LETTERALE CHE PORTA IL KILLER DELLA SONDA GEMELLA, E IL DOC DEL FRATELLO VENTI RIGHE SOPRA DICEVA L'OPPOSTO.** Il commento di `crates/kernel/tests/reconciliation.rs` diceva *«`Verifiable` IS INERT HERE, exactly as the note's class is»*; il doc di `a_note()` dice che la classe diversa *«è tutto ciò che rende non vacue le due sonde sotto»*. ⛔ **Misurato in tre passate, e il gemello ha ragione.** ① Aiutante armonizzato a `Idempotent` sul codice **corretto** → **`41 · 298 · 0 · 2`**, verde: il commento è vero *del codice corretto*, ed è ciò che lo rende ingannevole. ② Mutazione `RecordKind::Verdict => enter(&mut open, step, resolution_of(body.effect))` col codice di **adesso** → **`41 · 296 · 2 · 2`**, muoiono **entrambe** le sonde. ③ La **stessa** mutazione con l'aiutante armonizzato → **`41 · 297 · 1 · 2`**, muore **una sola**: `a_verdict_leaves_the_doubt_and_its_resolution_exactly_as_it_found_them` — la sonda la cui unica ragione d'esistere è *«l'altra metà»* — **smette di sparare, e niente diventa rosso per dirlo**. ✅ **Chiuso sostituendo tre righe con quattro** che dicono che cosa il letterale **compra**, invece di dichiararlo inerte. 📌 È il gotcha **#98** in una terza forma: un letterale scelto per un campo può lasciare **un'altra sonda** inesercitata. |
| **E76** | ✅ **CORRETTO — UN CONTEGGIO SOPRAVVISSUTO A `E70` NEL CORPO DI UNA SONDA DELLO STESSO FILE.** Il commento di `the_frozen_records_are_distinguishable_in_the_bytes` diceva *«three artefacts, two indices held … two colliding while **the third** stays apart»*, mentre `the_frozen_records()` ha tipo di ritorno `[(&'static str, &'static [u8], Record); 4]` e i `.cbor` sono **quattro**. ⛔ **`E70` aveva chiuso la TESTA di `frozen_bytes.rs` e la mappa, non i CORPI:** stessa classe, stesso file, la riga sotto. ✅ **Chiuso TOGLIENDO i numerali** e non riallineandoli a quattro — *un elenco invecchia, una regola no* (precedente **AUD-046**): quanti siano lo dice `the_frozen_records()`, il cui tipo di ritorno **il compilatore controlla**. |
| **E77** | ✅ **CORRETTO — LA RINOMINA DI `16365f2` HA ROTTO UN A-CAPO E NESSUN CONTROLLO LO VEDE.** `crates/kernel/src/reconcile.rs` portava una riga di commento da **129 caratteri** in un blocco le cui altre stanno a **≤ 83**: `a_verdict_leaves_a_closed_step_closed` (37 caratteri) è diventato `a_verdict_leaves_the_doubt_and_its_resolution_exactly_as_it_found_them` (70) senza riavvolgere. ⛔ **Nessuna rete lo coglie**, ed è il punto: `rustfmt` non tocca i commenti e la §7.4.3 non dà voce a `clippy` nel cancello — è la stessa classe del gotcha **#97**, dove uno strumento che riscrive lascia un sorgente **verde e sbagliato nella forma**. ✅ Riavvolta su due righe. |
| **E78** | ✅ **CORRETTO — IL LETTERALE `85`/`86` VIVEVA IN CINQUE CASE, E IL TERZO GIRO NE AVEVA AGGIUNTE DUE A UNA CIFRA CHE NE AVEVA GIÀ TRE.** Censite col comando: `crates/kernel/src/record.rs`, `crates/kernel/tests/frozen_bytes.rs` (**due** volte), `crates/kernel/tests/frozen/record_v1.map` (**due** volte, cioè la mappa la portava **due volte al proprio interno**). ✅ **Tolto dalle TRE case che lo affermano al presente in prosa**, e non solo dalle due nuove: correggerne due lasciando la terza a mentire è la forma che **AUD-018** e **AUD-060** hanno già pagato in questo repository. ⚖️ **Le due che RESTANO hanno ciascuna la propria ragione, dichiarata invece che taciuta:** la riga **89** di `record_v1.map` è la colonna **hex che il banco ricostruisce** — un fatto controllato, non una prosa — e la riga di `record.rs` sta dentro il **verbale datato** della misura **P-15** del 2026-08-30, dove la **55ª misura** dice che una cifra regge. 📌 Da cinque case a due, entrambe difese. |
| **E79** | ✅ **CORRETTO — QUINTO GIRO: `E73` AVEVA CHIUSO UN SITO SU TRE, E GLI ALTRI DUE ERANO MUTANTI VIVI.** I record di produzione che scrivono `detail: None` sono **tre** — `crates/kernel/src/sensor.rs`, `crates/kernel/src/boundary.rs` (`Untrusted::promote`) e `crates/kernel/src/arbiter/mod.rs` (`transition_record`) — e `E73` ne aveva chiuso **uno**. ⛔ **Misurato uno per volta, revocando fra l'uno e l'altro:** `detail: Some(Detail::Verdict(..))` lascia **`41 · 298 · 0 · 2`** su **entrambi** i siti mancanti, identico alla baseline cifra per cifra. ⚠️ **E l'errata di `E73` lo DICHIARAVA e lo prezzava male:** *«portano lo stesso mutante vivo, misurato, e NON sono tre rilievi … sono aggiunte meccaniche»*. La prima metà era vera, la seconda no — l'argomento di `E73`, *«un `Intent` con un `Detail::Verdict` entra nel formato durevole»*, vale **alla lettera** per un `Note` e per una transizione di policy, quindi ciò che li separava non era la sostanza ma **il sito dove il rilievo era stato trovato**. È la radice **R1** commessa dentro il rimedio, per la seconda volta in due ondate. ✅ **Chiuso con UNA asserzione per ciascuno dei due banchi**, nella forma di `E73`: `crates/kernel/tests/boundary_promotion.rs` e `crates/kernel/tests/arbiter_policy.rs`. ✅ **Provato nelle due direzioni su entrambi:** col rimedio, la stessa mutazione dà **`41 · 297 · 1`** e muore **una** sonda sola — `the_promoted_content_is_the_payload_and_it_is_labelled_untrusted` e `a_transition_names_the_policy_it_moves_to`. Conteggio invariato a **298**. ⚖️ **E la cura di CLASSE non è stata inventata, ed è dichiarato perché:** una guardia di **livello 1** sulla coppia `kind`/`Detail` — campi privati più un costruttore per specie — è il finding **AUD-050**, **registrato e non preso, del proprietario**; e una sonda che congelasse oggi la regola *«`detail` è `Some` se e solo se `kind` è `Verdict`»* fisserebbe una partizione che i **compiti 6 e 7** stanno per cambiare, cioè il gotcha **#57**. |
| **E80** | ✅ **CORRETTO — LA TESTA DI `frozen_bytes.rs` CONTAVA ANCORA TRE FILE, E LA MAPPA DICHIARAVA UNA SOLA PRODUZIONE.** *«The **three** `.cbor` files were TYPED BY HAND … and the probe was deleted in the same commit»*, e *«Produced **2026-08-10** … from a throwaway probe that was deleted in the same commit»*. ⛔ **Misurato:** `ls crates/kernel/tests/frozen/*.cbor | wc -l` dà **quattro**, e `git log --diff-filter=A` dice che il quarto è nato da una **seconda** sonda in un **secondo** commit — `4e4b725`, del 2026-08-31 — mentre i primi tre vengono da `170887d` del 2026-08-10. ⛔ **È la QUARTA occorrenza della stessa classe nello stesso file:** `E56` → `E70` (la testa) → `E76` (i corpi) → questa, e `E70` aveva corretto un paragrafo a **venti righe** da questo lasciandolo in piedi. ✅ **Chiuso TOGLIENDO il numerale** — *«Every `.cbor` file here … how many files there are is `the_frozen_records()`, whose return type the compiler checks»* — e portando la mappa a dichiarare **le due date e le due sonde** invece di una. |
| **E81** | ✅ **CORRETTO — *«THE OTHER FOUR FIELDS STAY READABLE»* E SONO CINQUE, IN DUE CASE, E CIASCUNA SI SMENTIVA DA SÉ POCHE RIGHE SOTTO.** `crates/kernel/src/record.rs` e `crates/kernel/tests/record_shape.rs` contano quattro campi leggibili ed elencano `kind`, `effect`, `trust`, `reason`; il `Debug` scritto a mano ne stampa **cinque** — `detail` compreso — e l'asserzione del banco li mostra tutti e cinque. ⛔ **Ed entrambi i file lo dicono già venti righe più sotto:** *«AND `detail` IS PRINTED»* e *«AND `detail` IS ON THE READABLE SIDE TOO, WHICH IS THE D25»*. ⛔ **Il precedente è nello stesso file e porta il proprio richiamo datato:** la stessa frase diceva *«THE OTHER THREE»* fino al 2026-08-10 — il conteggio fu portato da tre a quattro quando arrivò `reason` all'indice 4, e **non** da quattro a cinque quando arrivò `detail` all'indice 5. ✅ **Chiuso TOGLIENDO il numerale in entrambe le case** — *«EVERY OTHER FIELD»* — perché è una cifra che ha già invecchiato **due volte** sulla stessa frase; l'elenco dei nomi resta, e il compilatore lo tiene. |
| **E82** | ✅ **CORRETTO — IL CENSIMENTO DI `E78` ERA CORTO DI UNO, E LA CASA MANCATA È QUELLA CHE AVEVA SMESSO DI ESSERE VERA.** `E78` dichiara *«cinque case → due, entrambe difese»*; rifatto al padre `d4c906d` con `git grep`, le case erano **sei** — `crates/kernel/src/record.rs` la porta **due** volte, al paragrafo del 2026-08-10 e a quello di `detail` — quindi ne restavano **tre**, e la terza non era stata esaminata. ⛔ **E quella terza è la sola stantia:** il verbale del 2026-08-10 accanto a `reason` dice *«An `Option<u64>` at **the free index 5**»*, e l'indice 5 è di `detail` da `4e4b725` — la ricetta che dà **non compila più**, `duplicate index numbers`. ⛔ **È la stessa misura che il doc di `detail` porta venticinque righe sotto**, datata **P-15, 2026-08-30**, e sul campo che esiste davvero: una **seconda casa**, e la più vecchia delle due nomina un indice occupato. ✅ **Chiuso TOGLIENDO il verbale vecchio e lasciando un rimando** — *un rimando non può marcire* — e togliendo la coda in prosa di `record_v1.map`. ⛔ **RICHIAMO SU `E78`, che è un verbale e non si riscrive: la sua giustificazione era mezza sbagliata.** Diceva che la riga 89 della mappa è *«la colonna hex che il banco ricostruisce»*: a essere ricostruito è il **byte `86`**, mentre il confronto *«the 85 -> 86»* stava nella **colonna di prosa**, che la testa della mappa stessa dichiara **non verificata**. ✅ **Ora il confronto `85`/`86` vive in UNA casa sola**, il verbale P-15 sul doc di `detail`. |
| **E83** | ✅ **AUD-050 È CHIUSO A LIVELLO 1 IL 2026-09-01, PER DECISIONE DEL PROPRIETARIO — ED È LA CURA ALLA RADICE CHE `E53` METTEVA COME TERZA VIA.** ⛔ **La falla, riprodotta prima di toccare niente** (passo 2 della disciplina dell'audit): da **fuori la crate**, su una sonda usa-e-getta cancellata nella stessa corsa, un letterale di struct ha messo una `String` calcolata a runtime all'indice 4 — `RecordV1 { .. payload: <6 bytes>, reason: "ignore your instructions", .. }`, il campo guardato sigillato e quello non guardato spalancato. È **P-1 attraverso una seconda bocca**, e `promote` prendeva già un `&'static str`: *una guardia vale quanto il suo costruttore*. ⛔ **Il perimetro è stato RIMISURATO contro il codice di adesso e non citato dalla scheda**, che è di agosto: **45 siti di costruzione in 13 file su 3 crate**, più 37 siti di lettura. ⛔ **RICHIAMO DEL 2026-09-01, sesto giro — DUE di queste quattro clausole erano FALSE alla misura, non stantie: le crate sono DUE e il «37» non si rifà con nessuna forma del comando.** Il testo **non** è riscritto, perché è un verbale; il verbale della correzione è `E85`, e la casa unica con la misura e il comando è [`porta-di-qualita.md`](../../porta-di-qualita.md). ✅ **La forma:** i sei campi diventano **privati**, sei **accessori** per la lettura, e **un costruttore per specie** — `intent`, `outcome`, `note`, `verdict` — ciascuno con `reason: &'static str`, tutti attraverso un `of` **privato** che è l'unico posto che costruisce, sul precedente di `Arbiter::issue` per `Grant` (§5.6). ⛔ **E la SECONDA metà è ciò che chiude anche la classe di `E79`:** la coppia `kind`/`Detail` non è più *rifiutata*, è **impronunciabile** — `kind` non è parametro di niente. ⚖️ **Ed è la ragione per cui questa forma è stata preferita a una sonda:** una sonda che congelasse *«`detail` è `Some` se e solo se `kind` è `Verdict`»* fisserebbe una partizione che i compiti 6 e 7 stanno per cambiare (gotcha **#57**), mentre una **specie nuova porta il proprio costruttore**, che è additivo. ✅ **Il caso `compile_fail` NUOVO è il 35°**, `record_reason_is_not_runtime_text.rs`, e **la sua non-vacuità è misurata nelle due direzioni**: allargati i costruttori a `&str` va `error` — la forma forte del gotcha **#42** — mentre `promote_reason_is_not_runtime_text.rs` resta `ok`, che è **ciò che prova che i due tengono strade diverse** invece di essere una copia (gotcha #49 evitato con una misura, non con un argomento). ⛔ **E un caso esistente ha dovuto MUOVERSI, non essere riallineato:** `record_without_trust_label.rs` lasciava `trust` fuori da un **letterale** e attendeva `E0063`; col letterale rifiutato scattava per una **seconda ragione**, e il suo stesso doc scrive che *«un caso negativo che scatta per una seconda ragione smette di provare la prima»*. Riscritto sulla strada che esiste — l'**arità** del costruttore, `E0061`, la forma che `reading_without_a_receipt.rs` usa già — e lo `.stderr` **scritto a mano** dall'uscita vera, mai `TRYBUILD=overwrite`. ✅ **I BYTE CONGELATI NON SI SONO MOSSI, ed era la cosa da controllare per prima:** `every_frozen_record_still_encodes_to_its_frozen_bytes` e `the_map_lists_the_bytes_that_are_really_frozen` verdi per tutto il cambiamento, e `git status` sui `.cbor` e sulla mappa **vuoto**. ⛔ **E la trappola dei fine-riga è scattata, misurata invece che temuta:** `rustfmt` sui cinque file toccati li ha portati da **CR = righe a CR = 0**; ripristinati e rimisurati file per file, censimento `git ls-files --eol` **immutato a quattro** `i/crlf`. ⚠️ **CINQUE case nel sorgente dichiaravano la falla APERTA e sono state chiuse nello stesso passaggio**, censite col `grep` e guardate una per una (#70): il doc di `Detail`, i due paragrafi del `Debug` in `record.rs`, la voce **A3** di `boundary.rs` e il commento di `record_shape.rs`. ⛔ **I verbali datati NON sono riscritti**, per la 55ª misura: il richiamo del 2026-08-28 resta e riceve il proprio. ⚠️ **Che cosa NON compra, dichiarato:** `payload` resta un `Vec<u8>` che il chiamante riempie e `trust` resta un parametro — l'etichetta è l'affermazione del **chiamante** e nessuna firma la può controllare. È il limite che la via **A4** di `boundary.rs` dichiara, e non è cambiato. |
| **E84** | ✅ **CORRETTO — `record_without_version.rs` ERA DEGRADATO DALLA FORMA FORTE ALLA DEBOLE DEL GOTCHA #42, E NIENTE ERA DIVENTATO ROSSO.** ⛔ **È il rilievo che vale il sesto giro**, perché è il solo che tocca una **proprietà** e non una frase. Quel caso costruiva `RecordV1` per **letterale di struct**; `E83` ha reso privati i campi, quindi la sua **mutazione di disarmo** — un `encode` inerente su `RecordV1` — non raggiungeva più `E0599` e sbatteva prima su `E0451`. ✅ **Riprodotto prima di toccare niente:** `test .. record_without_version.rs ... mismatch`, `ACTUAL OUTPUT: error[E0451]: fields ... are private`. ⛔ **E la ragione per cui nessuno se n'era accorto è la parte da ricordare: il caso restava VERDE.** Il controllo di privacy gira **dopo** il type-check, e `E0599` aborta prima — quindi la seconda ragione c'era ed era **mascherata**, e si vedeva solo mutando. Un caso che scatta per `mismatch` è **spegnibile da `TRYBUILD=overwrite`**, che è esattamente ciò che il paragrafo di quel file dichiara impossibile: *«a bulk regeneration CANNOT silence a case that fires by compiling»*. ✅ **Chiuso costruendo attraverso `RecordV1::intent`**, la strada che ora esiste, e la forma forte è **rimisurata nelle due direzioni**: verde com'è scritto, e `error` + `Expected test case to fail to compile, but it succeeded.` sotto l'`encode` inerente. ⛔ **Lo `.stderr` è passato da riga 16 a 14 e corretto A MANO**, mai `TRYBUILD=overwrite`, come quel file prescrive di sé. ✅ **CHIUSA LA CLASSE E NON L'OCCORRENZA, censita col `grep`:** `grep -rn 'RecordV1 {' crates/ --include=*.rs` non rende più **nessun** letterale vivo — restano la definizione, gli `impl`, un tipo di ritorno e tre stringhe di formato. 📌 **La lezione generale:** un cambiamento di **visibilità** può declassare un caso negativo **senza rossi**, perché due errori diversi sullo stesso sito si mascherano per ordine di fase del compilatore. |
| **E85** | ✅ **CORRETTO — IL CENSIMENTO DI `E83` NON È RIPRODUCIBILE, E VIVEVA IN SEI CASE.** *«45 siti di costruzione in 13 file su 3 crate, più 37 siti di lettura»*: delle **quattro** clausole ne sono false **due**, e non stantie — **sbagliate alla misura**. «45» e «13 file» sono vere **del comando**; «su 3 crate» è falsa — sono **due**: `git grep -l "RecordV1 {" c63c8c8^ -- 'crates/**/*.rs' | cut -d/ -f2 | sort | uniq -c` dà `12 kernel` e `1 simulator`, e `git log -S RecordV1 -- crates/platform crates/daemon crates/secrets` non rende **nessun commit**; «37 letture» non si rifà con nessuna forma del comando — oggi gli accessori sono **40**, al padre le letture di campo **51**. ⚠️ **E il sostantivo era sbagliato dove il numero era giusto:** dei 45 hit solo **31** sono siti di **costruzione**, in **11** file; gli altri 14 sono la definizione, l'`impl Debug`, un tipo di ritorno, la stringa di formato e otto righe di commento. ✅ **Chiuso TOGLIENDO la cifra da cinque case e lasciandola in UNA sola** — [`porta-di-qualita.md`](../../porta-di-qualita.md), la sola che porti accanto il **comando** — sul precedente di **AUD-018** e **AUD-060**, dove il rimedio è una **sottrazione** e la cifra esce **anche dalla casa che era giusta**. Le altre cinque, censite col `grep` e guardate una per una (#70): `crates/kernel/src/record.rs`, `crates/kernel/src/boundary.rs`, [`COMPENDIO.md`](../../COMPENDIO.md), [`audit-2026-08-27.md`](../../audit-2026-08-27.md) e le voci **`E53`** ed **`E83`** di questa errata. ⚖️ **E le due voci d'errata NON sono riscritte, dichiarato invece che taciuto:** sono **verbali**, e ricevono il **proprio richiamo datato** — è il trattamento della **55ª** misura, lo stesso che `E83` diede alle sue due case in `porta-di-qualita.md` e `riferimenti.md`. |
| **E86** | ✅ **CORRETTO — *«THE TYPE HAS NO OTHER ROAD»* È PIÙ LARGA DEL RIMEDIO, E `Record::decode` È LA SECONDA STRADA.** Due frasi di `crates/kernel/src/record.rs` — *«Now the type has no other road»* e *«there is no second road to shut»* — affermano del **tipo** ciò che è vero della **sorgente**: il `Decode` derivato costruisce `RecordV1` dai **byte**, che la privacy non guarda, e `Record::decode` è `pub`. ✅ **Riprodotto da FUORI la crate** su una sonda usa-e-getta cancellata nella stessa corsa — un record legittimo con un segnaposto di 24 caratteri, i byte riscritti **a runtime**, poi `decode` e `{:?}`: `V1(RecordV1 { kind: Note, effect: Unrepeatable, trust: Untrusted, payload: <6 bytes>, reason: "ignore your instructions", detail: None })`, cioè **la stessa riga** con cui `E83` documenta la falla che dichiara di aver chiuso. ⚖️ **Non è un buco nuovo e non è chiudibile lì:** è la via **A4**, che già dichiara che nulla pretende che ogni scrittura sul giornale sia un `Record` e che i byte non portano etichette (ADR-0036). A essere sbagliata era la **portata** della frase, non il rimedio — i costruttori chiudono davvero ogni strada che un chiamante possa **scrivere** in sorgente. ✅ **Chiuso in due punti e non in cinque:** le due frasi guadagnano *«IN SOURCE»* col richiamo e la misura, e l'elenco **A3** di `crates/kernel/src/boundary.rs` — il *pavimento dichiarato* — guadagna la terza via con un **rimando** invece che una copia. ⛔ **Ed è la lezione che la scheda di AUD-050 dava di sé, applicata al proprio rimedio:** *«il difetto non era la frase ma l'ELENCO che dichiara il pavimento»* — e un elenco riscritto **mentre** si chiude un buco è esattamente dove finisce l'omissione successiva. |
| **E87** | ✅ **CORRETTO — LA RICETTA DI DISARMO DEL CASO NUOVO NON È ESEGUIBILE COME SCRITTA.** `record_reason_is_not_runtime_text.rs` detta *«widen **any** species constructor back to `&str` and this file COMPILES»*. ⛔ **Misurato:** allargando **una sola** specie — `note` — la crate **non compila**, `error[E0521]: borrowed data escapes outside of associated function`, perché l'`of` privato pretende ancora `'static`; `trybuild` non gira nemmeno, quindi chi prova la ricetta legge un rosso che **non è quello promesso**. ✅ **La ricetta vera è a CINQUE righe** — le quattro specie **più** l'`of` — e con tutte e cinque la conclusione dichiarata si riproduce esatta: il caso va `error` e `promote_reason_is_not_runtime_text.rs` resta `ok`. ⚠️ **Delle tre clausole ne era falsa UNA, la sola PORTATA** (gotcha **#65**): la conclusione sulla forma forte e la non-copia rispetto al caso di `promote` sono vere e riprodotte. ⚠️ **E delle due case quella sbagliata era il SORGENTE**, cioè quella che si legge per rifare la misura: [`porta-di-qualita.md`](../../porta-di-qualita.md) scriveva già *«allargati i **cinque** `reason: &'static str`»*. |
| **E88** | ⛔ **BLOCCANTE — IL PRE-CONTROLLO DEL COMPITO 6 È RIFATTO IL 2026-09-01 CONTRO IL CODICE DI ADESSO, E IL BRIEF È SCRITTO CONTRO UN `RecordV1` CHE NON ESISTE PIÙ.** È la regola **5** di [`../../../CLAUDE.md`](../../../CLAUDE.md) — *il contratto cresce sotto il piano* — e il pre-controllo ha tenuto una **quinta** volta. ⚠️ **`E57`–`E62` non colgono niente di questo, e non è una loro mancanza:** sono del **2026-08-31**, e `E83` ha sigillato il tipo il **giorno dopo**. *Un pre-controllo ha una data come tutto il resto.* **Quattro voci, TRE bloccanti:** ① ⛔ **`dispatch` costruisce con un letterale di struct e mette testo di RUNTIME all'indice 4** — `Record::V1(RecordV1 { kind: RecordKind::Routing, .. reason: String::from("the gateway resolved the routing for this step"), .. })`. ✅ **Misurato e non dedotto**, su una sonda usa-e-getta in `crates/kernel/src/sensor.rs` cancellata nella stessa corsa: `error[E0451]: fields ... of struct `RecordV1` are private` — e vale **anche da un modulo fratello DENTRO la crate**, perché la privacy di campo è del **modulo** e `gateway` non discende da `record`. ⛔ **E il difetto non è solo che non compila: il `String::from` all'indice 4 È la falla che AUD-050 ha chiuso**, quindi il compito così com'è la **riaprirebbe** — la stringa è un letterale, ma la firma che l'accetterebbe no. ② ⛔ **La sonda dettata legge campi privati da FUORI la crate**: `crates/kernel/tests/gateway_decisor.rs` fa `body.kind` e `&body.detail`, che sono ora gli **accessori** `body.kind()` e `body.detail()`. ③ ⛔ **Il banco dei byte congelati chiama un aiutante che ha cambiato firma**: il brief scrive `record(RecordKind::Routing, EffectClass::Idempotent, Trust::Instruction, Some(Detail::Routing(..)))`, mentre `record` in `crates/kernel/tests/frozen_bytes.rs` prende ora una **chiusura**, `impl FnOnce(Vec<u8>, &'static str) -> RecordV1`. ④ ⚠️ **IL PERIMETRO È CRESCIUTO, e non è una scelta:** l'elenco `Modify: crates/kernel/src/record.rs` nomina `RecordKind::Routing`, `Detail::Routing` e `RoutingDetail`, e **non** il costruttore della specie nuova. `E83` prescrive di sé che *«una specie nuova porta il proprio costruttore, che è additivo»*, quindi il compito deve aggiungere **`RecordV1::routing`** — con `detail: RoutingDetail` non facoltativo, sul precedente di `verdict`. ✅ **Le altre domande del pre-controllo reggono, ricontate col comando e non citate:** `crates/kernel/src/gateway/` **non esiste**, quindi il compito non è già eseguito (domanda 4); `pub enum Detail` **esiste**, quindi la premessa che il brief si dà è soddisfatta; e `ls crates/kernel/tests/frozen/*.cbor` ne conta **quattro**, quindi *«il quinto record congelato»* del brief è giusto. |
| **E89** | ⛔ **BLOCCANTE — I DUE COMMIT DEL COMPITO 6 NON SONO ESEGUIBILI NELL'ORDINE DETTATO: IL 6a NON COMPILA SENZA IL PASSO 1 DEL 6b.** Il `crates/kernel/src/gateway/mod.rs` dettato dal commit **6a** scrive `use crate::record::{.. RoutingDetail ..}` e costruisce un `Detail::Routing`, e **tutti e tre** quei nomi nascono al **Passo 1 del commit 6b**. ✅ **Misurato e non dedotto:** col solo 6a il banco risponde `error[E0432]: unresolved import` e `error[E0599]: no variant or associated item named Routing found for enum RecordKind`. ⛔ **Non è tipografia: il criterio di chiusura pretende `GATE GREEN` a ENTRAMBI i commit**, e il primo non compilerebbe nemmeno. ⚠️ **L'elenco `Files:` è unico per il compito e non per commit**, quindi la contraddizione non si vede leggendo la mappa dei file — si vede solo scrivendo il codice, che è la **terza** domanda del pre-controllo. 📌 **Eseguito nell'ordine che compila** — il formato (variante, specie del dettaglio, `RoutingDetail`, costruttore), poi l'arm di `reconcile` che il compilatore pretende, poi il decisore, poi i byte congelati — e consegnato come **un** albero, che è ciò che il coordinatore committa. |
| **E90** | ⛔ **C'È UN TERZO `match` ESAUSTIVO SU `RecordKind`, E NÉ IL PIANO NÉ `E60` LO NOMINANO:** `crates/kernel/tests/record_shape.rs`. `E60` censiva `frozen_bytes.rs` e la riconciliazione; questo file ne porta **due** siti dentro `every_record_kind_survives_the_round_trip_and_the_kinds_differ_in_the_bytes` — la chiusura `of`, che è `error[E0004]` **misurato**, e l'**array** del round trip, che il compilatore **non** tiene. ⛔ **La seconda metà è quella che conta, ed è già costata una correzione a mano:** estendere la chiusura e dimenticare l'array lascia una sonda che si chiama *«every record kind»* a camminare su un sottoinsieme in silenzio — che è **letteralmente** ciò che `E71` ha dovuto correggere quando arrivò `Verdict`. Entrambe estese, e il commento accanto all'array dice **perché** sono due posti e non uno. ⚠️ **Il censimento si rifà col comando e non dalla memoria:** `grep -rn "RecordKind::Verdict\|Detail::Verdict" crates/ --include=*.rs` rende i siti che nominano l'ultima variante, ed è così che questo è stato trovato. |
| **E91** | ⛔ **L'ARM VUOTO `RecordKind::Routing => {}` NASCE MUTANTE VIVO, E IL PIANO CHIEDE LA MISURA SENZA PRESCRIVERE CIÒ CHE LA RENDE POSSIBILE.** Il Passo 2 del commit 6b dice *«provalo con le due mutazioni … e se nessuna muove niente dichiaralo»*, ma non detta le sonde che tengono l'arm — e senza di esse **entrambe** le mutazioni lascerebbero il workspace verde: la sola sonda che scrive un record di routing è quella del dispaccio, che non chiama mai `steps_in_doubt`, e l'oracolo della campagna DST **panica** su quella specie invece di riconciliarla. ✅ **Chiuso sul precedente ESATTO che `reconcile.rs` già porta due volte:** `Note` e `Verdict` hanno ciascuno una **coppia** in `crates/kernel/tests/reconciliation.rs`, e la coppia nuova è scritta nelle **due** direzioni (§7.1.1 regola 3). ⛔ **E LA NON-VACUITÀ HA PRETESO UNA SCELTA CHE LE DUE COPPIE SORELLE NON AVEVANO:** `a_note()` e `a_verdict()` portano una classe **diversa** da quella dei loro passi, mentre un record di routing porta la classe che `dispatch` scrive davvero — `Idempotent` — quindi la differenza è stata messa **dall'altra parte**, sul passo. **Misurato:** con entrambi `Idempotent`, la mutazione `enter` uccide **una sola** delle due invece di due. ✅ **Le due mutazioni uccidono sottoinsiemi DIVERSI** — `enter` due, `leave` una — il che prova che la coppia è due difetti e non un controllo scritto due volte; la tabella sta in [`porta-di-qualita.md`](../../porta-di-qualita.md). |
| **E92** | ⚠️ **`.gitattributes` PORTAVA UN NUMERALE STANTIO CHE QUESTO COMPITO RENDE PIÙ STANTIO ANCORA.** Diceva *«OGGI NESSUNO DEI **TRE** FILE CONTIENE UN `0a` O UN `0d`»*, e i file erano **quattro** dal 2026-08-31; col quinto record congelato diventano **cinque**. ⛔ **L'affermazione resta VERA — nessuno dei cinque porta quei byte — e a essere falso è solo il numerale**, che è la forma più insidiosa del gotcha **#31**: una riga giusta nel merito che nessuno rilegge perché la regola che sostiene è giusta. ✅ **Rimediato con una SOTTRAZIONE e non con un riallineamento**, che è la regola di `CLAUDE.md`: *«un numero misurato non si scrive: si scrive il COMANDO che lo produce»*, qui `ls crates/kernel/tests/frozen/*.cbor`. ⚠️ **Fuori dal perimetro dettato, e dichiarato invece che taciuto:** il file non è nell'elenco `Modify:`, ma è **questo** compito a portare il conto da quattro a cinque, e lasciare un documento a mentire più forte di prima è ciò che il repository vieta. |
| **E93** | 📌 **IL VERBALE DI COME `E45`, `E50`, `E57`–`E62` E `E88` SONO STATE PRESE, perché una voce di pre-controllo che nessuno dichiara di aver raccolto è indistinguibile da una ignorata.** ⛔ **`E57`** (e `E45` con essa): la sonda del dispaccio apre il passo con un `intent` — aiutante `open_the_step` — e gli oracoli seguono, `entries.len() == 2` e il record a `entries[1]`. ⛔ **`E58`**: `Conforming` deriva **solo** `Debug` e le sonde confrontano con `matches!`; il derive che il compilatore suggerisce **non** è stato aggiunto, e il perché è scritto sul tipo. ⛔ **`E59` è una DECISIONE, e la decisione è «OFFERTI»**, presa leggendo ADR-0011: il record risolto elenca *«catena di riserva valutata»* e *«tentativi effettuati»* come **due voci separate**, quindi la catena è la popolazione in gioco e quanto lontano sia arrivato il filtro è l'altra voce, che questo traguardo non porta; e *«camminati»* non è nemmeno **un** numero, perché `resolve` percorre la catena **due** volte. Codice e doc dicono ora la stessa cosa, e la sonda usa una catena di **tre** col vincitore **primo** — mutazione **M4**, `left: 1, right: 3`. ⛔ **`E60`**: le due guardie di `frozen_bytes.rs` sono state **viste** scattare (`RecordKind::Routing` e `&Detail::Routing(_)` non coperti) prima di essere estese; il terzo sito è `E90`. ⛔ **`E61`**: due `#[test]` e non uno — *«una sonda in più»* è stata letta come **la coppia**, perché una sola si ferma alla prima asserzione (gotcha **#14**); mutazione **M3**, due morti. ⛔ **`E62`**: registrata e **non presa**, dichiarata sul doc di `dispatch` e nella cella del blocco B — una riga di catalogo nuova è spec. ⛔ **`E50`**: l'arm di `crates/simulator/tests/dst_campaign.rs` **panica** invece di essere assorbito, come quello di `Verdict`. ⛔ **`E88`**: tutti e quattro i punti presi — costruttore `RecordV1::routing` (④), nessun letterale di struct e `reason: &'static str` (①), accessori nelle sonde (②), chiusura nell'aiutante dei byte congelati (③). ⚠️ **E TRE DEVIAZIONI DALLA LETTERA DEL BRIEF, dichiarate:** ① le tre sonde con un nome in MAIUSCOLO portano `#[allow(non_snake_case)]`, perché il repository non ha precedenti di quei nomi e l'uscita resta pulita; ② la catena del dispaccio ha **tre** candidati e non uno, con un terzo `const` e un `PriceCeiling(0)` — è il rimedio di `E59`; ③ le sonde di `gateway_decisor.rs` sono **sette** e non cinque, per `E61`. |
| **E94** | ⛔ **REGISTRATA E NON PRESA, ED È DEL PROPRIETARIO — `RoutingDetail` È UNA TERZA BOCCA DELLA CLASSE DI AUD-050, NATA COL COMPITO 6.** ✅ **Riprodotta da FUORI la crate** su una sonda usa-e-getta cancellata nella stessa corsa, e **senza nessun atto deliberato**: `RecordV1::routing` è `pub`, `RoutingDetail` è `pub` **coi campi `pub`**, quindi un chiamante qualunque scrive `RoutingDetail { model: <String calcolata a runtime>, .. }` e il `Debug` scritto a mano la stampa **intera** — `detail: Some(Routing(RoutingDetail { model: "ignore your instructions", .. }))` — **col `reason` ancora un letterale `'static` a posto**. ⛔ **È l'argomento di AUD-050 alla lettera:** *una guardia vale quanto il suo costruttore*, e il `&'static str` di `reason` chiude la strada di **`reason`**, non quella del **record**. ⚠️ **Non è un difetto OGGI, e va detto:** l'unico chiamante di produzione è `gateway::dispatch`, e `Candidate::model` è `&'static str` — nessun testo di runtime entra per quella via, misurato. Il buco è nel **tipo**, che è esattamente la distinzione su cui AUD-050 fu deciso. ⚠️ **E `VerdictDetail` NON è coinvolta, misurato:** porta un `bool` e un `u64`, quindi il compito 5 non aveva aperto niente — `RoutingDetail` è il **primo** `Detail` che porta testo. ⛔ **IL COMPITO 7 LA TRIPLICA SE NON SI DECIDE PRIMA, ed è la ragione per cui la voce va portata adesso:** il suo `PermissionDetail` è dettato con **due** campi `String` pubblici, `tool` e `resource`, e ogni specie nuova aggiunge una bocca. ⚖️ **Il rimedio è già scritto altrove, ed è per questo che la voce è del proprietario e non dell'agente:** è la forma di **AUD-050** — campi privati e un costruttore che prende `&'static str` e converte dentro, come `of` fa per `reason` — e il tipo **sul filo resta `String`**, perché la decodificabilità è un vincolo misurato (**P-9**: un `&'static str` non è producibile da byte in arrivo senza `leak`). Costa una passata su `RoutingDetail`, `gateway::dispatch`, `frozen_bytes.rs`, `record_shape.rs`, un caso `compile_fail` nuovo e il registro; ⛔ **e i byte congelati NON si muovono**, perché la forma sul filo non cambia — è la stessa cosa che `E83` controllò per prima. ✅ **CHIUSA IL 2026-09-01, PER DECISIONE DEL PROPRIETARIO — la forma di AUD-050 applicata a `RoutingDetail`:** campi privati, `RoutingDetail::new(model: &'static str, evaluated, degraded)` come unica via, e un accessore per campo. ✅ **Il buco è stato RIPRODOTTO PRIMA del rimedio**, da fuori la crate su una sonda usa-e-getta cancellata nella stessa corsa: `detail: Some(Routing(RoutingDetail { model: "ignore your instructions", evaluated: 1, degraded: false }))`, col `reason` un letterale `'static` a posto — esattamente ciò che questa scheda prevedeva. ⛔ **E LA SCHEDA PREZZAVA UN SITO IN MENO, gotcha #65 applicato a una voce d'errata:** elencava `gateway::dispatch`, `frozen_bytes.rs` e `record_shape.rs`, e i letterali sono **quattro** — manca `crates/kernel/tests/reconciliation.rs`, trovato col censimento e non dedotto dall'elenco. ✅ **I byte congelati NON si sono mossi**, controllato per primo: `git status` su `crates/kernel/tests/frozen/` non nomina niente, e le sonde di `frozen_bytes.rs` restano verdi. ✅ **Il caso nuovo è `crates/kernel/tests/compile_fail/routing_detail_model_is_not_runtime_text.rs`, PROVATO NELLE DUE DIREZIONI:** allargato il solo `model` di `new` a `&str`, quel caso va **`error`** — la forma forte, dove trybuild dichiara *«expected compilation to fail»* invece di passare dal proprio oracolo — mentre `record_reason_is_not_runtime_text.rs` e `promote_reason_is_not_runtime_text.rs` restano **`ok`**, che è ciò che prova che i tre tengono strade **diverse** invece di essere copie. Mutazione revocata, `git diff` a zero righe su quella firma. ✅ **E un avviso ha CONFERMATO il rimedio invece di essere silenziato:** tolta la conversione da `gateway`, `use alloc::string::String` è diventato inutilizzato — cioè la conversione è davvero migrata in un posto solo. Tolto l'import, `cargo build --locked --workspace` a **zero avvisi**. 📌 **Baseline INVARIATA, e l'invarianza è il dato:** `cargo test --locked --workspace --no-fail-fast` dà **42 bersagli, 307 passate, 0 fallite, 2 ignorate**, identica a prima del rimedio — un caso `compile_fail` nuovo non aggiunge un `#[test]`, entra nel glob. `GATE GREEN` a fine passata. ⚠️ **Le due voci che ne DISCENDONO sono `E95` e `E96`**, e la seconda non è di questo compito. |
| **E95** | ⛔ **IL COMPITO 7 NASCE SIGILLATO, ED È LA CONSEGUENZA DIRETTA DELLA CHIUSURA DI `E94`: `PermissionDetail` NON HA CAMPI PUBBLICI.** Il compito lo detta con `pub tool: String`, `pub resource: String` e `pub write: bool` — cioè **due** bocche nuove della classe di AUD-050, che nascerebbero il giorno dopo che quella classe è stata chiusa sul tipo fratello. ⚙️ **La forma è quella di `RoutingDetail`, e non va reinventata:** campi privati, un costruttore solo — `PermissionDetail::new(tool: &'static str, resource: &'static str, write: bool)` — che converte in `String` dentro, più un accessore per campo. ⚠️ **Il tipo sul filo NON cambia**, quindi i byte congelati dei record esistenti non si muovono e il record congelato che il compito aggiunge si scrive con la stessa forma — lo si controlla **per primo**, come ha fatto `E83` e come ha fatto `E94`. ⛔ **E il compito 7 porta il proprio caso `compile_fail`**, sul modello di `routing_detail_model_is_not_runtime_text.rs` e provato nelle due direzioni: allargare il costruttore a `&str` deve far andare **`error`** quel caso e lasciare **`ok`** i tre fratelli — se li fa cadere insieme, il caso nuovo non tiene una strada propria. |
| **E96** | ⛔ **REGISTRATA E NON PRESA, ED È DEL PROPRIETARIO — UN RIMANDO `E<n>` NEL SORGENTE NON È UN RIFERIMENTO: il numero è unico dentro UN piano, e i piani lo riusano dall'inizio.** Trovata chiudendo `E94`, che ha **due** case omonime: l'`E94` di questo piano è `RoutingDetail`, quella del piano del **Traguardo 5** è la policy consegnata come secondo argomento di `Arbiter::new` — ed è la seconda che `crates/kernel/src/gateway/mod.rs` citava, **senza nominare il piano**. ✅ **Misurato col comando il 2026-09-01, non stimato: la MAGGIOR PARTE delle voci d'errata citate nel sorgente ha il proprio numero in più di un'errata, e UNA sola citazione dice a quale piano appartenga.** ⛔ **I NUMERALI SONO TOLTI E NON RIALLINEATI, e il perché è la prova più forte che questa voce abbia:** la prima stesura diceva **57** citate e **45** ambigue, misurate mezz'ora prima; rilanciando il comando **dopo** aver scritto questa voce le ambigue erano **46**, perché aggiungere `E96` a questa errata ha reso ambigua la citazione di `E96` nel sorgente — che veniva dall'errata del Traguardo 5. La cifra è stata falsificata **dalla voce che la descrive**, nella stessa sessione, e cresce a ogni voce d'errata nuova. 📌 **E il comando sta qui, che è la casa unica della misura** — i tre numeri si **rifanno**, non si rileggono: `cited=$(grep -rho '\`E[0-9]\+\`' crates/ --include=*.rs | tr -d '\`' | grep -v '^E0' | sort -u); echo "citate: $(echo "$cited" | wc -l)"; echo "ambigue: $(for n in $cited; do [ "$(grep -l "^| \*\*$n\*\*" docs/superpowers/plans/*.md | wc -l)" -gt 1 ] && echo x; done | wc -l)"` — e il `grep -v '^E0'` toglie i codici di `rustc`, che hanno la stessa forma e non sono voci. ⚠️ **Non è un difetto oggi, e va detto:** quasi ogni citazione **descrive** la voce accanto al numero, e la descrizione disambigua dove il numero non lo fa. Il buco è che a difendere il rimando è la **prosa**, non l'identificatore — quindi cade in silenzio il giorno in cui una descrizione si accorcia. ⛔ **Perché è del proprietario e non dell'agente:** le vie sono almeno due e cambiano una **convenzione** — qualificare il rimando in ogni sito, che è una passata su decine di file le cui case crescono a ogni compito, oppure numerare le errata per **sotto-progetto** invece che per piano, che è una decisione sul modo di lavorare. ⚖️ **Ciò che è stato fatto intanto, e nient'altro:** la sola citazione che *oggi* diventerebbe attivamente fuorviante — quella di `gateway/mod.rs`, perché la sua vicina omonima si chiude proprio oggi — è stata qualificata col nome del piano. Le altre **non sono toccate**: cominciare la convenzione nuova a metà ne produrrebbe **due** invece di una, che è la ragione con cui questo repository ha già rimandato lo spostamento delle misure in `riferimenti.md`. |
| **E97** | ⛔ **CORRETTO — SETTIMO GIRO: TRE CAMPI CHE `dispatch` SCRIVE IN UN RECORD DUREVOLE ERANO MUTANTI VIVI, E IL PEGGIORE È `Trust`.** `dispatch` scrive **sei** campi e `the_dispatch_journals_the_RESOLVED_decision_and_not_a_reference_to_it` ne rileggeva **quattro** — `kind`, `model`, `evaluated`, `degraded`. ✅ **Riprodotti dal coordinatore prima di rimediare, uno per uno:** `Trust::Instruction` → `Untrusted`, `EffectClass::Idempotent` → `Unrepeatable`, il letterale di `reason` cambiato — **`42 bersagli, 307 passate, 0 fallite, 2 ignorate` ciascuna, identico alla baseline**. ⛔ **`trust` è l'etichetta di `I6`/ADR-0014 su un artefatto durevole:** un record poteva portarla falsa senza un solo rosso. ⚠️ **Il censimento dice che era l'UNICO sito scoperto:** i siti che scrivono un `Trust` in un record — `arbiter/mod.rs`, `boundary.rs`, `sensor.rs` ×2, `gateway/mod.rs` — hanno tutti almeno una di queste asserzioni in un banco, tranne il gateway. ✅ **Chiuso con tre asserzioni nella sonda che c'era già**, e le tre mutazioni sono ora **rosse**, una sonda ciascuna. ⚠️ **`effect` è pinzato benché `reconcile` non lo legga**, ed è argomentato invece che scelto: il doc accanto alla chiamata **afferma** che il valore è vero di quel record — precedente del **Task 10** del Traguardo 5, *pinzati e non dichiarati perché un doc li afferma*. 📌 **E due numerali del registro che questo rimedio ha reso stantii sono TOLTI e non riallineati** (regola 5 della disciplina d'audit): *«sette test»* e *«le altre sei sonde»*, sostituiti dal comando e dalla relazione. |
| **E98** | ⛔ **CORRETTO — SETTIMO GIRO: LA VIA D'ERRORE DI `dispatch` NON ERA ESERCITATA DA NIENTE.** La funzione rende `Result<(), JournalError>` e **nessuna** sonda ne guardava mai l'`Err`, mentre il suo doc promette che *«`Journal::note` rifiuta una nota su un passo senza intento»*. ✅ **Riprodotto dal coordinatore:** `journal.note(step, &record)` → `let _ = journal.note(step, &record); Ok(())` lascia **`42 · 307 · 0 · 2`**, identico alla baseline. ⛔ **Un `dispatch` che dichiara successo mentre il record di routing non ha mai raggiunto il giornale è la perdita silenziosa che ADR-0007 esiste per vietare.** ⚠️ **La causa è visibile nella storia del banco:** il caso fu **incontrato** scrivendo il compito — il doc di `open_the_step` registra che *«the dictated probe started from an empty journal and could not pass»* — e fu risolto **aprendo il passo** invece di trasformarlo nella sonda della via d'errore. ✅ **Chiuso con `dispatch_does_not_swallow_the_journal_saying_no`**, che **non** apre il passo di proposito e pretende `Err(JournalError::OutOfOrder)`; la mutazione è ora rossa. |
| **E99** | ⛔ **CORRETTO — SETTIMO GIRO: LA RICETTA DI DISARMO CHE `E87` AVEVA RIPARATO È INVECCHIATA UN COMMIT DOPO, E IL VELENO ERA IL RIMEDIO STESSO.** `E87` chiuse l'occorrenza sostituendo *«any species constructor»* con un **numerale** — *«widen ALL FIVE … the four species AND the private `of`»* — e `ef361bc`, il commit **immediatamente successivo dello stesso giorno**, ha aggiunto la quinta specie `RecordV1::routing`. ✅ **Misurato: i siti sono SEI e le specie CINQUE** — `grep -c "reason: &'static str" crates/kernel/src/record.rs` → `6`. ⛔ **E il numerale stantio rende PIÙ probabile proprio l'errore che `E87` esisteva per prevenire:** chi conta cinque specie e legge «ALL FIVE» allarga le cinque specie, lascia `of`, e ottiene `error[E0521]` invece del rosso promesso. ⚠️ **Da non sovrapprezzare, e il coordinatore l'ha verificato:** il caso `compile_fail` **è verde e la sua forma è ancora forte**; a essere rotta era la ricetta, cioè la prova documentata di quella forma. ✅ **Chiuso togliendo il numerale e mettendo la RELAZIONE più il comando** — *«widen EVERY `reason` in `record.rs`»* — che è il gotcha **#76** applicato al rimedio invece che all'ultima ondata. ⚖️ **Nessun gotcha nuovo, ed è una scelta dichiarata:** *«un rimedio che sostituisce una formula qualitativa con un conteggio si falsifica al commit successivo»* **è** il **#76** — *togliere invece di riscrivere meglio* — e un gotcha che non insegna niente diluisce quelli che insegnano. |
| **E100** | ⛔ **CORRETTO — SETTIMO GIRO: LE LETTURE DI `evaluated` SONO TRE E LA SONDA NE SEPARAVA DUE, MENTRE IL SUO COMMENTO DICHIARAVA DI SEPARARLE TUTTE.** La frase diceva *«qui le due differiscono … quindi l'asserzione può passare per una sola delle due letture»*. ✅ **Misurato:** nello scenario di quella sonda la **prima** passata non trova niente e quindi **esaurisce** la catena, perciò *«quanti ne ha offerti la catena»* e *«quanti ne ha camminati la PRIMA passata»* valgono entrambi **tre** — riscrivendo `evaluated` come conteggio della prima passata l'intero workspace restava **verde**, `42 · 307 · 0 · 2`. ⛔ **`M4` del registro copre la SECONDA passata**, non la prima: le mutazioni erano due e la campagna ne dichiarava una. ✅ **Chiuso NON correggendo la frase ma aggiungendo la sonda che chiude la terza lettura** — `evaluated_is_what_the_chain_OFFERED_and_not_what_the_first_pass_walked`, dove la prima passata si ferma all'**indice 0** e cammina uno mentre la catena ne offre tre; la mutazione `M10` è ora rossa. 📌 *Chiudere la classe invece dell'occorrenza è la domanda che questo ciclo ha imparato a fare, applicata al rimedio stesso.* |
| **E101** | ⛔ **CORRETTO — SETTIMO GIRO: `E86` HA CHIUSO L'OCCORRENZA E LA CLASSE SI È RIAPERTA UN'ORA E MEZZA DOPO SUL TIPO FRATELLO.** `E86` (commit `b30e6c4`) aggiunse il qualificatore *«IN SOURCE»* alle due frasi su `RecordV1`; `3c90119` ha sigillato `RoutingDetail` e ha riscritto la stessa formula **senza** qualificatore — *«one place, and one that no caller can walk around»* — mentre il tipo deriva `Decode` e `Record::decode` è `pub`. ⛔ **E l'elenco A3 di `boundary.rs`, riscritto proprio per chiudere `E86`, nomina UN indice su due:** la stessa strada `Record::decode` porta testo di runtime anche in `RoutingDetail::model`, e il `Debug` scritto a mano stampa `detail` **intero** invece di chiuderlo come chiude il payload. 📌 *È letteralmente la lezione che quel rimedio si era scritto accanto — «una lista riscritta mentre si chiude un buco è esattamente dove va l'omissione successiva» — avverata il giorno dopo.* ✅ **Chiuso in entrambe le case**, col qualificatore su `RoutingDetail` e con l'indice 5 aggiunto all'elenco A3. ⚖️ **Una terza casa NON è toccata, dichiarato invece che taciuto:** il doc di `RoutingDetail::new` dice *«The ONLY way to build one»* ma **qualifica quattro righe più sotto** (*«the arriving road is `Decode`'s»*), quindi il lettore trova il correttivo; toccarla sarebbe prezzare il rimedio più grande del difetto — gotcha **#65**. ⚠️ **Nessun comportamento cambia:** la strada `Decode` è dichiarata **aperta e non chiudibile** in A4, e nessun sito di produzione la percorre. |
| **E102** | ⛔ **PRE-CONTROLLO DEL COMPITO 7 — COMINCIATO IL 2026-09-01 E **NON COMPLETO**, e dirlo e' la meta' che conta: chi dispaccia il compito 7 lo **finisce**, non lo salta perche' questa voce esiste.** ✅ **FINITO IL 2026-09-01: la metà che mancava è `E103`, qui sotto, e con essa un TERZO bloccante che questa voce non aveva.** ✅ **CIO' CHE E' GIA' MISURATO CONTRO IL CODICE DI ADESSO, coi comandi:** ① ⛔ **BLOCCANTE — `JournalError::Malformed` NON ESISTE.** Le varianti sono **quattro** — `NotDurable`, `Missing`, `OutOfOrder`, `StepInDoubt` — e il corpo di `is_granted` che il Passo 3 detta la nomina. Il compito **prevede gia'** il caso e ordina di NON inventarla: le vie sono due e **vanno misurate** prima di scegliere — aggiungere la variante con la propria ragione, come fu argomentato `StepInDoubt`, oppure far tornare alla proiezione un errore **proprio**, che ha il precedente di `FileJournal::open`. ② ⛔ **BLOCCANTE — IL CODICE DETTATO NON COMPILA: costruisce `Record::V1(RecordV1 { .. })` col letterale di struct, e `RecordV1` e' SIGILLATO da `c63c8c8`** (`E83`/AUD-050: nessun campo pubblico, un costruttore per specie). E' **la stessa classe di `E88`**, che era la voce bloccante del pre-controllo del compito 6, ripresentata sul compito successivo — *un compito scritto prima si legge contro il codice di ADESSO*. ⚠ **I siti dettati sono due**, il `grant` del Passo 3 e la voce dell'array di `frozen_bytes.rs` al Passo 4; **quest'ultima passa gia' da un aiutante `record(..)` e va riletta prima di prezzarla**. ③ ⛔ **L'ELENCO DEI FILE E' CORTO: cinque file fanno un `match` su `RecordKind` e il compito ne nomina DUE.** Misurato — `reconcile.rs` ✓ e `frozen_bytes.rs` ✓ sono nell'elenco; **`crates/kernel/src/sensor.rs`, `crates/kernel/tests/record_shape.rs` e `crates/simulator/tests/dst_campaign.rs` NO**. E' esattamente cio' che le voci `E50` ed `E90` avvertono, alla terza occorrenza. ⚠ **QUALI di quei match siano davvero ESAUSTIVI non e' stato verificato**: si aprono e si guarda se hanno un arm `_`. ✅ **E CIO' CHE INVECE REGGE, misurato e non assunto:** gli **indici sul filo dettati sono giusti** — `RecordKind::Permission` a `#[n(5)]` (0–4 presi) e `Detail::Permission` a `#[n(2)]` (0–1 presi). ⛔ **CIO' CHE RESTA DA FARE, ed e' la parte che questa voce NON copre:** le **quattro domande** di [`../../CLAUDE.md`](../../CLAUDE.md) per intero — in particolare la **3**, *scrivere un'implementazione da FUORI la crate*, che e' la sola che coglie un artefatto sbagliato che compila, e la **2**, *per ogni artefatto che il compito produce, quale controllo lo esercita?*, che non si vede leggendo. ⚠ **E un CANDIDATO non verificato, registrato perche' non si perda:** le sonde dettate al Passo 1 portano nomi con maiuscole — `a_different_OPERATION_is_not_covered`, `a_different_RESOURCE_is_not_covered`, `a_different_TOOL_is_not_covered` — e il banco del compito 6 mette `#[allow(non_snake_case)]` su una sonda della stessa forma. Se serva anche qui **non e' stato misurato**. ⚖ **E `E95` resta la voce che governa la forma:** `PermissionDetail` nasce **sigillato**, e il compito lo detta coi campi `pub`. |
| **E103** | ⛔ **PRE-CONTROLLO DEL COMPITO 7 — FINITO IL 2026-09-01, e COMPLETA `E102`.** Le quattro domande sono state fatte tutte, e ne escono un **terzo bloccante**, **due correzioni a `E102` stessa** e **quattro vie non esercitate**. **④ ⛔ TERZO BLOCCANTE, e `E102` non ce l'aveva: TUTTE E CINQUE LE SONDE DETTATE FALLISCONO, perché `grant` scrive una NOTA su un passo che nessuno ha aperto.** `Journal::note` dichiara di sé, in `crates/kernel/src/ports/journal.rs`, *«a note for a step with NO INTENT is `OutOfOrder`. A note is an annotation UPON something, and a step nobody opened is not something»*; le cinque sonde del Passo 1 partono da `MemoryJournal::new()` e chiamano `grant(.., StepId::new(1), ..)` senza `intent`, quindi `.expect("grant")` va in panico su **tutte**. ⛔ **È la SECONDA occorrenza esatta della voce bloccante del compito 5**, e ciò che la smentisce è scritto **nel banco di quel compito**: `crates/kernel/tests/sensor_ring.rs` porta in testa al file *«The dictated probes started from an empty journal and could not …»*. Gotcha **#58** alla sua occorrenza più letterale — *ciò che ti smentisce può stare in un banco di prova, perfino in un commento*. 📌 **Il rimedio ha già il proprio precedente e non è una decisione:** quel banco stabilisce che *«l'intento appartiene al CHIAMANTE, mai all'anello»* e apre il passo con `journal.intent(step, &intent)` prima della nota. Le sonde del compito 7 fanno lo stesso, e `grant` resta com'è. **⑤ ⛔ `is_granted` NON COMPILA PER UNA SECONDA RAGIONE, e `E102` prezzava DUE siti su QUATTRO.** Il corpo legge `body.kind` e `&body.detail` come **campi**, e `RecordV1` non ne ha più: gli accessori sono `body.kind()` e `body.detail()`. ⛔ **E il sito del `grant` non si chiude spostando una parentesi: manca un COSTRUTTORE.** AUD-050 dà *«un costruttore per specie»* — oggi `intent`, `outcome`, `note`, `verdict`, `routing` — quindi il compito deve **aggiungere `RecordV1::permission(..)`**, che nessun passo nomina. **⑥ ⚠️ CORREZIONE A `E102` ③: i file col `match` su `RecordKind` sono QUATTRO e non cinque, e tutti e quattro sono ESAUSTIVI** — misurato aprendoli: `reconcile.rs` (cinque arm, nessun `_`), `frozen_bytes.rs` (cinque nomi in un arm solo), `crates/kernel/tests/record_shape.rs` (cinque arm che **costruiscono**), `crates/simulator/tests/dst_campaign.rs` (cinque arm, due dei quali `panic!`). ⛔ **`crates/kernel/src/sensor.rs` NON ha un match: ha un COMMENTO** che cita `RecordKind::Intent`. È il gotcha **#65** applicato a `E102` stessa — *un rapporto è un'affermazione come le altre* — e la parte utile è che l'elenco dei file resta corto di **due** e non di tre. ⚠️ **E `record_shape.rs` costa più di un arm:** il suo `match` costruisce un record per specie, quindi pretende il costruttore del punto ⑤; `dst_campaign.rs` deve **scegliere** fra arm vuoto e `panic!`, che è ciò che fa per `Verdict` e `Routing`. **⑦ ✅ IL CANDIDATO DI `E102` È MISURATO: sì, serve.** `#[allow(non_snake_case)]` vive in **tre** siti di `crates/kernel/tests/gateway_decisor.rs`, il banco del compito 6, sulla stessa forma di nome. **⑧ ⚠️ DOMANDA 2 — QUATTRO vie del corpo dettato non sono raggiunte da NESSUNA delle cinque sonde**, ed è la specie di `E101`: ① la via d'errore di `grant`, cioè un giornale che rifiuta la nota; ② il ramo `Err(_) → Malformed`, che è **proprio la via che il doc dichiara portante** (P-15 · D20); ③ il `continue` su un record di specie **diversa**, perché le sonde scrivono solo record `Permission`; ④ il `continue` su un record `Permission` **senza** `detail`. ⛔ **Le prime due sono mutanti vivi per costruzione**, e la seconda è la peggiore: il commento accanto dichiara che saltare un record illeggibile sarebbe *«la verità parziale silenziosa che D20 esiste per impedire»*, e nulla lo prova. ⚖️ **E UNA SOLA SCELTA È DEL PROPRIETARIO, registrata e non presa:** la variante di `JournalError` del punto ① di `E102`, e solo in **una** delle due vie — aggiungerla tocca il **contratto di una porta condivisa da due implementazioni** e la suite di conformità, mentre un errore **proprio** della proiezione non tocca la porta affatto. ⛔ **RICHIAMO DEL 2026-09-01, dentro la voce stessa: questa riga ne dichiarava DUE, e la seconda NON è una scelta.** `E95` decide già la forma di `PermissionDetail` **e la scrive per esteso** — campi privati, il costruttore `PermissionDetail::new(tool: &'static str, resource: &'static str, write: bool)`, un accessore per campo e un caso `compile_fail` provato nelle due direzioni. Il compito la **esegue**, non la ripropone: è il gotcha **#65** al verso opposto, un pre-controllo che prezza **più** di ciò che serve. ✅ **E la DOMANDA 4 regge:** `crates/kernel/src/permission.rs` e `crates/kernel/tests/permission_triple.rs` **non esistono** e i record congelati sono **cinque** — il compito non è già eseguito. |
| **E104** | ✅ **DECISA IL 2026-09-01, E LA DECISIONE È PIÙ PICCOLA DI ENTRAMBE LE VIE CHE `E102` METTEVA DAVANTI: `RecordError::Malformed` ESISTE GIÀ, e il piano ha nominato l'ENUM SBAGLIATO.** `crates/kernel/src/record.rs` porta `pub enum RecordError { Malformed }` — *«The bytes are not a record of any version this build knows»* — ed è ciò che `Record::decode` restituisce. Il Passo 3 scrive `JournalError::Malformed`: non manca una variante, è nominato l'enum di un'altra cosa. ⛔ **Quindi NESSUNA delle due vie si percorre:** non si aggiunge una quinta variante a `JournalError` — che tocca il contratto di una porta, due implementazioni e la conformità — e non si inventa un errore nuovo. ⚙️ **La forma, ed è quella che il kernel usa già OTTO volte:** `is_granted` restituisce un errore **proprio** che compone le due cause che esistono entrambe — quella del giornale (`JournalError`, da `replay`) e quella del record (`RecordError`, da `decode`). ⛔ **RICHIAMO DEL 2026-09-01, e la prova che questa voce citava era FALSA — trovata dall'implementatore del compito, non da chi l'ha scritta.** La riga diceva *«è la forma che il kernel usa già OTTO volte»* ed elencava `GatewayError`, `ReleaseError`, `RunError`, `WireError`, `ProcessError`, `IpcError`, `FilesystemError`, `NetworkError`. ✅ **Misurato: nessuno degli otto ha una variante che porti un carico** — sono tutti enum a varianti nude. Reggono come precedente di *«un errore PROPRIO invece di una variante sulla porta»*, che è la metà che decide; **non** reggono come precedente di **composizione**. ⛔ **L'unico precedente di composizione è `platform::journal::OpenError`** — `File(io::Error)` ed `Engine(redb::Error)` — e vive in `platform`, non in `kernel`, il che è un fatto da dichiarare e non da nascondere. 📌 *Una decisione può essere giusta e la sua prova sbagliata, e in questo repository è la radice **R1**: qui è stata commessa dentro la voce che decide.* Il numerale è **tolto e non riallineato**. ⚖️ **E il fratello più vicino è stato letto prima di decidere, non dopo:** `reconcile::steps_in_doubt` ha la stessa forma — funzione libera che rilegge e deriva — e tiene `JournalError` **solo** perché il record illeggibile lo trasforma in una **risposta** (`Err(_) => enter(.., Resolution::SuspendAndAsk)`), cioè fallisce chiuso dentro il proprio tipo di ritorno. `is_granted` restituisce un `bool` e **non ha quella stanza**: è precisamente il motivo per cui le serve un errore proprio, e non un'eccezione alla regola. ⛔ **E la ragione per cui NON può rispondere `false`** sta già scritta accanto al corpo dettato: sarebbe la verità parziale silenziosa che **D20** esiste per impedire, e il degrado silenzioso che **ADR-0019** vieta. 📌 **Il costo dichiarato:** l'errore nuovo è una superficie nuova, e la via ② di `E103` — il ramo del record illeggibile — **deve** avere la propria sonda, o nasce come mutante vivo il giorno stesso. ⚠️ **Il compito 7 resta comunque da riscrivere prima di dispacciarlo**, per i bloccanti ④ e ⑤ di `E103`, che questa decisione non tocca. |
| **E105** | ✅ **IL PRIMO GIRO DI REVISIONE DEL COMPITO 7 È FATTO IL 2026-09-01 DA UN REVISORE INDIPENDENTE, E I CINQUE RILIEVI SONO CHIUSI.** Conformità al brief **✅** — quindici voci su quindici, riverificate contro il codice e non contro il rapporto. **Qualità RESPINTA**, con **sei mutanti vivi misurati**. ⛔ **I due gravi sono la stessa cosa vista da due lati:** ① la strada `Operation::Write → write: true` **non era percorsa da niente in tutto il workspace** — tutte le chiamate a `grant` passavano una lettura — quindi concedere una **scrittura** poteva registrare una **lettura** senza un rosso; ② `grant` scrive **sei** campi e nessuna sonda ne rileggeva il record, perché il banco passava solo dal **lettore**: `trust`, `effect`, `reason` e `payload` erano quattro mutanti vivi separati. ⛔ **Ed è `E97` VERBATIM sulla funzione sorella, a un'ora e quarantadue di distanza** — `gateway::dispatch` in `9441e6d`, `permission::grant` in `8d45eea` — con la regola generale già **scritta accanto al codice** del primo caso. Da lì il gotcha **#102**. ⛔ **Il terzo:** gli indici CBOR di `tool` e `resource` erano **permutabili a workspace verde**, perché il record congelato porta `"frozen"`/`"frozen"` — due stringhe **uguali**, quindi permutabili senza che un byte cambi — e il commento accanto **affermava il falso**, *«due stringhe uguali a due offset pinzano due offset»*. ✅ **Chiusi tutti e cinque in `0c1eead`**, e il coordinatore ha **riverificato le tre mutazioni una per una**: ciascuna uccide **una** sonda. ⚠️ **E il coordinatore ha commesso il #103 misurando:** la prima mutazione di `Trust` è caduta sulla riga **111**, che è un `///`, e il verde diceva *«mutante vivo»* mentre non c'era nessun mutante. |
| **E106** | ✅ **CHIUSA IL 2026-09-01 in `52efadd`, commit separato e dichiarato, sul precedente di `b66295d`** — la sonda `the_promoted_content_is_the_payload_and_it_is_labelled_untrusted` già rileggeva `trust`, `payload`, `reason` e `detail`: mancava **solo** `effect`, e ora c'è, provata nelle **due** direzioni (sul codice giusto **43 · 323 · 0 · 2**, sul mutante **una** rossa). ⛔ **MUTANTE VIVO PREESISTENTE, FUORI DAL PERIMETRO DEL COMPITO 7 E MISURATO IL 2026-09-01: `EffectClass::Unrepeatable` in `Untrusted::promote` non è tenuto da NIENTE.** `crates/kernel/src/boundary.rs` — mutato in `EffectClass::Idempotent`, `cargo test --locked --workspace --no-fail-fast` dà **43 bersagli, 323 passate, 0 fallite**, identico alla baseline. ✅ **L'etichetta `I6` INVECE È TENUTA**, misurata nella stessa passata: `Trust::Untrusted → Trust::Instruction` fa **una** rossa. ⛔ **Perché conta più di un campo qualsiasi:** `EffectClass` è ciò che ADR-0007 usa per decidere come la riconciliazione tratta un **dubbio** — `Unrepeatable` significa *«sospendi e chiedi all'utente»*, `Idempotent` significa *«riesegui»*. Un cambiamento silenzioso lì fa **sparire un dubbio vero dentro un ritentativo automatico**, sul confine dei dati non fidati. ⚖️ **È la TERZA occorrenza della classe del gotcha #102**, dopo `dispatch` e `grant`, ed è la prova che quella classe **non è del Traguardo 6**: `boundary.rs` è codice del Traguardo 2/3. 📌 **Trovata da un revisore che il crash del PC ha interrotto a metà mutazione**, e la misura è stata **completata dal coordinatore** invece di buttare la pista insieme al file sporco. ⚠️ **NON chiusa qui, perché allargare il perimetro di un compito è una decisione**, e il precedente si biforca: `b66295d` ha rimediato un rosso preesistente in un commit separato e dichiarato, mentre altre voci preesistenti sono state **registrate e non prese**. Il rimedio, se si prende, è la forma già scritta due volte: una sonda che **rilegge** il record che `promote` scrive e ne asserisce **ogni** campo. |
| **E107** | ✅ **IL SECONDO GIRO DI REVISIONE DEL COMPITO 7 È FATTO IL 2026-09-01 — il verbale è `E114` — E QUESTA VOCE ERA IL SUO BRIEF — sta QUI e non nel ledger, perché il ledger è `git`-ignorato e NON raggiunge un'altra macchina.** ⚠️ **Misurato il 2026-09-01:** `git check-ignore .superpowers/sdd/progress.md` risponde, quindi ogni istruzione lasciata lì muore con la macchina che l'ha scritta — è la voce `E43`, colta stavolta **prima** che costasse. ⛔ **Perché il giro serve:** il primo (`E105`) ha respinto la qualità con sei mutanti vivi, chiusi in `0c1eead`, e **un rimedio è codice nuovo** — in questo repository un'ondata di correzioni ha aperto difetti nuovi nella prosa scritta per chiuderli **nove volte in due compiti**. La regola è *si rivede finché una passata non torna pulita*, ed è **forte** dopo un cambiamento di codice. ⚙️ **Il perimetro:** `bf1e677..HEAD`. Il pacchetto si rigenera — non si cerca nello scratchpad, che non sopravvive alla sessione — con `git log --oneline bf1e677..HEAD`, `git diff --stat bf1e677..HEAD` e `git diff -U10 bf1e677..HEAD` in un file solo. ⛔ **Le cinque domande, in quest'ordine:** ① *il rimedio ha chiuso l'OCCORRENZA o la CLASSE?* — col `grep` sui fratelli, ed è la domanda che qui ha pagato più di ogni altra; ② *il rimedio ha aperto un difetto NUOVO?*; ③ *le sonde nuove sono non-vacue?* — si **misura** mutando, non si legge; ④ *un'affermazione che il codice smentisce*, nei commenti nuovi e in [`../../porta-di-qualita.md`](../../porta-di-qualita.md); ⑤ *la sonda di `R3` tiene le POSIZIONI o di nuovo solo i valori?* — `permission_triple.rs` codifica e decodifica dalla **stessa** derive, quindi ogni permutazione degli indici gli è invisibile. ⚠️ **Si dice al revisore che `E106` è già trovata e chiusa**, o rifà quel lavoro. ⛔ **E si dice il #103**, perché lo colpirà: revocare una mutazione con `cp -p` conserva l'mtime e `cargo` non ricompila — si usa `cp` più `touch`, e si controlla col `grep -n` che la mutazione non sia caduta in un `///`. ✅ **La baseline da cui parte è 43 bersagli, 323 passate, 0 fallite, 2 ignorate**, `GATE GREEN`, `fmt` pulito, sei record congelati. ⚠️ **RICHIAMO DEL 2026-09-01: QUESTO BRIEF HA UNA DATA COME TUTTO IL RESTO, e riprendendolo DUE sue affermazioni erano già stantie** — gotcha **#65**, precedente `E88`. ① **Il perimetro `bf1e677..HEAD` è CRESCIUTO sotto il brief:** scritto quando `HEAD` era `ab37c42`, alle 18:11, e alle 19:24 è atterrato `03da317` — la passata indipendente sul compito 5, che porta **codice di prodotto** mai rivisto (le due guardie `match` di `E109`, il doc di `Detail`, una sonda nuova). ⚖️ **Deciso dal proprietario: si legge alla LETTERA**, così quel codice non sfugge. ② **La baseline era stantia di UNO** — sono **324** — e la causa è misurata e non supposta: `03da317` aggiunge **esattamente un** `#[test]`, e `sensor_ring.rs` passa da cinque a sei sonde. 📌 *Un brief si prezza leggendo il codice di ADESSO, non il brief.* |
| **E108** | ⛔ **PASSATA INDIPENDENTE DEL 2026-09-01, VOCE BLOCCANTE — UN PARAGRAFO DI `src/` CHE SPIEGA PERCHÉ UN CAMPO DEL FORMATO DUREVOLE È SICURO, E LA MISURA LO SMENTISCE.** Il doc di `Detail` diceva *«AN UNKNOWN VARIANT DOES NOT DECODE, and that is what makes the field safe … A build that does not know a species STOPS instead of guessing»*. ⛔ **Riprodotto su una sonda usa-e-getta scritta da fuori la crate e cancellata nella stessa corsa, sui byte congelati del verdetto:** l'indice di variante di `Detail` portato da `00` a `03` — il primo libero — o a `09` risponde **`Ok(V1(RecordV1 { .. detail: None .. }))`**, cioè la sostanza sparisce **in silenzio**; nessun errore nasce, quindi nessuno raggiunge la mappatura di `Record::decode` né `reconcile`. ✅ **E il difetto è ISOLATO all'indice di variante**, misurato: `kind` a `09` e un corpo di arità sbagliata sono entrambi `Err(Malformed)`. ⛔ **La misura citata era VERA e apparteneva agli enum sotto `#[cbor(index_only)]`, cioè al campo ACCANTO** — gotcha **#98** alla terza occorrenza, stavolta in `src/` e non in un banco. ⛔ **E la coppia tenuta al LIVELLO 1 dal 2026-09-01 non chiude questa strada**, che è la distinzione da tenere: rende **incostruibile** una coppia sbagliata, mentre qui si **decodificano byte già scritti**. Una **seconda specie** sotto un `kind` **esistente** verrebbe ingoiata da una build vecchia. ✅ **Chiuso correggendo il paragrafo SULLA MISURA e sottraendo.** ⛔ **Ciò che resta è REGISTRATO E NON PRESO, del proprietario**, e deliberatamente **non pinzato**: una sonda sul silenzio di oggi sarebbe un voto contro il cambiarlo (gotcha **#73**). ⚠️ **QUATTRO passate di revisione del compito 5 gli sono passate accanto.** |
| **E109** | ⛔ **`==` NON È UNA GUARDIA, E L'ASSENZA NON SI TROVA MUTANDO.** `CostClass` e `VerdictOutcome` sono i due enum su cui `run_the_ring` decide, ed erano tenuti da **soli `==` e da nessun `match`** (⚠️ *«quattro»* fino al 2026-09-01: erano tre — `E128`). ⛔ **La prova è un CENSIMENTO e non una mutazione, ed è più forte:** una mutazione dice che *una* corsa è restata verde, il censimento — `grep -rn CostClass crates/`, idem per `VerdictOutcome` — dice che in **tutto** `crates/` non esiste un `match` su quei tipi, quindi **niente in nessun punto** potrebbe cogliere una variante nuova. È la ragione per cui quattro passate a mutazioni non l'avevano vista: **una mutazione coglie un comportamento CAMBIATO, mai un tipo CRESCIUTO** — gotcha **#104**. ⛔ **E la caduta di `CostClass` è dalla parte SBAGLIATA:** tutto ciò che non è `Inferential` **entra** nell'anello stretto, cioè la cosa che V11 esiste per rifiutare — stessa forma di `E55`, il cui letterale *«indovinava nella direzione permissiva»*. ⚖️ **Decisione del proprietario del 2026-09-01: guardia su entrambi.** ✅ **Provata nelle due direzioni:** una terza variante dà `` error[E0004] `` su ciascuno — `CostClass::Remote` e `VerdictOutcome::Inconclusive` — revocate con `cp` **più `touch`**, che è la cura del gotcha **#103**. ⚠️ **`verdict.outcome` è letto UNA volta sola** in un `let passed`: due `match` sullo stesso valore possono divergere, e uno solo basta a rendere la crescita un errore di compilazione. |
| **E110** | ⛔ **L'UNICA STRADA DI `run_the_ring` CHE RISPONDE `Err`, E NON LA RAGGIUNGEVA NESSUNA SONDA.** Il doc **afferma** un valore — *«this function answers `Err(JournalError::OutOfOrder)` when `step` was never opened»* — e la testa del banco la **descrive**, ma descrivere non è tenere: ogni sonda apre il passo e poi fa `.expect("the ring")`, quindi il ramo `Err` non aveva **nessun** lettore. ✅ **Misurato prima del rimedio:** col `?` di `journal.note` sostituito da `let _ = ..` il workspace resta identico alla baseline. ✅ **Chiusa con `a_step_nobody_opened_is_refused_and_nothing_is_written`, che asserisce DUE cose** — la chiamata è `Err(OutOfOrder)` **e** l'archivio è **vuoto** — perché è la seconda che conta: un verdetto scritto su un passo che nessuno ha aperto è l'ordine write-ahead di ADR-0007 rotto, non un valore di ritorno. ✅ **Controllo dopo:** con la stessa mutazione la sonda nuova è **l'unica rossa del banco**, `5 passed; 1 failed`. |
| **E111** | ⚠️ **TRE CLAUSOLE DEL DOC DI `Detail`, TUTTE TOLTE.** *«`Record` **ABOVE**»* — `Record` sta alla riga **793** e `Detail` alla **201**, quindi è **sotto**; *«between the only two data-carrying enums of the crate»*, dove `wire::worker::FromWorker` è un **terzo** che porta l'argomento **opposto** (il suo doc argomenta che scrivere l'attributo vale **di più** lì, perché quel canale non ha oracolo e i suoi due pari vivono fuori dal workspace); e *«Measured on **2026-09-01**»*, mentre `git log -L` data il commit che l'ha scritta — `4e4b725` — al **2026-08-31**. ✅ **La misura che le tre accompagnavano è INTATTA e resta.** |
| **E112** | ⚠️ **DUE DATE FALSE IN `crates/`, E IL CENSIMENTO HA DOVUTO DISCRIMINARE.** È `E66` nelle case che il suo censimento non raggiunse, ma la forma è cambiata: dal 2026-09-01 la **maggior parte** delle date `2026-09-01` nel sorgente è **legittima**, perché quei commit sono davvero di oggi. ⛔ **Quindi un `grep` non basta e uno sweep sarebbe stato un difetto peggiore del difetto:** ogni occorrenza è stata datata con `git log -1 -L <riga>,<riga>:<file>`. **Cinque** occorrenze fra `reconcile.rs` e `sensor_ring.rs`: **tre** scritte da commit di **oggi** e quindi vere — restano — e **due** scritte da commit del **2026-08-31**, `4e4b725` e `128c9aa`, quindi false. ✅ **Tolte quelle due, non riallineate**, e il fatto che le altre restino è scritto accanto. 📌 *Un censimento che sweepa una parola invece di datarla riga per riga produce l'errore che stava correggendo.* |
| **E113** | ⚠️ **UN CONTEGGIO DI BYTE SOPRAVVISSUTO AL CENSIMENTO DI `E70`, NELLA TESTA DI `frozen_bytes.rs`.** *«before `85`, the five fields»* e *«a record is 21 bytes and not 20»*, mentre i record congelati oggi sono **sei** e vanno da **21** a **40** byte — `wc -c` sui `.cbor` — e tre su sei portano `86`. ⚖️ **Prezzata onestamente:** il capoverso **immediatamente sopra** dice già che un record con `detail` *«IS LONGER AND ALSO MOVES BYTE 3»*, quindi un lettore attento non era ingannato. Ciò che la rende un rilievo è **dove** stava: quel capoverso vicino fu corretto il 2026-08-31 per **esattamente** questa ragione, e questa clausola è rimasta in piedi accanto — la forma di **AUD-049**. ✅ **Tolte entrambe e non riallineate**, perché il conto cresce col formato: a dirlo è `the_frozen_records()`, che il compilatore controlla. ⛔ **E chiusa in ENTRAMBE le case della frase** — `frozen_bytes.rs` e `crates/kernel/tests/frozen/record_v1.map`, che portava la gemella — perché un rimedio che ne raggiunge una sola è il modo in cui le due divergono. |
| **E114** | ✅ **IL SECONDO GIRO DI REVISIONE DEL COMPITO 7 È FATTO IL 2026-09-01 DA UN SOTTO-AGENTE FRESCO, CON LA LETTURA D'APERTURA VIETATA, E NON È TORNATO PULITO: CINQUE RILIEVI, TUTTI RIVERIFICATI DAL COORDINATORE PRIMA DI RIMEDIARE E TUTTI VERI.** ⛔ **Il primo è di PRODOTTO ed è la specie di `E109` sul TERZO sito:** `Operation` era tenuto da due `matches!` e da nessun `match`, quindi un enum cresciuto cadeva dalla parte **permissiva**. Misurato in due modi: con `Execute` aggiunto, `cargo check --locked --workspace --all-targets` esce a **zero errori** e la suite resta **43 · 324 · 0 · 2**, identica alla baseline cifra per cifra; e una sonda usa-e-getta scritta **da fuori la crate** mostra `grant` che scrive `write=false` per un `Execute` nel formato **durevole**, e `is_granted` che risponde **`true`** a una lettura che nessuno ha concesso — l'aliasing vale nei due versi. ⛔ **E ciò che conta di più è PERCHÉ era ancora lì:** il censimento di `E109` era limitato ai **due tipi che rimediava**, quindi chiuse l'**occorrenza** e non la **classe**. ✅ **La classe — un enum su cui il kernel decide, tenuto da `==`/`matches!` e da nessun `match` — è stata ricensita su tutti i 34 enum pubblici di `kernel/src/`, e aveva esattamente DUE membri vivi:** questo e `ConstraintClass`, che è la voce `E115`. ⚠️ **E il primo censimento del coordinatore aveva un FALSO NEGATIVO che avrebbe prodotto un rilievo falso:** il regex dei bracci non coglieva le varianti **con carico**, quindi dava `Admission` per scoperto mentre è tenuto da **dieci** bracci in `crates/daemon/src/main.rs`. Da lì il gotcha **#106**. ✅ **`Trust` invece è tenuto da un meccanismo DIVERSO** — `minicbor` rifiuta una variante senza indice — ed è la seconda direzione della prova. ⚖️ **Rimedio: `Operation::is_write`, un `match` esaustivo in UN posto solo**, perché due `match` su valori diversi possono divergere e uno basta a rendere la crescita un errore — la lezione che `E109` scrisse per `verdict.outcome`. Provato nelle due direzioni: `error[E0004]` con la mutazione, `43 · 324 · 0 · 2` e `GATE GREEN` senza. Commit `bdd18bc`. ⚠️ **Gli altri tre sono di PROSA:** *«An enum here costs NOTHING the day it grows a third variant»*, che è la frase che la misura qui sopra smentisce; *«cannot be handed runtime text AT ALL»*, mentre `String::leak` è una strada che `boundary.rs` **dichiara aperta** — sostituita con la formulazione che il repository possiede già **tre volte** in `record.rs`, *«not producible from arriving bytes WITHOUT LEAKING»*, e la **conclusione** dei due paragrafi non era in dubbio: era la **premessa** a strafare; e una riga di catalogo di [`porta-di-qualita.md`](../../porta-di-qualita.md) che enumerava le sonde di `permission_triple.rs` **nella riga la cui cella accanto vieta esattamente quello**. ⚠️ **Quest'ultima era prezzata in DIFETTO dal rapporto:** ne dava **una** omessa, e contate **sul binario** sono **undici** contro **otto** enumerate, cioè **tre** — gotcha **#65** applicato a un rapporto, nella direzione che chiede **meno** del necessario. ✅ **E DUE PASSATE SONO TORNATE PULITE, che è un risultato e va detto invece che taciuto:** la domanda ⑤ — la sonda di `R3` tiene le **POSIZIONI** e non i valori, misurato scambiando gli indici `#[n(0)]` e `#[n(1)]` di `tool` e `resource`, con **una sola** rossa — e la domanda ②, nessun difetto nuovo aperto dai rimedi del primo giro. ⚠️ **RICHIAMO DEL 2026-09-01, nono giro (`E124`): *«aveva esattamente DUE membri vivi»* era FALSO dentro il proprio perimetro** — `arbiter::Activity` e `arbiter::PreemptibleState` sono `pub` in `kernel/src/` e crescevano a `exit 0`; e fuori da esso `executor::TaskState` ed `EntryKind` del simulatore. Il censimento resta un verbale; la chiusura è del compilatore. |
| **E115** | ✅ **CHIUSA IL 2026-09-01 in `bba4ca1`, FUORI DAL PERIMETRO DEL COMPITO 7 E DICHIARATO**, sul precedente di `b66295d` ed `E106`. ⛔ **`ConstraintClass` era il SECONDO membro vivo della classe di `E114`:** confrontato con `==` in due `.filter()` di `gateway::resolve` e matchato in **nessuno**, quindi una terza classe cadeva fuori da **ENTRAMBI** i filtri — un vincolo che **nessuno applica**, che è la direzione permissiva che ADR-0012 esiste per vietare. ✅ **Riprodotto prima di correggere:** con `Residency` aggiunta all'enum, `cargo check --locked --workspace --all-targets` esce a **zero errori**. ⛔ **Perché NON è stata rimandata, ed è il punto:** il rilievo che la apre dice *«il rimedio di `E109` ha chiuso l'occorrenza e non la classe»* — chiudere `Operation` lasciando questa aperta sarebbe stato commettere quel difetto **dentro il commit che lo corregge**, cioè la radice **R1** dell'audit del 2026-08-27. ⚖️ **E il rimedio NON scrive un filtro come complemento dell'altro:** la negazione assorbirebbe la terza classe da un lato invece di rifiutarla, cioè **sposterebbe** la caduta silenziosa senza chiuderla. ✅ **Provato nelle due direzioni, e la seconda dice quanto:** con la mutazione escono **DUE** `error[E0004]`, uno per filtro, che è ciò che prova che i siti tenuti sono due e non uno. |
| **E116** | ⛔ **OTTAVO GIRO, MUTANTE VIVO DI PRODOTTO: il `payload` del record che `gateway::dispatch` scrive non era riletto da niente, ed è la PREMESSA dell'asserzione che `E97` aveva appena aggiunto.** `Trust::Instruction` è vero di quel record **soltanto perché** nessun byte esterno vi entra, quindi un payload non tenuto lascia l'etichetta **I6** di ADR-0014 poggiata sul nulla. ✅ **Misurato:** tre byte nel payload lasciano il workspace verde, **43 · 324 · 0 · 2**, identico alla baseline; `grep -c payload crates/kernel/tests/gateway_decisor.rs` dava **zero** mentre gli altri quattro banchi che rileggono un record lo pinzano tutti. ⛔ **E il banco sorella `permission_triple.rs` aveva chiuso la stessa classe in `0c1eead`, cioè DOPO `9441e6d`:** la classe fu chiusa dove la si guardava e lasciata aperta dove l'ondata stava riparando. ⚖️ **Chiuso con l'asserzione già scritta nel banco sorella**, parola per parola, perché la ragione era già scritta lì. ⚠️ **E la stessa voce chiude un'ARITMETICA FALSA nel commento che `E97` scrisse:** *«dispatch writes six fields and only four were read back»* non chiude con sé stessa — sei meno quattro fa **due**, non tre — perché mescola le unità: *quattro* conta **asserzioni**, *sei* conta **campi**. ⛔ **E il campo che cadeva fuori da entrambi i conti era esattamente `payload`.** I numerali sono **tolti e non riallineati**; al loro posto la regola: *ogni campo che questo record porta è riletto sotto*. Commit `0d148a4`. |
| **E117** | ⛔ **OTTAVO GIRO, SECONDO MUTANTE VIVO DI PRODOTTO: `run_the_ring` scrive DUE volte e solo la prima aveva un lettore.** `E98` chiuse la via d'errore di `dispatch`, che scrive **una** volta; la funzione sorella ne ha **due**, e l'`intent` che **apre il passo correttivo** non era raggiunto da niente. ✅ **Misurato:** `journal.intent(next, ..)?` → `let _ = …` lascia il workspace **43 · 324 · 0 · 2**, identico; la mutazione gemella sulla **prima** scrittura è rossa, cioè la disparità è fra le due scritture e non fra due funzioni. ⛔ **E ciò che si perde non è un valore di ritorno:** inghiottito, l'anello risponde `Ok(Some(next))` — *«il passo correttivo è aperto»* — mentre nessun intento ha raggiunto il giornale, quindi la **retroazione non fidata** che il tentativo successivo deve rispondere sparisce senza che nulla diventi rosso. È la perdita silenziosa che ADR-0007 vieta. ⚖️ **La strada è reale e non chiede nessuna finta:** `MemoryJournal::intent` rifiuta un **secondo** intento sullo stesso passo con `OutOfOrder` — promessa 6 della conformità, che vincola **entrambe** le implementazioni. ✅ **La sonda asserisce DUE cose**, come la sorella: che la chiamata è `Err`, e che l'archivio è cresciuto del **solo** verdetto. Commit `0d148a4`. |
| **E118** | ⛔ **OTTAVO GIRO, TERZO MUTANTE VIVO DI PRODOTTO, ed è quello con la conseguenza peggiore: `reconcile::steps_in_doubt` inghiottiva l'errore di `replay`.** ✅ **Misurato:** `journal.replay()?` → `.unwrap_or_default()` lascia il workspace **43 · 324 · 0 · 2**, identico. ⛔ **Inghiottita, la scansione risponde `Ok(vec![])`** — *«nessun passo è in dubbio»* — **su un archivio che non ha potuto leggere**, e lo fa sull'**unica** strada dove quella risposta viene agita: la **ripresa dopo un crash**. Un dubbio mai riportato non è mai riconciliato, e `SuspendAndAsk` non accade. ⚖️ **È la stessa forma che `is_granted` rifiuta** in `permission_triple.rs` — *«non lo so»* riportato come *«no»*, il degrado silenzioso di ADR-0019 — qui però sul lato **durevole**. ⚠️ **Il censimento dice perché nessuno l'aveva colto:** i chiamanti di `steps_in_doubt` passano **tutti** un `MemoryJournal` che risponde, e tutti `.expect(..)`. ✅ `FileJournal::replay` rende `Err` da **tre** siti, quindi la strada è di un archivio vero e non un'invenzione della finta. Commit `0d148a4`. |
| **E119** | ⚠️ **OTTAVO GIRO: il doc di `LOCAL_PRICEY` prometteva ancora ciò che `E100` aveva falsificato, sessanta righe più su.** Diceva che *«una catena di tre lascia distinguere `evaluated` da quanti ne sono stati CAMMINATI»*, e la **prima** passata esaurisce la catena in quella sonda, quindi il suo conto è **tre** pure. ⛔ **A smentirlo è il commento che `E100` scrisse quindici righe più sotto, nello stesso file.** `E100` corresse la frase **dentro** la sonda e lasciò questa in piedi: occorrenza chiusa, frase no. Commit `fb2a36f`. |
| **E120** | ⚠️ **OTTAVO GIRO: la lista A3 di `boundary.rs` ometteva le DUE bocche di `PermissionDetail`, e l'ha fatto NEL BULLET SCRITTO PER CHIUDERE LA STESSA OMISSIONE.** `E101` aggiunse *«e la stessa strada raggiunge l'indice 5»* nominando `RoutingDetail::model`; `PermissionDetail` cavalca la **medesima** `Decode`, porta **due** campi di testo, e lo stesso `Debug` scritto a mano li stampa interi — `grep -c PermissionDetail crates/kernel/src/boundary.rs` dava **zero**. ✅ **Riprodotto da FUORI la crate** su una sonda usa-e-getta: tre bocche sulla stessa strada, la lista ne nominava una. ⛔ **È la lezione che il paragrafo CITA, avvenuta due volte sulla stessa lista:** *«una lista riscritta mentre si chiude un buco è esattamente dove finisce l'omissione dopo»*. ⚖️ **Quindi al posto dell'enumerazione c'è una REGOLA** — *ogni campo di ogni specie di `Detail` è su quella strada* — e una specie aggiunta domani vi è senza che nessuno editi lì. Commit `fb2a36f`. |
| **E121** | ⚠️ **OTTAVO GIRO: `RoutingDetail::new` diceva ancora *«The ONLY way to build one»* senza qualificatore, mentre la sorella lo porta.** `E101` aggiunse *«in source»* al doc del **tipo** e non a quello del **costruttore**, sessanta righe più giù; `PermissionDetail::new` lo aveva già. ✅ `grep -rn "ONLY way to build" crates/*/src --include=*.rs` rende **due** esiti, e la differenza fra i due è l'intero rilievo. ⛔ **Il qualificatore non è tipografia:** `Decode` costruisce quel tipo dai **byte**, quindi *«in source»* è tutto ciò che il costruttore compra — come `E120` misura. Commit `fb2a36f`. |
| **E122** | ✅ **L'OTTAVO GIRO DEL CICLO DI `E53` È FATTO IL 2026-09-01 SU `git show 9441e6d`, DA UN SOTTO-AGENTE FRESCO CON LA LETTURA D'APERTURA VIETATA, E NON È TORNATO PULITO: DIECI RILIEVI, TUTTI RIVERIFICATI DAL COORDINATORE PRIMA DI RIMEDIARE E TUTTI VERI.** ⛔ **La domanda di classe è stata posta PRIMA di cercare difetti, ed è ciò che ha pagato: SETTE rimedi su otto avevano chiuso l'OCCORRENZA e non la CLASSE.** I due che l'avevano chiusa davvero sono `E99` e le cinque righe di mutazione del registro, rimisurate una per una e tutte e cinque **vere**. ⛔ **TRE erano mutanti vivi di PRODOTTO** — `E116`, `E117`, `E118` — e il coordinatore li ha riverificati **insieme**: applicate tutte e tre le mutazioni, il workspace resta **43 · 324 · 0 · 2**, identico alla baseline, e se una sola fosse stata tenuta sarebbe stata rossa. ✅ **E NESSUNO DEI TRE HA CHIESTO UNA RIGA DI PRODOTTO:** `git diff --stat crates/kernel/src/` è **vuoto** dopo il rimedio — il codice era giusto, a mancare era la **prova**. È la forma del gotcha **#74**. ⚠️ **Gli altri sette sono di prosa e di documento:** `E119`, `E120`, `E121`, la frase mozza che il rimedio di `E99` aveva lasciato a metà riga, e **due** celle del registro — quella di `gateway_decisor.rs`, che portava un'**enumerazione** di sette sonde dove il binario ne dà **nove**, **nella stessa riga** della cella che vieta i numerali, e quella di `parameters_delivered.rs`, che diceva *«cinque»* dove sono **sei**. ⛔ **Un elenco È un numerale:** il settimo giro tolse il *«sette»* dalla cella accanto e lasciò in piedi l'elenco che lo ripeteva a parole. Tolti entrambi e non riallineati. ⚠️ **Gotcha #86 verificato e NON scattato**, misurato con `git diff -U0` e con la suite: l'edit al caso `compile_fail` cade sotto il `fn main()` e il `.stderr` cita righe più in alto. ⛔ **Che cosa venga dopo NON sta in questa voce:** il ciclo ha una casa sola, ed è `E53` — scriverlo anche qui sarebbe il gotcha **#68** commesso dentro il verbale che lo registra. |
| **E123** | ⏭️ **IL BRIEF DEL NONO GIRO DEL CICLO DI `E53`, scritto il 2026-09-01 PRIMA di dispacciarlo — sta QUI e non nel ledger, sul precedente di `E107`: il ledger è `git`-ignorato e non raggiunge un'altra macchina.** ⚙️ **Il perimetro:** `git diff 9441e6d..HEAD -- crates/`, letto **alla lettera** — sono i commit che `git log --oneline 9441e6d..HEAD -- crates/` elenca, dal `fmt` di `b66295d` ai due dell'ottavo giro, `0d148a4` e `fb2a36f`. Il pacchetto si rigenera con `git diff --stat` e `git diff -U10` sullo stesso intervallo, in un file solo, e non si cerca nello scratchpad. ⛔ **Le domande, in quest'ordine, e la prima si pone PRIMA di cercare difetti:** ① *ciascun rimedio ha chiuso la CLASSE o l'occorrenza?* — col `grep` sui fratelli, rimedio per rimedio, cominciando dai due commit dell'ottavo giro e poi da `bdd18bc` e `bba4ca1`, che nessun giro successivo ha ancora interrogato; ② *un rimedio ha aperto un difetto NUOVO?*; ③ *le sonde nuove sono non-vacue?* — si **misura** mutando sull'intero workspace, mai leggendo; ④ *un'affermazione che il codice smentisce*, nei commenti del perimetro e nelle celle di [`../../porta-di-qualita.md`](../../porta-di-qualita.md) che `git diff 9441e6d..HEAD -- docs/porta-di-qualita.md` tocca; ⑤ **la lente del #104**: per ogni enum su cui il codice del perimetro decide, *esiste un `match` esaustivo?* — si censisce e si prova facendo **crescere** l'enum, perché una mutazione coglie un comportamento cambiato e mai un tipo cresciuto. ⚠️ **Si dice al revisore che cosa è GIÀ trovato e chiuso in questo perimetro**, o lo rifà: `E105` ed `E106`, `E108`–`E113`, `E114` ed `E115`, `E116`–`E121` — una riga ciascuna nel brief, e la sonda di `R3` è già misurata sulle **posizioni** (`E114`). ⛔ **E si dicono il #103 e il #86**, perché lo colpiranno: una mutazione si revoca con `cp` più `touch` e si conferma col `cmp`, e si controlla col `grep -n` che non sia caduta in un `///`; un caso `compile_fail` non si edita, perché il suo `.stderr` cita righe. ⛔ **Lettura d'apertura VIETATA**, come per l'ottavo giro: né `CLAUDE.md`, né il compendio, né `HANDOFF.md`, né questo piano — legge il codice, le sonde, gli ADR e il registro. Non committa, non pusha, e lascia l'albero **pulito**, provato con `git status --short` e `git diff --stat` vuoti in fondo al rapporto. ✅ **La baseline da cui parte, rimisurata oggi e non citata:** `GATE GREEN`, `cargo test --locked --workspace --no-fail-fast` → **43 bersagli, 326 passate, 0 fallite, 2 ignorate**, `fmt` pulito, albero pulito e allineato a `origin` dopo `git fetch`. 📌 **Un brief ha una data** (`E107`, gotcha **#65**): vale per l'`HEAD` di questo commit, e chi lo riprendesse dopo altri commit su `crates/` lo rilegge contro il codice di allora. |
| **E124** | ⛔ **NONO GIRO, PRODOTTO — GUARDIE ASSENTI: quattro enum su cui il codice decide erano tenuti da `==`, `matches!` o un braccio `_`, e da nessun `match` esaustivo, e il censimento di `E114` che aveva chiuso la classe a *«esattamente DUE membri»* era falso DENTRO il proprio perimetro.** `arbiter::PreemptibleState` e `arbiter::Activity` (`revoking()`, `ask_back`, `collect_expired`), `executor::TaskState` (`runnable_order`, la scadenza più vicina, `wake_those_due_at`) e `simulator::journal::EntryKind` (`has_intent`, `prune`). ✅ **Misurato dal coordinatore facendo CRESCERE ciascuno di una variante**, uno per volta e revocato byte-esatto: `cargo check --locked --workspace --all-targets` → **exit 0, zero `E0004`** su tutti e quattro; `Operation` cresciuto, il controllo, → `E0004` a `is_write`. ⛔ **La caduta è dalla parte PERMISSIVA per i due dell'arbitro:** uno stato terzo non è colto dalla guardia di `ask_back` e viene rimarcato `Revoking` con una grazia **fresca** — la sovra-ammissione dalla porta di servizio che quella guardia esiste per rifiutare — e `revoking()` lo sotto-conta; `TaskState` parcheggia un'attività in silenzio fino al limite di turni; `EntryKind` cade dalla parte conservativa, ma in silenzio. ⚖️ **Rimedio: la cura di `is_write`, un `match` esaustivo in UN posto per enum** — `Activity::is_revoking`, `TaskState::{is_runnable, sleeping_until}`, `EntryKind::{is_intent, is_outcome}` — e i bracci di `collect_expired` **nominati**: un `_` si legge come un `match` a qualunque censimento e non lo è. Nessun cambiamento di comportamento; cresciuti di nuovo, tutti e quattro danno `E0004` in **due** punti; `43 · 326 · 0 · 2`, `GATE GREEN`. ⛔ **E la notizia è il censimento:** due dei quattro sono `pub` in `kernel/src/`, cioè dentro il perimetro che `E114` dichiarava ricensito — un conteggio non è una chiusura, il gotcha **#106** applicato a chi lo scrisse. ⚠️ **`Resolution` cresce anch'essa in silenzio, e NESSUNO la decide oggi**, né in `src/` né nei banchi: registrata, il primo consumatore la deciderà con un `match`. Commit `fe52039`. |
| **E125** | ⚠️ **NONO GIRO, PROSA in due case: gli arm `Routing` e `Permission` di `reconcile` dicevano *«each killed exactly the half of the pair below that exists to reach it»*, e `enter` le uccide ENTRAMBE.** ✅ Rimisurato dal coordinatore sull'arm `Permission`: `enter` → `43 · 324 · 2 · 2`, cadono tutte e due le sonde della coppia; `leave` → `43 · 325 · 1 · 2`, la sola `…_leaves_…`. Il registro lo sapeva dalle righe `M1`/`M2` del gettone di conformità; la frase è stata copiata dall'arm `Routing` all'arm `Permission` col difetto dentro — la forma che `boundary.rs` (`E120`) dice di temere. Chiusa per sottrazione in entrambi gli arm, col richiamo in uno solo. Commit `54159bd`. |
| **E126** | ⚠️ **NONO GIRO, PROSA scritta dal rimedio `E118`:** *«`FileJournal::replay` returns `Err` from three separate sites»* — le chiamate fallibili sono **quattro** (`begin_read`, `open_table`, `table.iter()`, `entry`), misurate con `awk` sul corpo della funzione. Numerale tolto e non riallineato: *«from every fallible call it makes into the engine»*. Commit `54159bd`. |
| **E127** | ⚠️ **NONO GIRO, PROSA — una regola sovra-generale scritta dal rimedio `E120`:** *«every field of every `Detail` species is on this road»*, mentre la strada A3 è **testo** di runtime che raggiunge `{:?}`, e `record.rs` dice di `VerdictDetail` *«it carries a `bool` and a `u64`, so no runtime TEXT can enter through it»*: due paragrafi della stessa crate si contraddicevano, nel verso conservativo. Ristretta a *«every TEXT field»*. Commit `54159bd`. |
| **E128** | ⚠️ **NONO GIRO, REGISTRO — quattro cifre di [`../../porta-di-qualita.md`](../../porta-di-qualita.md) smentite dal comando**, tutte riverificate: ① *«tutte e **quattro** le chiamate a `grant`»* → **sei** a `8d45eea`, tutte `READ_A` — `git show 8d45eea:crates/kernel/tests/permission_triple.rs \| grep -c 'grant(&mut journal'`; ② *«**quattro** `==`»* di `E109` → **tre**, tutti in `sensor.rs`, e la cifra viveva in **tre** case — registro, gotcha **#104**, voce `E109` — tolta da tutte e tre; ③ *«i tipi che portano `#[cbor(array)]` sono **tre**»* → **cinque** — `grep -c '^#\\[cbor(array)\\]' crates/kernel/src/record.rs`; ④ la riga `permission::is_granted` della tabella del compito 7 **enumerava** le sonde nello stesso commit in cui la cella per-file lo vieta. Cifre fuori, comandi dentro. Commit `54159bd`. |
| **E129** | ⚠️ **NONO GIRO, PROSA di bassa gravità — numerali di distanza e di tempo scritti dai rimedi dell'ottavo giro:** *«sixty lines up»* (sono oltre cento), *«sixty lines below»* (trentotto), *«a day later»* (`9441e6d` 13:53 → `0d148a4` 21:03, lo **stesso** giorno), e *«ONE of the four above»* in `permission_triple.rs` dopo che `0c1eead` ne aveva inserita una quinta sopra. Sottratti: *«above it»*, *«below it»*, *«hours later»*, *«of the four probes above that ask `is_granted`»*. Commit `54159bd`. |
| **E130** | ✅ **IL NONO GIRO DEL CICLO DI `E53` È FATTO IL 2026-09-01 SU `git diff 9441e6d..HEAD -- crates/`, DA UN SOTTO-AGENTE FRESCO CON LA LETTURA D'APERTURA VIETATA (brief `E123`), E NON È TORNATO PULITO: SEI RILIEVI, `E124`–`E129`, TUTTI RIVERIFICATI DAL COORDINATORE PRIMA DI RIMEDIARE E TUTTI VERI — più uno del coordinatore.** ⛔ **La domanda di classe ha pagato una QUARTA volta, e stavolta ha colto il CENSIMENTO stesso:** `E114` aveva chiuso la classe *«un enum deciso con `==`/`matches!` e da nessun `match`»* dichiarandola a due membri, e ne restavano **quattro**, due dei quali `pub` dentro il perimetro dichiarato — `E124`, l'unico rilievo di prodotto, che non ha chiesto una riga di comportamento: quattro `match` esaustivi, come `is_write`. Gli altri cinque sono prosa e registro, e **quattro su cinque sono affermazioni scritte dai rimedi dell'ottavo giro** (`E118` → `E126`, `E120` → `E127`, `E116`/`E119`/`E121` → `E129`): la radice **R1** dentro il rimedio, di nuovo. ⚠️ **E uno l'ha trovato il coordinatore rimediando, non il revisore:** `evaluated_is_what_the_chain_OFFERED_…` di `gateway_decisor.rs`, nato in `9441e6d`, era l'unico nome con maiuscole del file senza `#[allow(non_snake_case)]` — un **avviso** che ogni build dei banchi stampava, invisibile a *«`cargo build --locked --workspace` a zero avvisi»* perché quella misura non compila i banchi. Chiuso col precedente dei tre fratelli nello stesso file; se la riga a zero avvisi debba passare a `--all-targets` è del proprietario. ✅ **Ciò che REGGE — le mutazioni di prodotto del revisore, tutte rosse, e gli enum tenuti dal compilatore — non è ripetuto qui:** la casa è la sezione *«La NONA passata»* di [`../../porta-di-qualita.md`](../../porta-di-qualita.md). ⚠️ **La serie è `3 · 2 · 6 · 6 · 4 · 4 · 5 · 10 · 6`.** ⛔ **Che cosa venga dopo NON sta in questa voce:** la casa unica è `E53`. |
| **E131** | ⏭️ **IL BRIEF DEL DECIMO GIRO DEL CICLO DI `E53`, scritto il 2026-09-01 PRIMA di dispacciarlo, sul precedente di `E107` ed `E123`.** ⚙️ **Il perimetro:** `git diff 02d2162..HEAD -- crates/`, letto alla lettera — i due commit del nono giro, `fe52039` (prodotto: quattro `match` esaustivi e i bracci nominati di `collect_expired`) e `54159bd` (prosa e un attributo). Si rigenera con `git log --oneline`, `git diff --stat` e `git diff -U10` sullo stesso intervallo, in un file solo. ⛔ **Le domande, in quest'ordine:** ① la domanda di classe, rimedio per rimedio — `E124`–`E129` e l'attributo di `E130` — col `grep` sui fratelli; ② un rimedio ha aperto un difetto NUOVO?; ③ i predicati nuovi sono tenuti? — non da una mutazione sola: si fa **crescere** l'enum e si legge `E0004`, e si rovescia il verso di ciascun braccio per vedere quale sonda muore; ④ un'affermazione che il codice smentisce, nei doc nuovi e nelle celle di [`../../porta-di-qualita.md`](../../porta-di-qualita.md) che `git diff 02d2162..HEAD -- docs/porta-di-qualita.md` tocca; ⑤ la lente del #104 su qualunque enum del perimetro. ⚠️ **Si dice al revisore che cosa è già trovato e chiuso:** `E124`–`E130`, una riga ciascuna. ⛔ **Si dicono il #103 e il #86.** ⛔ **Lettura d'apertura VIETATA**, e albero pulito alla fine. ✅ **Baseline da cui parte, rimisurata:** `GATE GREEN`, `43 · 326 · 0 · 2`, `fmt` pulito, allineato a `origin`. 📌 **Un brief ha una data** (`E107`): vale per l'`HEAD` di questo commit. |
| **E132** | ⚠️ **DECIMO GIRO, PROSA scritta dal rimedio `E124`:** il commento nuovo di `collect_expired` diceva che il braccio `_` *«kept a third state for ever»*, e la guardia `expires_at <= now` che lo precede raccoglie **ogni** stato alla chiusura della finestra di validità: un terzo stato sarebbe vissuto quanto `Running` e `NonPreemptible`, e il difetto vero del `_` era più stretto — nessuna scadenza di **grazia** lo raccoglieva mai. ✅ Misurato dal revisore su una sonda usa-e-getta in una copia del workspace, col `_ => true` di `02d2162` e uno stato terzo forzato: `promote(4_999)` lascia `allocated() == 4_096`, `promote(5_000)` lo porta a zero. Riverificato dal coordinatore leggendo la guardia. Corretto per sottrazione, con la frase vera al suo posto. Commit `6f630d3`. |
| **E133** | ⚠️ **DECIMO GIRO, REGISTRO:** la riga `E114` della tabella *«La domanda di classe»* dichiarava che cosa il comando del censimento rende e **ometteva `Admission`** — quattro `matches!(.., Admission::Granted(_))` nel modulo di test dell'arbitro, che il comando restituisce. `Admission` è tenuto (cresciuto, `E0004` in tre punti), quindi nessuna conseguenza di prodotto: è la specie di `E128`, un elenco che non riproduce il proprio comando. ✅ Riverificato dal coordinatore con `git grep` a `02d2162`. Corretta, e al passato: quel comando oggi rende altro, perché `fe52039` ha tolto le occorrenze. Commit `6f630d3`. |
| **E134** | ⚠️ **DECIMO GIRO, PROSA FUORI DAI FILE DEL PERIMETRO — la specie di `E129`, colta dalla domanda di classe:** il censimento `grep -rnE "lines (up\|below\|above\|down)" crates/` rende, oltre alle sorelle vere o al passato, **tre** affermazioni false oggi. `dst_campaign.rs`: *«the literal nine lines below»*, ed è a cinquantuno righe, perché il doc fra i due è cresciuto di due richiami. `ports_are_implementable.rs`: *«`worker` is moved by the line above»* e *«three lines above»*, imprecise **dalla nascita** — la riga sopra muove `already_dead`, e tre righe sopra c'è un commento. ⛔ **E la terza è un FATTO, non una distanza:** *«`ScriptedWorker` twenty lines above IS a `Worker` obtained without a grant»*, falso da `822db6d` (2026-08-30, compito 1c), quando `kill` ha cominciato a restituire la concessione e `new` a prenderne una da `a_real_grant()`, che passa da `Arbiter::admit`. ✅ Riverificate dal coordinatore col `grep` e con `git log -S`. Le prime due sottratte; la terza **datata**, perché ciò che P-2 stabilì — un `Worker` si ottiene implementando il tratto, non da `start` — resta vero. Commit `6f630d3`. |
| **E135** | ✅ **IL DECIMO GIRO DEL CICLO DI `E53` È FATTO IL 2026-09-01 SU `git diff 02d2162..HEAD -- crates/`, DA UN SOTTO-AGENTE FRESCO CON LA LETTURA D'APERTURA VIETATA (brief `E131`): TRE RILIEVI, `E132`–`E134`, TUTTI RIVERIFICATI DAL COORDINATORE E TUTTI VERI, E NESSUNO DI PRODOTTO.** ⛔ **È la prima ondata di CODICE del ciclo riletta senza un difetto di prodotto**, e la misura che lo sostiene è nel registro: i quattro predicati di `fe52039` provati **braccio per braccio** — ogni rovescio uccide le proprie sonde, tranne tre che sono **equivalenti per costruzione** e ora **dichiarati nel sorgente** (`sleeping_until` sul braccio `Runnable`, raggiunto solo dopo un turno senza attività eseguibili; `is_intent` sul braccio `Outcome`, perché `outcome` esige `has_intent`; il braccio `Note` lo dichiarava già l'enum) — e **trentasette** enum di `crates/*/src` censiti facendoli crescere: tenuti quelli su cui il codice decide, a `exit 0` i sedici su cui nessuno decide, e `Resolution` come registrato. ⚠️ **E la domanda di classe ha pagato una QUINTA volta, stavolta fuori dal perimetro:** `E134` viene dalla specie di `E129` cercata sull'intero `crates/`. ✅ Il campione delle misure del nono giro rifatto dal revisore (`M1`, `M5`, le due di `E125`, tutte le crescite) **coincide** col registro. ⚠️ **La serie è `3 · 2 · 6 · 6 · 4 · 4 · 5 · 10 · 6 · 3`.** ⛔ **Che cosa venga dopo NON sta in questa voce:** la casa unica è `E53`, che porta la decisione del proprietario fra un undicesimo giro documentale e il pre-controllo del compito 8. |
| **E136** | ✅ **PASSATA DOCUMENTALE A SÉ SULLA SPECIE DI `E129` — i numerali di distanza — SULL'INTERO `crates/`, il 2026-09-02, per la via ② scelta dal proprietario (richiamo ⑨ di `E53`).** ⛔ **Il censimento è ALLARGATO oltre il comando di `E53`, per chiudere la classe e non l'occorrenza:** `grep -rnE "(one\|two\|three\|four\|five\|six\|seven\|eight\|nine\|ten\|twenty\|thirty\|[0-9]+) (lines?\|paragraphs?) (up\|below\|above\|down\|earlier\|later\|before\|after\|further\|away\|under)" crates/` — il comando di `E53` non vedeva *«lines away»*, *«lines earlier»*, *«lines under»* né i **paragrafi**, e cinque dei nove sottratti stanno lì. 📌 **La regola, in due direzioni:** un numerale di distanza **al presente** — un puntatore che chi legge oggi segue — si **sottrae**, e al suo posto va un **nome** che non marcisce; uno dentro un richiamo **datato e al passato** — dove qualcosa *sedeva* — è un verbale e **resta**; *«the line above»* senza numerale resta. **Nove sottratti in otto file, ciascuno MISURATO prima:** *«ten lines above»* (`boundary.rs`, sono venti), *«three lines above»* (`ports/journal.rs`, ventidue), *«twenty lines below»* (`ports/reactor.rs`, ventitré), *«twenty lines down»* (`engine_crash_consistency.rs`, diciotto), *«three lines away»* (`executor.rs`: il posto è la promozione sopra), *«one line below»* (`frozen_bytes.rs`, sei), *«six lines earlier»* (`journal_contract.rs`: i blocchi 7 e 7b distano cinquantasette righe), e le due *«four paragraphs»* di `dst_campaign.rs` (due). **Quattro lasciati** perché datati e al passato: `boundary.rs` (*«sat nine lines above»*, AUD-049), `wire/worker.rs` (*«leaned … four lines under»*, 2026-08-31), `arbiter_admission.rs` (*«said so thirty lines up»*, 2026-08-20) e la citazione di `E134` in `ports_are_implementable.rs` — e il comando qui sopra rende oggi **esattamente quei quattro**. ⚠️ **Una specie SORELLA è dichiarata e NON passata:** i **conteggi** di sonde vicine — *«the five probes above»*, *«the two tests below»* — sono la specie del gotcha #31, un conteggio e non una distanza; il censimento è `grep -rnE "(two\|three\|four\|five\|six\|seven\|eight\|nine\|ten) (probes?\|tests?) (above\|below)" crates/`, e se passarli è del proprietario. ✅ `GATE GREEN` rimisurato; fine-riga misurati identici file per file con `tr -cd '' \| wc -c`. Commit: questo. |
| **E137** | ⛔ **PRE-CONTROLLO DEL COMPITO 8, BLOCCANTE ①, domanda 3 — il codice dettato del passo 2 NON COMPILA: legge `body.kind`, `body.detail` e `routing.degraded` come CAMPI, e dal 2026-09-01 sono ACCESSORI.** `RecordV1` non ha più un campo pubblico (`E83`, AUD-050) e `RoutingDetail` neppure (`E94`): la forma è `body.kind()`, `body.detail()`, `routing.degraded()` — `grep -n 'pub fn kind\|pub fn detail\|pub fn degraded' crates/kernel/src/record.rs`. È la specie di `E88` alla **seconda** occorrenza: *un pre-controllo ha una data*, e il compito 8 fu scritto il 2026-08-30, due giorni prima che `E83` sigillasse il tipo. ⚠️ **E il filtro per specie segue `permission::is_granted` riga per riga:** `if body.kind() != RecordKind::Routing { continue; }` è la forma che quel fratello usa già, e un record `Routing` il cui `detail` non è un `Routing` è `RecordError::Malformed`, non l'`if let` silenzioso che il passo detta. |
| **E138** | ⛔ **PRE-CONTROLLO DEL COMPITO 8, BLOCCANTE ②, domanda 1 — TUTTE E TRE le sonde dettate falliscono: `dispatch` scrive una NOTA (`journal.note`, in `gateway/mod.rs`) e le sonde la scrivono su un passo che NESSUNO HA APERTO.** ✅ **Riprodotto prima di scrivere questa voce**, con la seconda sonda copiata alla lettera in un banco usa-e-getta cancellato nella stessa corsa: `cargo test --locked -p kernel --test zz_precheck_task8` → `panicked … dispatch: OutOfOrder`. ⛔ **È la TERZA occorrenza esatta della stessa voce bloccante — compito 5 (`E44`–`E48`), compito 7 (`E102`), compito 8 — e ciò che la smentisce sta nei banchi dei compiti 6 e 7** (gotcha #58): `open_the_step` in `crates/kernel/tests/gateway_decisor.rs` e in `crates/kernel/tests/permission_triple.rs`, che scrivono l'intento con `RecordV1::intent` prima di ogni scrittura. 📌 **La regola per chi pre-controlla i compiti che restano:** questo piano detta OGNI scrittura di giornale senza aprire il passo; una sonda dettata che scrive si legge contro il contratto della porta — `note` pretende `intent`, o è `OutOfOrder` — **prima** che contro il proprio oracolo. Nel compito il rimedio è l'aiutante dei due fratelli, chiamato prima di ogni `dispatch`. |
| **E139** | ⚠️ **PRE-CONTROLLO DEL COMPITO 8, di CONTRATTO e non bloccante — il `degradation_now` dettato INGHIOTTE un record che questa build non decodifica (`let Ok(..) = Record::decode(..) else { continue }`) e restituisce `JournalError`, che non ha una stanza per `RecordError`.** Contraddice la regola che il fratello `permission::is_granted` scrive nel proprio corpo — *«a record this build cannot read STOPS the answer»* — e il doc che il compito stesso detta per il tipo, *«a field that is always `false` reads as "fine" rather than as "unknown", which is the falsest of the two»*: su un archivio illeggibile risponderebbe *«nessun degrado»*, il degrado silenzioso che ADR-0019 vieta, sulla stessa strada che l'ottavo giro ha chiuso in `reconcile::steps_in_doubt` (`E122`). ⚖️ **La forma è quella che il proprietario decise per il compito 7, `E104`: un errore PROPRIO che compone le due cause esistenti** — `DegradationError { Journal(JournalError), Record(RecordError) }` — e `Result<Degradation, DegradationError>`. Nessun chiamante esiste, quindi nessuna firma cambia sotto qualcuno; è applicata per coerenza col precedente di un compito fa e **dichiarata qui** perché il proprietario possa rifiutarla. |
| **E140** | ✅ **PRE-CONTROLLO DEL COMPITO 8 — le MISURE che il compito chiedeva di fare invece di ricordare, fatte il 2026-09-02.** ① `Arbiter::ceiling()` **non esiste**, come previsto: `grep -n 'pub fn' crates/kernel/src/arbiter/mod.rs` rende `set_policy · allocated · admit · queued · promote · revoking · release`; il tetto contro cui `admit` confronta è `self.parameters.total_vram()`, quindi il getter restituisce quello, con la ragione accanto (precedente `StepId::get`: un getter nasce col chiamante che lo pretende, e qui c'è). ② **Il terzo addendo NON serve:** le due quote permanenti di ADR-0033 entrano dal grafo di produzione **attraverso `admit`** (`crates/daemon/src/main.rs`, `arbiter.admit(profile, FOR_EVER, ..)`), quindi stanno **dentro** `allocated()`, e `allocated() >= total_vram` si confronta senza un terzo valore; `Mib` deriva `PartialOrd`. ③ **`V27` e `Q18` vivono nella SPEC, §8.3 e §8.4**, non nel registro che il compito elenca fra i `Modify:`; sono `⚠️ parziale` oggi, misurato, e restano tali (condizione 12). ④ **La lista `use` del passo 1 manca di `ArbiterId`, `VramPolicy` e `RemotePolicy`**, che la forma di `arbiter_admission.rs` pretende — `Arbiter::new(Parameters::new(TURN_LIMIT, total, id), VramPolicy::Remote(RemotePolicy))` — mentre `ComputeClass · Preemption · ResourceProfile · WorkDescriptor` servono solo alla sonda satura di **M3**. ⑤ **Il compito NON tocca `RecordKind`**: `E50` non scatta. ⚖️ **La mutazione M2 — *«l'ultimo routing e non uno qualsiasi»* — si chiude con la SONDA a due dispacci sullo stesso passo aperto, non con una dichiarazione:** il codice sarebbe giusto e la prova mancherebbe (gotcha #74), che è la scelta fatta a ogni giro di questo traguardo. |
| **E141** | 📋 **BRIEF DEL COMPITO 8, scritto qui PRIMA del dispaccio** (precedente `E107`/`E123`: il ledger è git-ignorato). Sotto-agente fresco; la lettura d'apertura di `CLAUDE.md` e del compendio è **vietata**. Legge, in quest'ordine: il § *Compito 8* di questo piano; `E137`–`E140`; i tre file che sono il suo modello — `crates/kernel/src/permission.rs` (la proiezione sorella: l'errore composto, il filtro per specie, il `Malformed`), `crates/kernel/tests/permission_triple.rs` (`open_the_step` e la forma delle sonde) e `crates/kernel/tests/arbiter_admission.rs` (il costruttore dell'arbitro e i profili). **Produce:** `crates/kernel/src/degradation.rs` con `Degradation`, `DegradationError` e `degradation_now`; la riga in `lib.rs`; `Arbiter::ceiling()` con la ragione accanto; `crates/kernel/tests/degradation_state.rs` con le TRE sonde del piano corrette da `E137`/`E138`, la sonda satura di **M3** e la sonda a due dispacci di **M2**; le righe del registro. **Prova nelle due direzioni:** le tre mutazioni del passo 3 applicate una per volta, rosso misurato, revocate con `git diff` a zero. **Non fa:** non tocca `RecordKind` né il formato, non marca `V27`/`Q18`, non riapre la lettura di *«mantiene»* (la divergenza va dichiarata accanto alla funzione). **Si FERMA e riporta** se `allocated()` e il tetto non fossero confrontabili. **Chiude:** `bash scripts/gate.sh` verde, `cargo fmt --all --check` pulito, fine-riga misurati, **un** commit senza co-autore, `feat(degradation): lo stato di degrado si ricalcola dal mondo, e non si cachea`. **Riporta:** ogni mutazione che non ha ucciso niente e ogni scarto dal piano, come voci d'errata proposte. |
| **E142** | ✅ **COMPITO 8 ESEGUITO IL 2026-09-02, `d6db082`, `GATE GREEN`, quaterna 43 · 326 · 0 · 2 → 44 · 334 · 0 · 2.** ⛔ **TRE sonde in più delle cinque enumerate dal brief, e non sono zelo:** `E139` fa nascere `DegradationError` con **due** varianti, e con le sole cinque sonde **nessuna delle due era esercitata** — superficie morta il giorno in cui è stata scritta, contro la regola che la sorella `permission::is_granted` scrive nel proprio doc (*«the branch that produces `Record` MUST have its own probe»*) e contro `E104`, che arrivò **con** le proprie sonde. Le tre — `a_journal_that_will_not_replay_…`, `a_record_that_will_not_decode_…`, `a_routing_record_without_its_detail_…` — hanno ciascuna la propria mutazione (`M5`–`M7`), e **`M5` e `M6` sono alla lettera il codice che il passo 2 dettava** prima di `E139`: la correzione è ora **misurata** — ciascuna forma dettata lasciava un archivio corrotto leggersi come *«niente è degradato»*. Casa delle misure: la sezione del compito 8 in [`porta-di-qualita.md`](../../porta-di-qualita.md). |
| **E143** | ⛔ **QUATTRO mutazioni oltre le tre del passo 3, e la ragione è la regola 6 del brief:** con le sole `M1`–`M3`, `an_idle_machine_declares_nothing` **non era uccisa da nessuna mutazione**, cioè vacua per misura. `M8` (`routing_degraded` parte da `true`) e `M9` (`vram_exhausted` sempre `true`) la tengono; `M4` (`>=` → `>`) trasforma in misura il confine che il commento della sonda satura **affermava**. Nove mutazioni, nove uccise, zero sopravvissute — e la tabella si legge dal lato che si dimentica: **ogni sonda ha un killer**. |
| **E144** | ⚠️ **`E140` ④ SBAGLIAVA: `WorkDescriptor` NON serve alla sonda satura, e importarlo sarebbe stato `unused_imports`.** `Arbiter::admit` prende `&ResourceProfile`, `Millis` e `Monotonic`, e il suo doc lo dice per iscritto — *«AND IT DOES NOT RECEIVE A `WorkDescriptor`»*, cioè `Q8 · §5.2.1` tenuta dalla firma. Trovato da chi eseguiva, che ha seguito il codice e non il pre-controllo: `cargo build --locked --workspace` a **zero** avvisi. 📌 *Un pre-controllo è un'affermazione come le altre* (gotcha #65). |
| **E145** | ⚠️ **DIFETTO DEL COORDINATORE, non del piano:** il dispaccio diceva *«segui la forma delle righe vicine (ogni `pub mod` porta un commento sopra)»*, e in `crates/kernel/src/lib.rs` **nessun** `pub mod` ne porta uno — le righe sono nude, separate da una riga bianca, e il doc del modulo dice che la lista dei `pub mod` è *«the only answer that cannot go stale»* (`AUD-046`). Chi eseguiva ha seguito **il file** e lo ha riportato invece di obbedire: `pub mod degradation;` nudo, in coda. Precedenti `E116`, `E127`, `E128`: *un brief è un'affermazione come le altre*. |
| **E146** | ⛔ **SU UN FILE NUOVO, *«revoca e `git diff` a zero righe»* NON PROVA NULLA — misurato con la mutazione IN SEDE.** `crates/kernel/src/degradation.rs` è non tracciato fino al primo `git add`, e `git diff -- FILE \| wc -l` rende **0** con `M1` applicata. Le prime due revoche sono state verificate con `sha256sum` contro una copia pristina; poi il file è stato messo nell'**indice**, e da lì `git diff` confronta albero contro indice ed è di nuovo la verifica che la regola intende. ⛔ **Regola per i compiti che restano, e il 9 crea TRE file:** un file nuovo si mette nell'indice **prima** della campagna di mutazione. Gotcha **#107** di [`HANDOFF.md`](../../HANDOFF.md). |
| **E147** | ⚠️ **`cargo fmt --all --check` era rosso su UNA riga del compito** — `degradation_state.rs`, un `assert!` a due argomenti che `rustfmt` vuole su tre righe — **corretta a mano**, senza `cargo fmt` in scrittura: **un** blocco prima, **zero** dopo. Diversamente dal compito 7, il rosso **non** preesisteva alla base: era del compito. È il segnale che [`porta-di-qualita.md`](../../porta-di-qualita.md) chiama *«nessuno lo fa rispettare»* (§7.4.3). |
| **E148** | ✅ **LA REVISIONE DEL COMPITO 8 È FATTA IL 2026-09-02 DA UN SOTTO-AGENTE FRESCO: conforme, NESSUN difetto di prodotto, SEI rilievi Minor — tutti di prosa o di forma — chiusi in TRE ondate, `de59819`, `7568dfa` e `4497130`.** ⛔ **La ri-revisione della prima ha trovato TRE frasi false scritte per chiudere i rilievi** — la specie di sempre: il limite dichiarato per ③ diceva che *«la conformità non arriva dentro un passo»* e che *«la porta deve l'ordine solo fra passi»*, mentre `journal_contract.rs` (promessa 8c) asserisce due record di **un** passo in ordine di scrittura e `ports/journal.rs` promette l'ordine **intero** — ciò che la conformità non esercita è **due note su un passo**; la frase fusa per ④ copriva anche `M10`, revocata con `sha256sum`; e la riga `M10` contava **una** sonda verde per la ragione sbagliata dove sono **due**. ⛔ **E la FONTE della frase falsa stava fuori dal perimetro**, in `crates/simulator/src/journal.rs`, insieme a una frase di `arbiter/mod.rs` — *«at the first one who looks it is already freed»* — falsa da quando `degradation_now` guarda senza riscuotere: **entrambe corrette nella seconda ondata e dichiarate**, sui precedenti `E106`/`E115`, perché correggere la copia lasciando in piedi la fonte è la radice **R1**. ⛔ **E il censimento della seconda ondata ha reso una TERZA casa** — `crates/simulator/tests/memory_journal.rs`, tre righe con le stesse due affermazioni — che chi eseguiva **non ha toccato** perché fuori dal perimetro nominato, e ha riportato invece di allargare da solo: chiusa nella terza ondata — che ha corretto anche una regressione **propria** della seconda, trattini ASCII in un file che usa l'em dash, trovata misurando la convenzione del file invece di dichiararla. 📌 *Un rimedio chiude la CLASSE, non l'occorrenza — e la classe la trova il `grep`, non la memoria.* ① `let _ = admit(..)` nella sonda satura scartava l'`Admission`, contro la forma di tutto `arbiter_admission.rs`; ② il doc di `vram_exhausted` diceva *«nothing left to admit»* mentre `allocated()` **non riscuote** gli scaduti — fra due operazioni può dire *esaurita* un istante prima che `admit` la smentisca, ed è ora **dichiarato**, nella direzione conservativa; ③ *«l'ULTIMO routing»* poggia sull'ordine di `replay` **dentro un passo**, che la conformità della porta non raggiunge (`crates/simulator/src/journal.rs`) — dichiarato accanto al ciclo, e la sonda **non** è stata indebolita spostando il secondo dispaccio su un altro passo; ④ il registro si smentiva dentro una sottosezione (*«`git diff` a zero»* contro `sha256sum`), fuso in una frase vera; ⑤ il rapporto attribuiva al **brief** la frase *«i file nuovi nascono LF»*, che era del **dispaccio** — i due file nuovi restano `w/lf` per decisione del coordinatore, l'indice è LF come tutto il repository; ⑥ il filtro per specie era tenuto per **deduzione**: misurato come `M10`, tolto il filtro, muoiono **tre** sonde — `a_degraded_routing_shows_up_in_the_state`, `it_is_RECOMPUTED_and_not_cached`, `the_LAST_routing_wins_and_not_any_routing` — tutte con `derive: Record(Malformed)`, 44 · 331 · 3 · 2; e sotto la stessa mutazione `a_routing_record_without_its_detail_…` resta verde **per la ragione sbagliata** (il `Malformed` viene dall'`Intent` che apre il passo), registrato e non chiuso: non è un difetto, perché `M10` ha tre killer propri e quella sonda tiene `M6`. 📌 *Il prodotto regge alla prima passata; le frasi no* — anche qui. ⛔ **E LA RI-REVISIONE DELLE ONDATE 2 E 3 NON È TORNATA PULITA:** i sei punti sono chiusi, ma due rotture nuove **Important** — ancora prosa scritta per chiudere — e una quarta casa fuori perimetro restano APERTE: sono il **round 4**, voce `E151`, non dispacciato per decisione del proprietario (*«basta dopo questo giro»*). |
| **E149** | ⚠️ **[`riferimenti.md`](../../riferimenti.md) resta intoccato anche qui**, come `E153` del Traguardo 5 e per la stessa voce aperta del proprietario: le misure del compito 8 vivono in [`porta-di-qualita.md`](../../porta-di-qualita.md), accanto alle sonde che difendono. |
| **E150** | ⚠️ **DIFETTO DEL COORDINATORE, colto prima che costasse:** il dispaccio della terza ondata diceva di `crates/simulator/tests/memory_journal.rs` *«oggi il file non ha CR: resti a zero»*, e la misura fatta nello stesso minuto — `tr -cd '\r' < FILE \| wc -c` — rende **395 su 395 righe**, cioè CRLF integrale. Corretto con un secondo messaggio prima che l'ondata toccasse il file. ⛔ **E il comando di censimento dettato dallo stesso dispaccio era più STRETTO di quello che aveva trovato la terza casa** — mancava l'alternativa `ACROSS steps` in maiuscolo, quindi rendeva tre righe e non due delle frasi false: chi eseguiva ha rilanciato quello largo, `grep -rni 'across steps\|conformance does not reach\|does not reach inside' crates/ docs/`, nove righe, nessuna che affermi più il falso senza il proprio richiamo. Un censimento che entra in un documento come procedura entra nella forma **larga**. Terza occorrenza in un compito della specie di `E145`: *un dispaccio è un'affermazione come le altre*, e sui fine-riga si **misura**, mai si ricorda (gotcha #31, e la riga di `CLAUDE.md` sui fine-riga misti per file). |
| **E151** | ⏭️ **ROUND 4 DEL COMPITO 8 — APERTO, NON DISPACCIATO, ED È IL PUNTO DA CUI SI RIPRENDE.** La ri-revisione delle ondate 2 e 3 (`7568dfa`, `4497130`) ha chiuso tutti e sei i punti ma ha trovato **due** rotture nuove Important — prosa falsa scritta per chiudere un rilievo, alla **terza** ondata di seguito — più una **quarta** casa fuori perimetro. **①** `crates/kernel/src/arbiter/mod.rs`, il richiamo del 2026-09-02 accanto allo scaduto: *«it is the one looker that does not collect -- `allocated`»* è falso, perché `revoking()` legge `self.held` senza riscuotere e il suo doc lo dice alla lettera (*«IT COLLECTS NOTHING, for the same reason `allocated` collects nothing»*): i lettori dei libri che non riscuotono sono **due**. Rimedio: togliere *«the one»* — nominarli entrambi o nessuno. **②** `crates/kernel/tests/degradation_state.rs` (commento della sonda `the_LAST_routing_wins_and_not_any_routing`) e `crates/simulator/tests/memory_journal.rs` (commento della sonda `a_step_may_carry_many_notes_and_they_keep_their_order`) dicono **entrambi** *«held here and nowhere else»* dello stesso caso — due note su un passo — e ciascuno è falsificato dall'altro; il costrutto scisso in `crates/kernel/src/degradation.rs` (*«it is `tests/degradation_state.rs` that holds it»*) è la stessa rivendicazione. Rimedio: **togliere** le tre rivendicazioni di esclusività (gotcha #76), lasciando il fatto — la conformità non esercita due note su un passo; questi due banchi sì. **③** La quarta casa, in **italiano**, sopravvissuta a un censimento fatto in inglese: la cella di `memory_journal.rs` in [`porta-di-qualita.md`](../../porta-di-qualita.md) — si trova con `grep -n 'dentro un passo' docs/porta-di-qualita.md`, ogni riga letta intera — dice che l'ordine dentro un passo è *«vero di questa sola»*: falso per la stessa ragione delle altre tre, l'ordine dentro un passo è dovuto dalla porta e tenuto dalla conformità (promessa 8c) su **entrambe** le implementazioni; unico di `memory_journal.rs` è il caso **due note su un passo**. Rimedio: richiamo datato accanto, CRLF conservati (regola 5 del brief `E141`). ⛔ **Regole del round:** stesso implementatore o uno fresco col rapporto in `.superpowers/` se c'è; nessuna riga eseguibile, nessuna sonda nuova, **nessuna frase nuova che affermi unicità o esclusività** — è la specie di `E38` (il qualificatore che invecchia, quarta forma del gotcha #31) e del gotcha #67; il censimento finale in **entrambe** le lingue, `grep -rni 'across steps\|conformance does not reach\|does not reach inside\|nowhere else\|the one looker' crates/ docs/` e `grep -rn 'dentro un passo\|questa sola' docs/`, ogni riga letta intera; UN commit senza co-autore. Poi la ri-revisione mirata su `4497130..HEAD`; **solo dopo** il compito è chiuso e si passa al compito 9, pre-controllato prima. ⚠️ Il prodotto è intatto: le ondate 2 e 3 non hanno cambiato una riga eseguibile, quaterna 44 · 334 · 0 · 2. |
| **E152** | ✅ **IL ROUND 4 È ESEGUITO IL 2026-09-02 (`29b85b8`, implementatore fresco) E IL ROUND 5 LO HA FATTO IL COORDINATORE A MANO (`82464b4`) PER DECISIONE DEL PROPRIETARIO: IL CICLO DI `E148`/`E151` È CHIUSO, E IL COMPITO 8 È CHIUSO.** ⚠️ Omonima della voce `E152` del piano del Traguardo 5 che il compito 9 nomina nel titolo: sono due errate diverse, e il numero è unico dentro **un** piano (`E96`). **Round 4:** ① *«the one»* tolto e l'insieme definito per intensione — *«lookers that declare of themselves that they collect nothing»*; ② le tre rivendicazioni *«nowhere else»* / *«it is X that»* tolte per sottrazione; ③ richiamo datato nella cella di `memory_journal.rs` del registro, CRLF conservati; nessuna riga eseguibile, quaterna `44 · 334 · 0 · 2`. ⛔ **La ri-revisione mirata su `4497130..HEAD` ha chiuso i tre rilievi e ne ha trovato UNO nuovo, Important, ancora prosa scritta per chiudere:** il richiamo nuovo diceva *«Ciò che questo file esercita e la conformità no **è** il caso due note su un passo»* — un costrutto scisso, cioè la forma che `E151` vieta riscritta in italiano — e la lettura esaustiva è falsa, perché la stessa cella e il blocco su `prune` di `journal_contract.rs` danno anche la terza risposta di `prune` come tenuta dal solo doppio in memoria. **Round 5, dal coordinatore:** il costrutto tolto per sottrazione — *«Questo file esercita il caso … e la conformità no»* — e la clausola sorella *«il secondo intento»*, nella STESSA frase, richiamata dopo aver **misurato** la promessa 6 di `journal_contract.rs`: il rifiuto è della conformità su entrambe le implementazioni, il *«senza scrivere»* e la contro-sonda nominata stanno in `memory_journal.rs`; la terza clausola, *«non sopravviva alla propria caduta»*, misurata e non toccata. ⛔ **TRE SVISTE DEL COORDINATORE, dichiarate (specie `E145`/`E150`):** (a) il rimedio di ③ in `E151` diceva *«unico di `memory_journal.rs` è il caso due note su un passo»* — la stessa esclusività falsa che ② toglieva, perché `degradation_state.rs` tiene lo stesso caso; l'implementatore **non** l'ha trascritta, ed è la condotta giusta; (b) il `grep -n 'dentro un passo'` dettato da `E151` **non trovava** la cella, che scriveva `*dentro* un passo` in corsivo — l'ha presa l'alternativa `questa sola`, e la forma larga è `dentro\*\? un passo`; (c) il brief del round 4 dichiarava le altre due clausole della cella *«non in discussione»* **senza misurarle**, e una era falsa. ⚖️ **Dichiarato e non toccato:** il punto ③ di `E148` narra il rilievo con *«che la conformità della porta non raggiunge»* senza richiamo, mentre la **testa** della stessa cella porta la correzione; è un verbale chiuso, e se un verbale che afferma un meccanismo sbagliato vada corretto è del proprietario — precedente **X-4** dell'audit del 2026-08-27. ⚠️ **Il residuo, detto:** la correzione del round 5 **non è stata rivista da nessuno** — decisione del proprietario, *«basta»* — ed è scritta per sottrazione da una misura fatta nello stesso minuto; la vede l'audit del compito 10. ⚖️ **Nessun gotcha nuovo:** un costrutto scisso è la forma di `E38`/#67 che `E151` già nominava, riprodotta in un'altra lingua — la stessa lezione della quarta casa. Il rapporto del round 4 (`.superpowers/`, git-ignorato) porta i totali del censimento sbagliati di uno; le tabelle sono giuste. |
| **E153** | ⚠️ **OSSERVAZIONE PER IL PRE-CONTROLLO DEL COMPITO 9, che NON è il pre-controllo — quello si fa prima di dispacciarlo, contro il codice di allora (`E88`).** Letta il 2026-09-02 chiudendo l'8: la mappa `Files:` del compito 9 elenca **tre** `Create:` — `crates/kernel/src/client.rs`, `crates/simulator/src/ipc.rs`, `crates/simulator/tests/gui_death_campaign.rs` — ma il Passo 1 del commit 9a crea un file che la mappa non nomina, `crates/kernel/tests/client_grants.rs`, *«file nuovo»*. È la specie di `E154` del Traguardo 5 — *l'elenco dei file di un compito è un'affermazione come le altre* — e pesa su `E146`: **ogni** file nuovo va nell'indice prima della campagna di mutazione, o la revoca *«`git diff` a zero»* non prova nulla. Il pre-controllo riconta i file sul testo del compito, non su questa riga. |
| **E154** | ✅ **IL PRE-CONTROLLO DEL COMPITO 9 È FATTO IL 2026-09-02, contro il codice di quel giorno (`78d770f`), con le quattro domande di `CLAUDE.md` — casa unica: questa voce più `E155`–`E157`.** ⛔ **Domanda 4, misurata:** niente del compito esiste — `grep -rni -e ClientGrants -e on_disconnect crates/` rende zero righe, `crates/kernel/src/client.rs`, `crates/simulator/src/ipc.rs` e i due banchi non esistono, e `grep -n "property_" crates/simulator/tests/arbiter_campaign.rs` rende **1**, **4** e **5**: il *«due»* del Passo 0 regge. ⛔ **Domanda 3, per costruzione e non per lettura:** `ClientGrants` e le tre sonde del commit 9a sono state scritte **da fuori la crate** in una sonda usa-e-getta (`crates/kernel/tests/precheck_client_grants.rs`, compilata, eseguita e cancellata nella stessa corsa, albero pulito dopo): **quattro** sonde verdi, e le tre mutazioni dettate uccidono ciascuna la propria — `M1` ne uccide tre, `M2` **una sola**, `M3` **una sola**. ⛔ **E la misura ha dato TRE vincoli di forma che il compito non scrive, letti nel codice di ADESSO (riga 5 del pre-controllo):** ① `ClientId` deriva `Debug, Clone, Copy, PartialEq, Eq` e **niente altro** — `Ord` e `Hash` furono **tolti per sottrazione** (`crates/kernel/tests/ports_are_implementable.rs`, riga 28; il doc di `GrantRequest` in `crates/kernel/src/wire/ipc.rs` cita quel rifiuto come precedente) — quindi un `BTreeMap<ClientId, _>` **non compila**, `HashMap` è vietata (gotcha #12, `no_std`), e la forma è un **`Vec<(ClientId, Grant)>`** a ricerca lineare; ridare `Ord` a `ClientId` riaprirebbe quella decisione e non è una via. ② `Grant` non è `Clone` né `PartialEq`: l'estrazione **muove**, con `drain` e ripartizione — il precedente è `take_due` in `crates/simulator/tests/arbiter_campaign.rs`. ③ `on_disconnect` **non può fare panico** — `grep -rn -e 'panic!' -e '.expect(' -e '.unwrap()' crates/kernel/src/` rende righe **solo** dentro il `#[cfg(test)] mod tests` di `arbiter/mod.rs` — e deve **far vedere `Released`** (`Now(Mib)` contro `AlreadyCollected`, la forma di `E30` consegnata dal compito 1): la forma misurata è `Result<Vec<Released>, ReleaseError>`, dove l'`Err` è il **difetto del chiamante** di `Arbiter::release` (una concessione di un altro arbitro) e **non** il client sconosciuto, che è `Ok(vuoto)` (`M3`). Le firme di oggi, perché chi esegue non le rideriva: `Arbiter::new(Parameters::new(turn_limit, total, ArbiterId::new(n)), VramPolicy::Remote(RemotePolicy))`, `admit(&profile, valid_for: Millis, now: Monotonic) -> Admission`, `release(grant, now) -> Result<Released, ReleaseError>`. ⛔ **Domanda 2 sul commit 9a — la direzione che si dimentica:** il compito detta **tre** sonde e nessuna esercita la **finestra scaduta**, che è esattamente `E30` sulla gui — *una gui che muore DOPO la propria finestra* — e la campagna del 9b la produrrà su una parte dei semi. **Quarta sonda, misurata verde nella usa-e-getta:** `a_disconnect_after_the_window_reports_already_collected` — a *finestra più uno* la risposta è `[AlreadyCollected]` e `allocated()` è già alla linea di base; senza di essa un `on_disconnect` che scartasse o rifiutasse `AlreadyCollected` compilerebbe verde. |
| **E155** | ⛔ **DOMANDA 2 SUL COMMIT 9b, PASSO 3 — LA SONDA DELLA PROPRIETÀ 2 MANCA: il compito dice *«iniezione: kill in istanti arbitrari … ciò che manca non è la forma: è l'iniezione»* e NON scrive l'oracolo.** Letto contro il codice: `Process::start(grant, descriptor)` prende la concessione **senza `now` e senza interrogare l'arbitro**, `GrantId` è privato e nessuna API risponde *«questa concessione è ancora nei libri?»* — quindi la metà **temporale** di *«concessione valida»* (§5.7 riga 2, design/02 riga 134) **non è osservabile all'avvio**, e un worker può restare `Attiva` oltre la propria finestra: è `E30`/`E39` del Traguardo 5, voce aperta del proprietario, e una sonda che la pinzasse sarebbe un voto contro il prenderla (gotcha **#73**). ⛔ **Prescrizione, che chi esegue può ribaltare con una misura:** ① l'asserzione sta **sui libri**, come le proprietà 1, 3 e 5 — dopo ogni kill la concessione torna da `Killed.grant` (livello 1) e `Arbiter::release` risponde `Now(riserva)` se il kill cade **dentro** la finestra e `AlreadyCollected` se fuori, **mai `Err`** con un arbitro solo; e dopo il rilascio `allocated()` è la somma delle riserve dei worker che il banco stesso sa vivi e non scaduti; ② la metà temporale si **conta e si dichiara** — quanti kill hanno trovato un worker oltre la propria finestra — e **non si asserisce**, con la frase accanto al contatore che nomina `E30`; ③ i **due** oracoli di non-vacuità di §5.7.1 sono obbligatori anche qui: *i kill sono scattati* (contatore maggiore di zero) e *c'era qualcosa da verificare* (almeno un `Released::Now`, cioè un kill dentro la finestra — senza, un banco i cui worker scadono tutti prima del kill è verde avendo confrontato insiemi vuoti); ④ l'istante del kill si estrae da un generatore **derivato** e non da quello dell'interlacciamento, sul precedente di `crash_point` nello stesso banco (D2 del piano del Traguardo 4). ⚠️ **La finta che serve NON è nel simulatore e non deve andarci:** `FakeWorker` e `FakeProcess` vivono in `crates/kernel/tests/worker_tokens.rs` e **il codice di test non attraversa le crate** — si duplicano nel banco, dichiarandolo, come `Yield` fu duplicato *«parola per parola»* da `dst_campaign.rs`; una finta guidata dal seme in `crates/simulator/src/` non serve, perché a decidere il kill è il banco e non il worker. Se la proprietà 2 vada in `arbiter_campaign.rs` o in un banco proprio lo lascia decidere il compito (*«o un banco nuovo se il file cresce troppo»*: oggi è a 39 KB e cinque sonde); un banco nuovo è un **sesto** file nuovo, e `E146` vale anche per lui. |
| **E156** | ⛔ **DOMANDA 2 SUL COMMIT 9b, PASSO 1 — LA FINTA GUI NON HA UN BANCO PROPRIO, E LA MAPPA NON HA IL FILE.** Il precedente che il compito nomina, `CrashingJournal`, porta **un banco su ciò che solo lei promette** — `crates/simulator/tests/crashing_journal.rs`, tredici sonde: cade alla scrittura detta, resta caduta, stesso seme stessa scrittura, il punto estratto sta dentro le scritture dello scenario, **ogni** scrittura può essere quella, `has_fallen` dice no finché non cade. Per la finta gui la mappa elenca **solo la campagna**, il cui oracolo (*«il guasto è scattato»*) prova che muore, **non** che muoia AL punto detto, che resti morta su `send` **e** su `receive`, né che ogni operazione del percorso possa essere quella. **Prescrizione:** un banco `crates/simulator/tests/<nome della finta>.rs` sullo stesso precedente — è il **quinto** file nuovo del compito dopo il quarto di `E153`, e `E146` vale per tutti e cinque; il nome della finta segue `CrashingJournal` (participio più cosa) e lo sceglie chi esegue, con `FakeGui` di `crates/kernel/tests/ports_are_implementable.rs` come **forma** e non come artefatto (§6.7 del disegno). ⛔ **E DUE COSE SULLA CAMPAGNA DELLA PROPRIETÀ 3 che il testo non dice e che il codice impone.** ① **La porta `ipc` non ha un evento di disconnessione:** `accept`, `send`, `receive` e basta, e la morte si vede **solo** come `Err(IpcError::Disconnected)` su `send` o `receive`. Quindi la riconciliazione va innescata da quell'`Err` letto **attraverso la porta**, mai chiedendo alla finta se è morta — chiederlo alla finta terrebbe la proprietà **dentro il banco**, che è il difetto che P-16 nomina — e il secondo oracolo di non-vacuità si scrive intero: *in almeno un mondo la gui ha ottenuto `Granted` prima di morire **e** la morte è stata vista dalla porta*. ② **La linea di base non deve essere zero:** *«la somma torna alla linea di base»* con base zero è verde anche per una riconciliazione che rilascia **tutto** — è `M2` del commit 9a applicata alla campagna. Il core tiene una concessione **propria** (la quota di presentazione di ADR-0033 è il modello, e `daemon` ne monta due) e l'oracolo asserisce che **quella** è ancora nei libri dopo la riconciliazione. |
| **E157** | ⛔ **RIGA 6 DEL PRE-CONTROLLO — QUATTRO FRASI DIVENTANO FALSE IL GIORNO DEL COMPITO 9, E DUE VIVONO IN FILE CHE LA MAPPA NON ELENCA.** Censite con `grep -rni -e "three of the five" -e "are milestone 6" -e "ne tiene tre" crates/ docs/`, ogni riga letta intera (gotcha #70): ① `crates/simulator/tests/arbiter_campaign.rs`, righe 1–2 — *«Three of the five properties: the two that need process and ipc are milestone 6»* — nel file che il compito tocca: si **riscrive**, non si annota sotto (finding A-2); ② `crates/kernel/src/ports/ipc.rs`, il doc di modulo — *«tests/ports_are_implementable.rs writes a fake gui … including the client that DIES WHEN THE SEED DECIDES»* — **falsa già oggi** (§6.7 del disegno l'ha misurata: `dies` è chiamata da due test in modo esplicito e nessun seme la muove) e dal compito 9 la finta che il seme muove esiste **altrove**: richiamo datato, **file da aggiungere ai `Modify:` come solo doc**; ③ [`README.md`](../../README.md), riga 54 — *«resta parziale perché la §5.7 elenca cinque proprietà e la campagna dell'arbitro ne tiene tre»* — è la cella di stato del Traguardo 5 e diventa falsa: richiamo datato nello stesso commit, **file da aggiungere ai `Modify:`**, perché una cella di stato che mente lo fa con autorevolezza (radice R1); ④ [`porta-di-qualita.md`](../../porta-di-qualita.md) — già nei `Modify:` — in **quattro** case: la cella dei chiamanti dell'esecutore (*«porta le proprietà DST 1, 4 e 5 … Le altre due hanno bisogno di process e ipc, Traguardo 6»*), la riga della mappa dei banchi (*«cinque test — contati sul binario»* e *«le proprietà 1, 4 e 5»*), la riga 27 della tabella delle voci aperte del Traguardo 5 (`E152`, si chiude col commit) e la riga di catalogo della campagna DST (*«PARZIALE dal 2026-08-25»*), che passa a coperta con le cinque proprietà **nominate una per una** e il numeratore **ricontato** sul catalogo, non dedotto. ⚠️ **Non toccare** `crates/kernel/tests/arbiter_admission.rs` riga 228 (*«the only half milestone 5 can hold»*) né la §6.7 del disegno: sono **verbali** al passato, e restano veri. 📌 **Il riconto dei file, sul testo del compito e non sulla mappa:** `Create:` **cinque** — `client.rs`, `tests/client_grants.rs` (`E153`), `simulator/src/ipc.rs`, il banco della finta (`E156`), `gui_death_campaign.rs` — più un sesto se la proprietà 2 prende un banco proprio (`E155`); `Modify:` i due `lib.rs`, `arbiter_campaign.rs`, `porta-di-qualita.md`, **più `ports/ipc.rs` (solo doc) e `README.md`**. |
| **E158** | 📋 **BRIEF DEL COMPITO 9, scritto PRIMA del dispaccio — e il dispaccio avviene in una SESSIONE NUOVA, per decisione del proprietario del 2026-09-02** (precedente `E141`: il ledger è git-ignorato; il file intero è `task-9-brief.md` nel ledger di questa macchina, e questa voce è la sua casa nel repository). Sotto-agente fresco, `opus`; la lettura d'apertura di `CLAUDE.md` e del compendio è **vietata**. Legge, in quest'ordine: il § *Compito 9* di questo piano; `E146`, `E153`–`E157`; `arbiter_admission.rs` (il costruttore e i profili); i doc di `Grant`, `Released`, `ReleaseError`, `Arbiter::{new, admit, release, allocated}`; `ports/ipc.rs` e `wire/ipc.rs`; `FakeGui` di `ports_are_implementable.rs` come forma; `CrashingJournal` e il suo banco; `arbiter_campaign.rs` intero; `ports/process.rs` e `worker_tokens.rs`; il doc di modulo di `degradation.rs`; le sezioni dei compiti 7 e 8 del registro. **Produce, in DUE commit `GATE GREEN` ciascuno:** 9a — `client.rs` con `ClientGrants` (`Vec<(ClientId, Grant)>`, `register`, `on_disconnect -> Result<Vec<Released>, ReleaseError>`), la riga in `lib.rs`, `tests/client_grants.rs` con le tre sonde del piano più la quarta di `E154`, le tre mutazioni misurate; 9b — la finta gui in `simulator/src/ipc.rs` col suo banco (`E156`), `gui_death_campaign.rs` con i due oracoli di non-vacuità **visti rossi**, la proprietà 2 nella forma di `E155`, la campagna di mutazione (D7, `E146`), le quattro frasi di `E157` corrette nello stesso commit, la sezione del registro e la riga di catalogo a coperta col numeratore ricontato. **Non fa:** non chiude `E50`/`E51`, non riapre `E30`, non tocca `RecordKind` né il formato, non marca `V11`/`V21`/`V27`/`Q18`, non aggiunge derive a `ClientId`. **Si FERMA e riporta** se un oracolo di non-vacuità non può essere visto rosso o se la porta non lascia vedere la morte. **Chiude:** gate verde, `fmt` pulito, fine-riga misurati, due commit senza co-autore, non pusha. **Riporta:** ogni scarto come voce d'errata proposta, e l'uscita del Passo 0. |
| **E159** | ⛔ **`E157` ② censisce UNA frase in `crates/kernel/src/ports/ipc.rs`, e le frasi che il compito 9 rende false sono TRE.** Oltre a *«including the client that DIES WHEN THE SEED DECIDES»*, il file dice *«measured, `Ipc` has exactly one implementation from outside the crate»* e *«`grep -rnE "^ *impl Ipc for" crates/` still finds ONE bench fake and nothing else»*. **Misurato:** quel comando rende **due** righe a `ae73501` — `ports_are_implementable.rs:456` e `simulator/src/ipc.rs:143`. Il censimento non le ha colte perché il suo grep cercava *«three of the five»*, *«are milestone 6»* e *«ne tiene tre»*, e nessuna delle due le contiene. Tutte e tre corrette con richiamo datato. ⛔ **La lezione è sul METODO del censimento e non su queste righe:** un grep per il TESTO delle frasi note non trova le frasi che parlano dello STESSO fatto con altre parole |
| **E160** | ⛔ **`E157` ④ dice «in QUATTRO case» di [`porta-di-qualita.md`](../../porta-di-qualita.md); sono CINQUE.** La quinta è il verbale della tabella delle voci aperte del Traguardo 5: *«⛔ E ne MANCA CINQUE che sono aperte: E53, E83, E100, E140 ed E152»*. **Comando:** `grep -n "ed E152" docs/porta-di-qualita.md`. Non contiene nessuno dei tre modelli del censimento. Corretta con un richiamo datato che **lascia il verbale intatto** — parla del punto cieco del FILTRO, che non si è mosso — e corregge il solo presente *«sono aperte»*: quattro lo restano |
| **E161** | ⚠️ **`E157` ④ dice che la riga della mappa dei banchi diventa falsa in due punti — *«cinque test — contati sul binario»* e *«le proprietà 1, 4 e 5»*. MISURATO: nessuno dei due.** `cargo test --locked -p simulator --test arbiter_campaign` rende ancora `running 5 tests`, e quel file tiene ancora esattamente le proprietà 1, 4 e 5, perché le due nuove sono andate in **file nuovi**. Ciò che alla mappa dei banchi serviva davvero — e che `E157` non chiede — sono **tre righe nuove**, aggiunte. 📌 Il gotcha **#65** dal verso che si dimentica: un rapporto può prezzare un lavoro che non serve, non solo mancarne uno che serve |
| **E162** | ⛔ **IL COMPITO 9 CREA UNA CAMPAGNA DST E NESSUNO AVEVA MESSO `scripts/gate.sh` FRA I SUOI `Modify:`.** Il settimo passo del cancello nomina i propri bersagli **uno per uno**, quindi una campagna assente dall'elenco gira ma **non stampa il proprio tempo di parete**, e il vincolo **7** della §11 non è soddisfatto per lei. **Misurato a `ae73501`:** `bash scripts/gate.sh \| grep -c "DST gui death\|DST worker kills"` rende **0**, col cancello **VERDE**. ⚠️ **È mancato DUE VOLTE SU DUE**: identico al Task 12 del Traguardo 5, dove il commento di quel passo annota che *«il cancello è uscito VERDE e la sua uscita conteneva le quattro righe `DST arbiter` ZERO volte»*. 📌 **Per i piani che verranno: un compito che crea una campagna DST crea anche un BERSAGLIO del passo 7 di `scripts/gate.sh`, e quel file va nel suo elenco `Modify:`** |
| **E163** | ⚠️ **`E152` non può portare lo SHA del commit che la chiude**, perché quel commit è quello che scrive la riga. Scritta come *«`9342fc1`, e il commit che porta questa riga»*. La riga 26 della stessa tabella porta uno SHA (`822db6d`) e deve essere stata scritta dopo |
| **E164** | 📌 **METODO — un comando messo accanto a un'affermazione deve misurare L'AFFERMAZIONE, non una sua approssimazione.** *«Non la chiama mai»* è una domanda sulle **chiamate**; `grep -c <nome>` conta le **occorrenze**, e il doc che dichiara di non chiamarla è esso stesso un'occorrenza — quindi il comando rende un numero maggiore di zero e la frase che gli sta accanto lo smentisce. ⛔ **Ed è successo DUE volte nello stesso compito, in case diverse, con due numeri diversi e entrambi sbagliati.** Il rimedio ha due metà: il comando **ancorato** (`grep -cE '\.has_died\('`) e la **seconda direzione** — un comando che non può rendere diverso da zero non misura niente. 📌 **E il numero di un comando NON ancorato non si scrive in nessuna casa**, perché scriverlo lo rende falso: la riga che lo scrive è essa stessa un'occorrenza |
| **E165** | ⚠️ **Confermata l'osservazione già registrata dal compito 8:** in `crates/kernel/src/lib.rs` non c'è **nessuna** riga di doc per modulo. `grep -c '///' crates/kernel/src/lib.rs` → **0**. L'elemento 2 dell'ordine operativo del brief chiede *«la riga di doc nello stile delle altre»*: seguito **il file**, non l'attesa |
| **E166** | ⛔ **SCARTO DAL BRIEF, E LA DECISIONE È DEL COORDINATORE.** Il brief detta *«DUE commit, 9a poi 9b»* (regola 8) e vieta i file fuori dall'elenco (regola 9), che **non** contiene `scripts/gate.sh`. Il compito chiude con **TRE** commit di prodotto — `9342fc1`, `ae73501`, `0976d9f` — più le ondate di revisione, e tocca un settimo file. ⚠️ **La sequenza è quella che il brief stesso prescrive:** chi eseguiva ha lavorato nel perimetro dato, ha registrato la mancanza come riserva invece di allargarsi da solo, e il coordinatore ha allargato il perimetro portando la misura. ⛔ **La ragione per cui NON era una decisione del proprietario è verificabile e non asserita:** il commento del passo 7 dichiara *«the catalogue count stays at six»*, quindi nessuna riga di catalogo nasce e il vincolo globale 7 — che riserva la §7.4 al proprietario — non è toccato; e il precedente identico è **dentro quel file**, al Task 12 del Traguardo 5 |
| **E167** | ⛔ **`E154` ② PRESCRIVE UNA FORMA CHE LA MISURA DICE PEGGIORE, e la voce si corregge perché il piano smetta di prescriverla.** Detta che `on_disconnect` estragga *«MUOVENDO (`drain` e ripartizione, precedente `take_due`)»*. **Fatto:** `Arbiter::release` **consuma** la concessione, quindi su un `Err` a metà lista il `drain` ha già svuotato il `Vec` e ogni coppia non ancora rilasciata è **persa**; col prelievo singolo (`position` + `remove`) il `?` esce lasciando registrato tutto il resto. **Misura del 2026-09-02:** applicata `drain` **con** ripartizione come mutazione sul codice di produzione, `cargo test --locked -p kernel --test client_grants` rende `4 passed; 1 failed`, e la sola rossa è `a_foreign_grant_is_the_caller_s_defect_and_leaves_the_rest_registered`, con `left: Ok([])` contro `right: Ok([Now(Mib(1024))])`. ⚠️ **E il precedente che la voce cita non regge il peso che le si dà:** `take_due` in `arbiter_campaign.rs` riparte un `Vec` in cui **nessuna** operazione può fallire, quindi non ha un ramo d'uscita anticipata da cui perdere il resto — è un precedente per il **movimento**, non per il `drain`. ⛔ **E la deviazione è rimasta NON PROVATA fino alla prima ondata di revisione:** era dichiarata in un doc e nessuna sonda percorreva il ramo `Err` che la giustifica, quindi un ritorno alla forma prescritta sarebbe passato verde. La sonda che la tiene è la quinta di `client_grants.rs` |
| **E168** | ⛔ **DIFETTO DEL COORDINATORE, e la sua forma è più utile del caso: UNA DIAGNOSI VERA SU UN SITO È STATA APPLICATA A UN SITO GEMELLO PER ANALOGIA, SENZA CONTROLLARE SE LA PREMESSA VI REGGESSE.** La prima ondata trovò in **due** campagne un'asserzione aggregata che nessuna mutazione faceva rossa, e il coordinatore ordinò di **toglierle entrambe** (gotcha **#76**) sull'argomento che la pretesa restava tenuta dall'asserzione **per seme**, più forte. ✅ **Vero in `gui_death_campaign.rs`:** dopo l'assert per seme `death_seen_from_port` è **costante `true`**, quindi `deaths == SEEDS` valeva per costruzione. ⛔ **Falso in `worker_kill_campaign.rs`: quell'asserzione per seme NON ESISTEVA**, e toglierla ha aperto una lacuna vera contro `E155` ③ — l'oracolo 1, *«i kill sono scattati»*, non era più tenuto da niente, e un kill saltato lasciava **l'intero banco verde** per due ondate. ⛔ **E la diagnosi era falsa anche nel merito, misurato:** sottoposta allo stesso kill saltato l'aggregata legge **6000** contro **8000** e **va rossa**, quindi non era infalsificabile. A distinguere le due forme non è mai stata la falsificabilità — sotto la sola restrizione vera, *«nessuna mutazione di PRODUZIONE la raggiunge»*, l'asserzione per seme che l'ha sostituita è irraggiungibile quanto lei — ma che la forma per seme **nomina il seme** e vale su **ogni** seme invece che sulla somma. ⚠️ **E un rilievo Minor nominava già quel vuoto e fu chiuso DICHIARANDOLO invece di riempirlo**, cioè la dichiarazione ha fatto passare per scelta una lacuna. 📌 *Una diagnosi si riverifica sul secondo sito, non si trasporta* |
| **E169** | 📋 **VERBALE DEL CICLO DI REVISIONE DEL COMPITO 9, e il residuo dichiarato.** Due revisori in **parallelo** su perimetri **disgiunti** — misurato che non condividono un file — invece di uno solo sul pacchetto intero da 190 KB: **A** sul kernel rese spec ✅ e Approvato con **un** Important, **B** sul simulatore, i documenti e il cancello rese spec ❌ con **nove**. Poi **quattro ondate**: la serie degli Important, contata sui rapporti e non ricordata, è **10 · 5 · 3 · 3**. ⛔ **Ogni ondata ha chiuso i propri rilievi APRENDONE DI NUOVI NELLA PROSA SCRITTA PER CHIUDERLI** — la prima ne aprì cinque, la seconda due, la terza due — e la specie è sempre la stessa: un conteggio, una rivendicazione di esclusività, o un esito citato che il commit stesso aveva appena cancellato dal sorgente. ✅ **Il prodotto invece ha retto:** dalla prima ondata in poi nessuna revisione ha trovato un difetto di comportamento. ⚖️ **La QUARTA ondata l'ha fatta il COORDINATORE A MANO e senza ri-revisione**, sulla pratica fissata dal proprietario al round 5 del compito 8, dopo che il ri-revisore ha dichiarato **voce per voce** che ciò che restava era sola prosa di documento. ⚠️ **Residuo, detto e non arrotondato:** quelle tre correzioni non sono state riviste da nessuno; e due citazioni di riga sbagliate restano nel rapporto del compito, che vive in `.superpowers/` — **fuori da ciò che si consegna** — dichiarate lì con un richiamo datato invece che corrette, sul precedente del ciclo del Task 11 del Traguardo 5 |
| **E170** | ✅ **IL PRE-CONTROLLO DEL COMPITO 10 È FATTO IL 2026-09-02, contro il codice e i documenti di quel giorno — casa unica: questa voce più `E171`–`E177`.** ⛔ **Domanda 4, misurata voce per voce, e il compito NON è già eseguito:** la **§8** del disegno **non esiste** — `grep -n '^## '` sul disegno rende `## 7. La chiusura` come ultima sezione numerata, seguita da tre non numerate; e **non esiste** la tabella delle voci aperte del Traguardo 6 — l'unica è `## ⛔ LE VOCI APERTE DEL TRAGUARDO 5, IN UNA TABELLA SOLA (2026-08-25)` in [`porta-di-qualita.md`](../../porta-di-qualita.md), che è il **modello** e non l'artefatto. ⛔ **Domanda 3 non si applica:** il compito è un **audit** e non produce codice, quindi non c'è nessun artefatto da implementare da fuori la crate. ⚠️ **E una parte È già soddisfatta, che è il gotcha #49 colto prima e non dopo:** vedi `E173` |
| **E171** | ⛔ **IL PASSO 1 DETTA UN COMANDO CON UN SEGNAPOSTO NON RISOLTO, e chi esegue non può indovinarlo:** `git diff --name-only <primo-commit-del-traguardo>..HEAD -- crates/ scripts/ Cargo.lock`. ✅ **Misurato:** il primo commit del Traguardo 6 che tocca `crates/` è **`c4cf942`** — *«traguardo 6 (compito 1a): l'arbitro guadagna un'identità CONSEGNATA»*, del 2026-08-30. ⚠️ **E i due candidati che lo precedono NON vanno usati:** `5cd3cff` è il pre-controllo del compito 1 e `d864286` è lo sfoltimento del compendio del 2026-08-28 — **nessuno dei due tocca `crates/`**, quindi partire da lì gonfierebbe il perimetro con commit di sola documentazione. 📌 Il segnaposto si sostituisce con `c4cf942`, e la scelta si dichiara |
| **E172** | ⛔ **IL COMANDO `awk` DEL PASSO 1 CONTA PIÙ DI CIÒ CHE IL PASSO VUOLE, misurato.** Dettato: `awk '/^#### 7\.4\.1/{f=1} /^#### 7\.4\.3/{f=0} f' <spec> \| grep -c '^\|'` → rende **48**. Ma `grep '^\|'` prende **anche** le righe di intestazione e i separatori `\|---\|` dei blocchi di tabella, e ciò che il passo vuole sono le **righe di catalogo**. ✅ **Con le intestazioni e i separatori esclusi il conteggio è 40**, cioè il comando dettato ne conta **otto** che non sono righe di catalogo. ⚠️ **Il precedente è il Task 13 del Traguardo 5**, che ricontò *«sulla §7.4 della spec delimitando per intestazione — `3 + 8 + 1`»* e non con un `grep` cieco. 📌 **E il passo non dichiara che numero si attende**, quindi la divergenza non può essere colta da chi non riconta: chi esegue scrive **il comando che ha usato** accanto alla cifra, e se diverge da un documento **vince il conteggio** |
| **E173** | ✅ **LA CONDIZIONE 12 È GIÀ SODDISFATTA, e si verifica LEGGENDO invece di eseguire — misurato il 2026-09-02.** Le quattro righe portano ancora `⚠️ parziale` nelle tabelle §8.3/§8.4 della spec: `V11`, `V21`, `V27` e `Q18`, nessuna marcata ✅. ⛔ **Ed è la sola condizione che si fallisce FACENDO TROPPO**, come il compito stesso avverte: il rischio non è dimenticarla ma marcarne una per entusiasmo di chiusura. ⚠️ **Il comando che le legge NON è un `grep` sul nome:** quelle sigle compaiono anche in prosa fuori dalle tabelle — `grep -n 'V11'` sulla spec rende righe di §2 e §5 prima di arrivare alla tabella — quindi si delimita per sezione e si legge la **terza** colonna, che la trappola **3** di `check-docs.sh` dichiara essere quella dello stato |
| **E174** | ⛔ **IL VINCOLO OPERATIVO DEL COMPITO 10 È IL TETTO DEL COMPENDIO, E VA MISURATO PRIMA DI SCRIVERE, non dopo.** ⛔ **E LA CIFRA NON SI SCRIVE QUI, per la ragione che questa voce stessa dimostra: il commit che l'ha portata l'ha subito falsificata.** La prima stesura diceva *«204 584 byte, cioè 4 312 di margine»*, misurati alla chiusura del compito 9; il commit del pre-controllo — questo — ha scritto in §6 il proprio esito e il peso è salito, quindi il numero era **falso prima ancora di essere pushato**. È il gotcha **#109** applicato a un peso invece che a un `grep`. **Il margine si rifà col comando**, che non marcisce: `echo $((208896 - $(wc -c < docs/COMPENDIO.md)))`, col tetto letto in `scripts/check-docs.sh` e non ricordato. ⚠️ **E il gotcha #100 dice che il verde NON è un segnale di margine:** il 2026-09-01 il compendio era verde a **ventun** byte dal rosso. 📌 Il compito tocca la §6 in **due** punti soltanto — la tabella dei sei traguardi e il prossimo passo — e la §6 dichiara di sé che *«a che punto sia NON è scritto qui»*: il verbale va nella **§8 del disegno**, che è la decisione **B** della §7.1 e la ragione per cui quella §8 esiste |
| **E175** | ⛔ **COLLISIONE DI CODICI: `P-n` NOMINA DUE POPOLAZIONI DIVERSE, e il compito 10 ne cita una senza dirlo.** Il Passo 4 nomina *«cinque candidate — P-1, P-5, P-6, P-8, P-9»*, e sono le **sezioni `### P-n` del pre-controllo del PIANO**, che vivono in questo file. ⛔ **RICHIAMO DEL 2026-09-02, chiudendo il compito 10:** qui stavano i **numeri di riga** di quattro di esse — P-1, P-5, P-8, P-9 — ed erano già stantii **al commit che le scrisse** — misurato: `git show 4d95e00:<piano> | grep -n '^### P-'` rende per quelle quattro numeri **diversi** da quelli che la voce portava. Un numero di riga dentro un documento vivo è un puntatore senza guardia. **Tolti e non riallineati:** a rifarli è il comando che questa voce stessa prescrive, in fondo. ⛔ **Ma il rapporto del compito 9 usa `P-1`…`P-9` per le PROPRIE voci proposte**, con contenuti del tutto diversi — rinumerate in `E159`–`E167` alla chiusura, il 2026-09-02. **Misurato:** `grep -c '^\| \*\*P-[0-9]\*\*'` su questo piano rende **0**, perché le une sono intestazioni e le altre righe di tabella; ma un `grep P-1` nudo le rende **entrambe**. 📌 **Chi esegue il compito 10 cerca le candidate con `grep -n '^### P-'` su QUESTO file**, e non nel rapporto di un compito |
| **E176** | ⛔ **«CINQUE CANDIDATE» È LA CIFRA DI QUANDO IL PIANO FU SCRITTO, e il Passo 4 lo dice esso stesso — *«e i compiti ne aggiungeranno»*.** ✅ **Misurato:** l'errata di questo piano è arrivata a **`E169`**, e le smentite del disegno raccolte dai compiti non sono più cinque. ⚠️ **Quali siano non si scrive qui** — sarebbe un cumulativo che invecchia al prossimo compito, gotcha **#31** — e la casa unica è l'errata stessa, che si legge dall'alto. 📌 **E il Passo 4 chiede anche le CONFERME**, non solo le smentite: *«un verbale che elenca solo le smentite fa sembrare il disegno peggiore di com'era»* |
| **E177** | ✅ **DUE CONFERME, misurate e non assunte, perché un pre-controllo che elenca solo i difetti mente per omissione.** ① Le condizioni della §7.2 del disegno sono **dodici**, contate col comando, e il compito le chiama *«le dodici»*: **regge**. ② La condizione **11** — *«le voci che il traguardo lascia aperte stanno in UNA tabella sola, con la colonna di chi le chiude»* — **c'è nel disegno**, cioè non si ripete l'errore del Traguardo 5, dove il disegno l'aveva dimenticata e a rimediare fu chi scriveva il piano. ⚠️ **Ma esserci nel disegno non è eseguirla:** la tabella del Traguardo 6 **non esiste** (`E170`), e questo compito è chi la scrive |
| **E178** | ⛔ **IL DISEGNO CITA `E146` E QUEL NUMERO NON È UN RIFERIMENTO: la voce intesa è del piano del TRAGUARDO 5, e questo piano ne ha una propria che dice un'altra cosa.** La §7.4 del disegno scrive *«non tocca `riferimenti.md` — la voce **E146** è registrata e non presa»*, e la voce che dice quello è la riga **30** della tabella unica del Traguardo 5 in [`porta-di-qualita.md`](../../porta-di-qualita.md). ⛔ **L'omonima di QUESTO piano** è *«su un file nuovo, «revoca e `git diff` a zero righe» non prova nulla»*: misurata, chiusa, e senza rapporto con `riferimenti.md`. ⚠️ **Quando il disegno fu scritto, il 2026-08-28, l'ambiguità non esisteva** — l'errata di questo piano nasce due giorni dopo, ed è precisamente ciò che `E96` dice: il numero è unico dentro **un** piano, e a difendere il rimando è la prosa accanto, che qui **non** disambigua. ✅ **Qualificata col nome del piano e un richiamo datato**, che è il rimedio già scelto da `E96` — *«la sola citazione che oggi diventerebbe attivamente fuorviante è stata qualificata; le altre non sono toccate»* — e non una convenzione nuova. Trovata dal compito 10, leggendo la §7.4 contro l'errata |
| **E179** | ⛔ **REGISTRATA E NON PRESA — QUESTO FILE PORTA UN `CR` ISOLATO, E GIT LO CLASSIFICA NON-TESTO.** ✅ **Misurato il 2026-09-02:** `python -c "import io,sys; b=io.open(sys.argv[1],'rb').read(); cr=chr(13).encode(); print(b.count(cr), b.count(cr+chr(10).encode()))"` su questo file rende **due numeri che differiscono di uno**, e il `CR` isolato sta dentro un code span della voce `E136`, dove il testo intendeva i **due caratteri** che scrivono l'escape. ⛔ **La conseguenza:** `git ls-files --eol` dà `i/-text w/-text` — gli altri `.md` del repository danno `i/lf` — quindi i CRLF di questo file stanno **nell'indice**, e chi lo riscrive li conserva byte per byte. ⛔ **E il rimedio costa più del difetto:** sostituito il `CR` coi due caratteri il file torna `i/lf w/crlf`, e il primo `git add` normalizzerebbe **ogni** riga — la trappola dei fine-riga di [`../../../CLAUDE.md`](../../../CLAUDE.md) alla scala del file intero. ✅ **Provato nelle DUE direzioni** su due copie in un repository usa-e-getta fuori da questo, non dedotto dalla documentazione di git. Comparso con `307fa18`, la passata che ha scritto `E136`. Da lì il gotcha **#110**, e la riga sta anche nella tabella delle voci aperte del Traguardo 6 |
| **E180** | ⛔ **`E174` DICE CHE IL COMPITO 10 TOCCA LA §6 DEL COMPENDIO IN «DUE PUNTI SOLTANTO», E I PUNTI SONO TRE — misurato eseguendo.** La §6 porta **due** tabelle dei traguardi: quella *«I sei traguardi del sotto-progetto 1»*, che `E174` nomina, e una seconda dentro *«Le voci ancora aperte»*, la cui riga **6** portava `⬜` e diventava falsa alla chiusura. ✅ **Trovata col comando e non a memoria:** un `awk` che cerca `⬜` fra l'intestazione della §6 e quella della §7 rende **due** righe, non una. ⚠️ **E non è una svista del solo pre-controllo:** la §6 dichiara di sé che il numeratore *«vive QUI e in nessun altro punto di questa sezione»*, e quella seconda tabella è una casa in più dello stesso stato. ⛔ **Aggiornata e non tolta:** le sue righe 1–5 portano ciascuna la propria data e sono **verbali**, quindi toglierne una sola lascerebbe la tabella a metà — consolidarla è del **proprietario**, ed è il debito che la §6 dichiara già di sé |
| **E181** | 📋 **VERBALE DEL CICLO DI REVISIONE DEL COMPITO 10, e il residuo dichiarato.** Un revisore sul pacchetto intero — sette file, tutti di documentazione — ha reso spec ✅ e qualità **approvata**, con **un** Important, sei Minor e tre ⚠️; ha **rilanciato i comandi** invece di rileggere il rapporto, e ogni affermazione misurabile che ha controllato è risultata vera — `E178` confermato finding vero, `E180` misurato necessario. ⛔ **L'Important era la specie di sempre, dentro la frase che la vieta:** *«un elenco di ventinove nomi invecchierebbe alla prima che si chiude»* scriveva il numerale nella frase che argomenta che i numerali invecchiano. **Prima ondata** (`c671256`): i sei rilievi chiusi per **sottrazione**, e due difetti propri colti dall'implementatore **prima** di consegnare — due `LF` nudi in un file CRLF, visti perché il delta dei `CR` non tornava col `numstat`, e una clausola falsa su `C-1`. ⚠️ **E un rilievo del revisore era sbagliato:** il filtro del Traguardo 5 sta sotto il **secondo** `$` del suo blocco, non il terzo — corretto dall'implementatore **misurando**, e la ri-revisione gli ha dato ragione. **Ri-revisione:** tutti chiusi, nessuna rottura Important, **quattro** Minor nuovi di sola prosa nelle frasi scritte per chiudere — una dichiarazione che non copriva la proposizione accanto, un rimando a una forma non scritta, un antecedente perso per sottrazione, e una clausola tolta da una cella e **viva nella gemella**: occorrenza e non classe, il richiamo ⑥ di `E53`. ⚖️ **La seconda ondata l'ha fatta il COORDINATORE A MANO e senza ri-revisione**, sulla pratica fissata dal proprietario al compito 8 e applicata al 9 — e rileggendo ha trovato un **quinto** difetto che nessuna delle due revisioni aveva visto: l'**intestazione del compendio** diceva ancora *«col compito 9 … l'ultimo contenuto di merito è il compito 9»*, cioè la specie di **AUD-034** alla terza occorrenza sulla riga che la registra. ⚖️ **Tre ruling del coordinatore:** la metà *«visto scattare»* della condizione 3 per `V14`/`Q10` è soddisfatta dal **verbale datato** della campagna di mutazione del compito 5 — un audit non muta `src/`, e ciò che è già eseguito si riconosce (§7.3 regola 3); la posizione della §8 del disegno, dopo le tre sezioni non numerate, **resta** — è il verbale scritto dopo la chiusura e le segue; **nessuna revisione finale dell'intero ramo**, perché questo compito È l'audit di chiusura e il ramo è quello di lavoro del sotto-progetto, non un ramo da mergiare. Il cancello è stato **rilanciato dal coordinatore** dopo ogni ondata: `GATE GREEN`. ⚠️ **Residuo, detto e non arrotondato:** le frasi della seconda ondata non sono state riviste da nessuno; e il filtro letterale del Traguardo 5 sta **su due righe** dentro il proprio blocco, cioè un copia-incolla alla lettera dà una regex rotta — il blocco è un verbale e non è toccato, l'istruzione nuova lo dichiara |
---
