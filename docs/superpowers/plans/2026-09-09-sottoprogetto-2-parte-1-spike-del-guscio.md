...
2. La lettura obbligatoria di `CLAUDE.md`; la **§6 del compendio** dice il passo: la **parte 2** del piano del 2. Di questo piano si leggono la testa, i vincoli, la posizione (tutta ✅), l'errata **E1–E20** e questo diario — non i compiti, che sono eseguiti.
