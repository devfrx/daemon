...
`git show --stat 1c6716c`, che nomina i nove file. ⚠️ **RICHIAMO DEL 2026-09-03:** qui stava `HEAD`, che si sposta al primo commit successivo — un verbale nomina il **commit**.
