...
✅ **RICHIAMO DEL 2026-09-23, quarta sessione — la (d) e la (e) approvate.** La quarta sessione ha rifatto i controlli
...
risposta **21**: «Accessibilità» passa a 🔶 nella tracciabilità. ⛔ Si riprende dalla **(f)**, le sonde che diventano test:
*«Prossimo passo, eseguibile»*, punto 4.
...
metà**: cominciato il 2026-09-23, ventuno risposte nella tabella *«Le risposte del proprietario, una per domanda»* — il
...
e la **(e)**, le voci registrate, alla 21. ⛔ **Il prossimo passo è la sezione (f)**, le sonde che diventano test. Si riprende
**ESATTAMENTE** da lì: *«Prossimo passo, eseguibile»*, punto 4.
...
- ⛔ **il disegno a sezioni** — il prossimo passo, una sezione approvata per volta; gli approcci sono decisi, **A** alla
  risposta 14, la **(a)** è approvata alla 16, la **(b)** alla 17 e la **(c)** alla 18; la **(d)** alla 19 e alla 20, la **(e)** alla
  21: si riprende dalla **(f)**; le domande sono finite, e la
...
4. Gli **approcci** — ✅ **A**, risposta 14 — e il **disegno a sezioni**, una approvata per volta: ✅ (a) i token, risposte 15 e
   16; ✅ (b) il kit, 17; ✅ (c) il dock, 18; ✅ (d) la cornice, 19 e 20; ✅ (e) le voci registrate, 21. ⛔ **Si riprende
   ESATTAMENTE dalla presentazione della (f)**, le sonde che diventano test — contrasto, raggi, caratteri, icone, testo tagliato — col browser vero per le prove di disposizione, che è
