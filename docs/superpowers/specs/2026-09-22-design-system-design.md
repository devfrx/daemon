...
✅ **RICHIAMO DEL 2026-09-23, quarta sessione — la (d) presentata, e la sua prima domanda ha risposta.** La quarta sessione ha
rifatto i controlli dell'apertura, ha presentato la **(d)**, la cornice, e ha la risposta **19**: le miniature della
Panoramica sono **schemi**. ⛔ Si riprende dalla **seconda domanda della (d)** — la striscia e gli angoli della finestra —
coi fatti nel punto 4 di *«Prossimo passo, eseguibile»*.
...
metà**: cominciato il 2026-09-23, diciannove risposte nella tabella *«Le risposte del proprietario, una per domanda»* — il
...
alla 18. La **(d)**, la cornice, è presentata, e la sua prima domanda ha risposta alla 19: le miniature sono schemi.
⛔ **Il prossimo passo è la seconda domanda della (d)**, la striscia e gli angoli della finestra. Si riprende **ESATTAMENTE** da
lì: *«Prossimo passo, eseguibile»*, punto 4.
...
passando per `gen_icons_v1.py` quando servono le icone. Nel repository le tavole approvate sono **tre** — lo stile, la
panoramica e i token — con **tre** sonde: raggi, caratteri, icone. La **terza** sessione, lo stesso giorno, ha lo scratchpad
...
- ⛔ **il disegno a sezioni** — il prossimo passo, una sezione approvata per volta; gli approcci sono decisi, **A** alla
  risposta 14, la **(a)** è approvata alla 16, la **(b)** alla 17 e la **(c)** alla 18; la **(d)** è presentata e la sua prima
  domanda ha risposta alla 19: si riprende dalla **seconda domanda della (d)**; le domande sono finite, e la
...
4. Gli **approcci** — ✅ **A**, risposta 14 — e il **disegno a sezioni**, una approvata per volta: ✅ (a) i token, risposte 15 e
   16; ✅ (b) il kit, 17; ✅ (c) il dock, 18; 🔶 (d) la cornice, **presentata** nella quarta sessione, con la prima domanda
   alla 19. ⛔ **Si riprende ESATTAMENTE dalla SECONDA domanda della (d): la striscia e gli angoli della finestra**, coi fatti
   che la quarta sessione ha verificato il 2026-09-23:
   - **la tavola approvata**: in `stile-approvato.html` e `panoramica.html` la striscia è una **pillola** — `.m-strip`, raggio
     999 — a 10,8 px dal fondo e dai lati di una cornice da 28, misurato nel pannello del browser: tornava perché
     quell'angolo era **nostro**;
   - **la finestra vera**: Windows 11 arrotonda le finestre a **8 px**, e a **0 px** quando sono ingrandite o agganciate —
     Microsoft Learn, *Geometry in Windows 11*, aggiornata il 2026-02-19, e *Apply rounded corners in desktop apps*,
     aggiornata il 2026-07-09, lette il 2026-09-23; che la finestra di Electron con la barra nascosta prenda quegli angoli è
     🔶 **dedotto**, e si vede col guscio;
   - **la regola, com'è scritta nella sonda**: `sonda-raggi.js` dice «vicini» due angoli che stanno entro il raggio più grande
     più 2 px **in tutte e due** le direzioni; la pillola a 12 px dai lati e dal fondo, dentro un angolo da 8 o da 0, è
     vicina e il suo raggio non torna — la regola del proprietario salterebbe;
   - **la domanda da portare**, con una tavola provata con la sonda **prima** di mostrarla: **A** la pillola resta, allineata
     alle schede a 12 px dai lati, e si **alza** a 24 px dal fondo — con una striscia alta fino a 44 px l'angolo della
     finestra non le è mai vicino, né a 8 né a 0; **B** la striscia diventa **piatta**, attaccata al fondo e larga quanto la
     finestra, come la barra, e gli angoli li arrotonda Windows. La lettura del coordinatore è **A**: tiene l'aspetto
     approvato, e costa 12 px d'altezza;
   - poi la (d) si chiude, e si passa alla (e).
   I fatti della presentazione della (d), verificati dalla terza sessione e **già detti** al proprietario, restano qui sotto:
