...
metà**: cominciato il 2026-09-23, diciotto risposte nella tabella *«Le risposte del proprietario, una per domanda»* — il
...
alla 18. ⛔ **Il prossimo passo è la sezione (d)**, la cornice. Si riprende **ESATTAMENTE** da lì: *«Prossimo passo, eseguibile»*, punto 4.
...
- ⛔ **il disegno a sezioni** — il prossimo passo, una sezione approvata per volta; gli approcci sono decisi, **A** alla
  risposta 14, la **(a)** è approvata alla 16, la **(b)** alla 17 e la **(c)** alla 18: si riprende dalla **(d)**; le domande sono finite, e la
